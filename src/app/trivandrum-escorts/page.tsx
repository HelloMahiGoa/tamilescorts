...
const url = `${base}/trivandrum-escorts`;

const metaTitle = "Trivandrum Escorts | Premium Escorts in Trivandrum – Kowdiar, Statue, MG Road, Technopark";
const metaDescription =
  "Trivandrum escorts and escort service in Trivandrum. Outcall to your hotel or place in Kowdiar, Statue, MG Road, Technopark, Pattom. Discreet, verified. Tamil, Mallu companions. Pay when you meet.";

function buildTrivandrumJsonLd() {
  ...
  return [
    {
      ...
      itemListElement: [
        ...
        { "@type": "ListItem", position: 2, name: "Trivandrum Escorts", item: url },
      ],
    },
    {
      "@context": "https://schema.org",
    ...
    },
    {
      ...
      "@type": "LocalBusiness",
      "@id": localBusinessId,
      name: "Trivandrum Escorts",
      description: "Premium escort service in Trivandrum. Outcall to Kowdiar, Statue, MG Road, Technopark, Pattom. Discreet, verified. Tamil, Mallu companions.",
      url,
      ...
      areaServed: { "@type": "City", name: "Trivandrum", containedInPlace: { "@type": "State", name: "Kerala" } },
    },
    {
      "@context": "https://schema.org",
      "@type": "FAQPage",
...
export const metadata: Metadata = {
  ...
  keywords: [
    "Trivandrum escorts",
    "escorts in Trivandrum",
    "Trivandrum escort service",
    "Kowdiar escorts",
    "Technopark escorts",
    "MG Road Trivandrum escorts",
    "Pattom escorts",
    "outcall Trivandrum",
    "Tamil escorts Trivandrum",
    "Mallu escorts Trivandrum",
    "housewife escorts Trivandrum",
    "model escorts Trivandrum",
    "escort service Kowdiar",
    "hotel escort Trivandrum",
  ],
  openGraph: {
    type: "website",
    locale: "en_IN",
    ...
    title: metaTitle,
    description: metaDescription,
    images: [{ url: `${base}/images/2.avif`, width: 1200, height: 630, alt: "Trivandrum escorts – premium outcall escort service" }],
  },
  twitter: {
...
const POPULAR_AREAS = [
  { name: "Kowdiar", slug: "kowdiar", desc: "Central & hotels" },
  { name: "Statue", slug: "statue", desc: "Landmark area" },
  { name: "MG Road", slug: "mg-road", desc: "Commercial hub" },
  { name: "Pattom", slug: "pattom", desc: "Residential & stays" },
  { name: "Kazhakootam", slug: "kazhakootam", desc: "IT & Technopark" },
  { name: "Technopark", slug: "technopark", desc: "Tech hub" },
];

const MORE_AREAS = [
  { name: "Sreekaryam", slug: "sreekaryam" },
  { name: "Ulloor", slug: "ulloor" },
  { name: "Peroorkada", slug: "peroorkada" },
  { name: "Nemom", slug: "nemom" },
  { name: "Thampanoor", slug: "thampanoor" },
  { name: "Vazhuthacaud", slug: "vazhuthacaud" },
];
...
const WHY_CHOOSE = [
  ...
  { title: "Direct Contact", body: "No bots, no long forms. You talk to someone who handles Trivandrum bookings every day. Quick response." },
...
const SERVICE_TYPES = [
  ...
  { title: "Dinner or event", desc: "Plus-one for a client dinner in Kowdiar or Statue, or company for an evening out. We'll match someone who's presentable and easy to be around." },
  ...
  { title: "Travel companion", desc: "Outstation trips (Kovalam, Varkala, Kollam) need advance booking. Not every girl does it; we'll check when you ask." },
];

const WHO_BOOKS = [
  { title: "Business travelers", body: "In town for a few days, staying at a hotel in Kowdiar or Technopark. Don't want to eat alone or sit in a room. Need company that's discreet and hassle-free." },
  { title: "Locals", body: "Living in Trivandrum and want company for an evening—dinner, event, or just a few hours. Same process: you tell us area, when, and type; we fix someone who shows up." },
  { title: "Events & client dinners", body: "Need a plus-one for a corporate dinner or a client meet in Statue or MG Road. We send someone presentable who knows how to keep the evening smooth." },
];
...
const FAQ_ITEMS = [
  { q: "What areas in Trivandrum do you cover?", a: "We cover Kowdiar, Statue, MG Road, Pattom, Kazhakootam, Technopark, Sreekaryam, Ulloor, Peroorkada, Nemom, Thampanoor, Vazhuthacaud and the rest of the city. Tell us your location when you book and we'll fix someone who can reach you on time." },
  ...
  { q: "How do I book a Trivandrum escort?", a: "Message us on Telegram. Tell us your area, when you need someone, and what you're looking for (Tamil, Mallu, regular, model, etc.). We'll suggest who's free. Same-day and advance bookings both work." },
  ...
  { q: "Outcall or incall in Trivandrum?", a: "We do outcall only in Trivandrum—she comes to your hotel or your place. Have the address and any gate or lobby instructions ready so there's no back-and-forth." },
  { q: "Are Trivandrum escorts verified?", a: "Yes. We verify profiles before listing. You get real photos and real people. No fake profiles or bait-and-switch. If something isn't right on the day, you can tell us—we take feedback seriously." },
  { q: "What is the best area for hotel bookings in Trivandrum?", a: "Kowdiar and Statue get the most hotel bookings—central, plenty of hotels, easy for us to send someone. MG Road and Pattom are popular with business travelers. Technopark and Kazhakootam work well too. Tell us your hotel area and we'll match someone who can reach you on time." },
  { q: "Can I book a Tamil or Mallu escort in Trivandrum?", a: "Yes. We have Tamil and Mallu escorts in Trivandrum. When you message, tell us your preference—language or type (regular, housewife, model, etc.)—and we'll suggest who's free and fits." },
];

const TRIVANDRUM_CATEGORIES: { slug: CategorySlug; label: string; line: string }[] = [
  { slug: "regular", label: "Regular Escorts", line: "Most popular in Trivandrum. No advance; hotel proof and room details for hotel bookings." },
...
export default function TrivandrumEscortsPage() {
  const jsonLd = buildTrivandrumJsonLd();
  return (
    <main id="main-content" className="min-h-screen bg-black">
      ...
      <header className="relative w-full min-h-[100vh] flex flex-col justify-end overflow-hidden">
        <div className="absolute inset-0 hidden md:block">
          <Image
            src="/images/2.avif"
            alt="Trivandrum escorts – premium outcall escort service in Kowdiar, Statue, Technopark and across Trivandrum"
            fill
        ...
        <div className="absolute inset-0 md:hidden">
          <Image
            ...
            alt="Premium Trivandrum escorts – discreet outcall booking to your hotel or place"
            fill
            className="object-cover object-center"
            priority
            sizes="100vw"
          ...
          <div className="mx-auto w-full max-w-7xl">
            ...
            <div className="max-w-2xl md:max-w-xl lg:max-w-2xl">
              ...
              <p className="mt-6 text-lg sm:text-xl text-white/85 leading-relaxed max-w-xl">
                Premium escort service in Trivandrum. Outcall to your hotel or your place—Kowdiar, Statue, MG Road, Technopark and across the city.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="border-b border-white/10 py-6 px-4 sm:px-6 lg:px-8" aria-label="About Trivandrum escorts">
        <div className="mx-auto max-w-4xl text-center">
          <p className="text-base sm:text-lg text-white/80 leading-relaxed">
            <strong className="text-white">Trivandrum escorts</strong> and escort service in{" "}
            <strong className="text-white">Kowdiar</strong>, <strong className="text-white">Statue</strong>,{" "}
            <strong className="text-white">MG Road</strong>, Technopark, Pattom and across Trivandrum. Tamil & Mallu companions. Outcall to your hotel or place. Discreet, verified, pay when you meet.
          </p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 min-h-0">
          <div className="relative aspect-[4/3] lg:aspect-auto lg:min-h-[480px] overflow-hidden bg-black">
            <Image
              ...
              alt="Premium Trivandrum escorts – Tamil and Mallu companions for outcall in Trivandrum"
              fill
              className="object-cover object-center"
          ...
          <div className="flex flex-col justify-center px-4 py-12 sm:px-8 lg:px-12 xl:px-16 lg:py-16">
            <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-white mb-6 leading-tight">
              Looking for premium Trivandrum escorts? You&apos;ve found the city&apos;s trusted escort service.
            </h2>
            <p className="text-base sm:text-lg leading-relaxed text-white/85 mb-4">
              Most of our bookings in <strong className="text-white">Trivandrum</strong> are from people in town for work—staying at a hotel in <strong className="text-white">Kowdiar</strong> or <strong className="text-white">Technopark</strong>—or locals who want company for a dinner or an event. We don&apos;t do the &quot;pay first and hope someone shows up&quot; thing. You tell us your area, what kind of evening you have in mind, and when. We suggest someone who can reach you without a fuss.
            </p>
            <p className="text-base sm:text-lg leading-relaxed text-white/85 mb-4">
            ...
            <p className="text-base sm:text-lg leading-relaxed text-white/85">
              A lot of our clients are here for a few days on work. They don't want to eat alone in a hotel or sit in a room by themselves. Some need a plus-one for a client dinner in Statue or MG Road. Some just want company for an evening with no strings. Same drill for everyone: you book, we fix someone who shows up, you pay when she's there.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-4xl">
          <div className="relative rounded-2xl border border-[var(--accent-gold)]/25 bg-black/50 px-6 sm:px-10 py-10 sm:py-12 text-center overflow-hidden">
            ...
            <h2 className="text-2xl sm:text-3xl font-bold text-white mb-5">
              What If Booking Escorts in Trivandrum Just Worked?
            </h2>
            ...
            <p className="text-white/70 text-sm sm:text-base">
              This is Trivandrum&apos;s trusted escort service that turns a simple booking into a smooth evening.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-6xl">
          <div className="text-center mb-10">
            ...
            <h2 className="text-2xl sm:text-3xl font-bold text-white mb-3">
              Popular Areas in Trivandrum
            </h2>
            <p className="text-white/70 max-w-2xl mx-auto">
              We cover Kowdiar, Statue, MG Road, and the suburbs. Tell us your location when you book and we&apos;ll fix someone who can reach you on time.
            </p>
          </div>
          ...
          <div className="rounded-xl border border-white/10 bg-black/30 px-6 py-5 text-center">
            ...
            <p className="text-white/60 text-sm text-center mt-4 max-w-xl mx-auto">
              Kowdiar and Statue get the most hotel bookings. Technopark and Kazhakootam are big for IT and corporate. Pattom, Sreekaryam and Ulloor are a mix of hotels and residential. Wherever you are, give us the area and we&apos;ll sort it.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-5xl">
          <div className="text-center mb-10">
            ...
            <p className="text-white/70">
              Book your escort in Trivandrum in three simple steps.
            </p>
          </div>
        ...
        <div className="mx-auto max-w-6xl">
          <div className="text-center mb-10">
            ...
            <p className="text-white/70 max-w-xl mx-auto">
              Trusted Trivandrum escort service. No advance for regular profiles. Discreet and direct.
            </p>
          </div>
        ...
        <div className="mx-auto max-w-4xl">
          <div className="text-center mb-8">
            ...
            <p className="text-white/70 max-w-xl mx-auto mb-8">
              100% verified profiles. Tamil and Mallu escorts in Trivandrum. Choose a type to browse by category (regular, housewife, college girls, models, artists, celebrity, actress).
            </p>
      ...
      {/* Tamil & Mallu Escorts in Trivandrum – label + cards */}
      <section className="border-y border-white/10 py-14 px-4 sm:px-6 lg:px-8 bg-white/[0.02]" aria-label="Tamil Mallu escorts Trivandrum">
        <div className="mx-auto max-w-6xl">
          <div className="text-center mb-10">
            <span className="inline-block text-xs font-semibold tracking-[0.2em] text-[var(--accent-gold)] uppercase mb-2">
              By language
            ...
            <h2 className="text-2xl sm:text-3xl font-bold text-white mb-3">
              Tamil & Mallu Escorts in Trivandrum
            </h2>
            <p className="text-white/70 max-w-2xl mx-auto">
              We have companions who speak Tamil and Malayalam. Many clients in Trivandrum want someone who gets the culture and can hold a conversation in their language—for a dinner, an event, or a relaxed evening at your hotel or place.
            </p>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            {[
              { href: "/tamil-escorts", label: "Tamil Escorts", desc: "Tamil companions in Trivandrum. Kowdiar, Statue, Technopark—outcall to your hotel or place. Same discretion and pay-when-you-meet policy." },
              { href: "/mallu-escorts", label: "Mallu Escorts", desc: "Mallu companions in Trivandrum for dinner, events or travel. Most requested in Kerala. Presentable, easy to talk to. Outcall; pay when she arrives." },
            ].map((item) => (
      ...
      {/* Languages in Trivandrum – card with pills */}
      <section className="py-14 px-4 sm:px-6 lg:px-8 border-t border-white/10">
        <div className="mx-auto max-w-4xl">
          <div className="relative rounded-2xl border border-white/10 bg-gradient-to-br from-white/[0.04] to-transparent overflow-hidden">
            ...
            <div className="pl-8 pr-6 sm:pr-8 py-8 sm:py-10">
              ...
              <p className="text-white/85 leading-relaxed">
                Our companions in Trivandrum speak Tamil and Malayalam, plus English. Many are multilingual. If you want someone who can hold a conversation in a specific language—for a family function, a dinner where everyone&apos;s speaking Malayalam or Tamil, or just because you&apos;re more comfortable—tell us when you book. We&apos;ll suggest who fits. It&apos;s one of the things we get asked most in Trivandrum.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-14 px-4 sm:px-6 lg:px-8 border-t border-white/10" aria-label="Escort categories Trivandrum">
        <div className="mx-auto max-w-6xl">
          <div className="text-center mb-10">
            <span className="inline-block text-xs font-semibold tracking-[0.2em] text-[var(--accent-gold)] uppercase mb-2">
              Categories
            ...
            <p className="text-white/70 max-w-xl mx-auto">
              Regular, housewife, college girls, models and more. All available in Trivandrum with outcall to your location.
            </p>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {TRIVANDRUM_CATEGORIES.map((cat) => (
              <Link
                key={cat.slug}
      ...
      <section className="border-y border-white/10 py-14 px-4 sm:px-6 lg:px-8 bg-white/[0.02]">
        <div className="mx-auto max-w-6xl">
          <div className="text-center mb-10">
            ...
            <h2 className="text-2xl sm:text-3xl font-bold text-white mb-3">
              What We Offer in Trivandrum
            </h2>
            <p className="text-white/70 max-w-2xl mx-auto">
              From a few hours to a full night, dinner dates to travel. Outcall to your hotel or your place in Trivandrum. Tell us what you need and we&apos;ll match you.
            </p>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
      ...
      <section className="py-14 px-4 sm:px-6 lg:px-8 border-t border-white/10 bg-white/[0.02]">
        <div className="mx-auto max-w-6xl">
          <div className="text-center mb-10">
            ...
            <p className="text-white/70 max-w-xl mx-auto">
              We offer flexible durations. All outcall to your hotel or your place in Trivandrum.
            </p>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            {[
              ...
              { title: "Outstation (travel)", desc: "Trips to Kovalam, Varkala, Kollam or elsewhere. We need a few days' notice. Not every companion does outstation. Same discretion and payment when she's with you.", num: "4" },
            ].map((item) => (
      ...
      {/* Outstation from Trivandrum – card */}
          ...
          <div className="relative rounded-2xl border border-white/10 bg-white/[0.03] overflow-hidden">
            ...
            <div className="pl-8 pr-6 sm:pr-8 py-6 sm:py-8">
              ...
              <h2 className="text-xl sm:text-2xl font-bold text-white mb-3">
                Outstation from Trivandrum
              </h2>
              <p className="text-white/85 leading-relaxed">
                We get requests for trips to Kovalam, Varkala, Kollam, and elsewhere. Not every companion does outstation, and we need advance notice—often a few days—to check who&apos;s free and willing to travel. Same rules: discretion, pay when she&apos;s with you (cash or UPI), and for regular and housewife profiles no advance. Tell us where you&apos;re going, how many nights, and when; we&apos;ll see what we can arrange.
              </p>
            </div>
          </div>
        </div>
      ...
      {/* Who Books Trivandrum Escorts – label + cards */}
      <section className="py-14 px-4 sm:px-6 lg:px-8 border-t border-white/10 bg-white/[0.02]">
        <div className="mx-auto max-w-5xl">
          <div className="text-center mb-10">
            <span className="inline-block text-xs font-semibold tracking-[0.2em] text-[var(--accent-gold)] uppercase mb-2">
      ...
      {/* First time booking in Trivandrum – card */}
      <section className="py-14 px-4 sm:px-6 lg:px-8 border-t border-white/10" aria-label="First time booking Trivandrum">
        <div className="mx-auto max-w-4xl">
          <div className="relative rounded-2xl border border-white/10 bg-gradient-to-br from-white/[0.04] to-transparent overflow-hidden">
            <div className="absolute left-0 top-0 bottom-0 w-1.5 bg-[var(--accent-gold)]/60" aria-hidden />
            <div className="pl-8 pr-6 sm:pr-8 py-8 sm:py-10">
              ...
              <h2 className="text-2xl sm:text-3xl font-bold text-white mb-5">
                First Time Booking in Trivandrum?
              </h2>
        ...
        <div className="mx-auto max-w-4xl">
          <div className="relative rounded-2xl border border-white/10 overflow-hidden">
            ...
            <div className="p-6 sm:p-8">
              ...
              <p className="text-white/85 leading-relaxed mb-4">
                Same-day bookings work—we often confirm within a few hours. For peak times (weekends, evenings in Kowdiar or Statue) a few hours&apos; notice helps. For full-night or outstation (Kovalam, Varkala, Kollam) we need advance notice; not every girl does it, and we need to line it up.
              </p>
              <p className="text-white/85 leading-relaxed">
      ...
      {/* Why outcall only in Trivandrum – card */}
      <section className="py-14 px-4 sm:px-6 lg:px-8 border-t border-white/10 bg-white/[0.02]">
        <div className="mx-auto max-w-4xl">
          <div className="rounded-2xl border border-white/10 overflow-hidden">
            <div className="bg-black/50 px-6 sm:px-8 py-6 border-b border-white/10">
              ...
              <h2 className="text-2xl sm:text-3xl font-bold text-white">
                Why Outcall Only in Trivandrum for Celebrity, Models, Artists and Actress?
              </h2>
            </div>
            <div className="p-6 sm:p-8 space-y-6">
              <div className="rounded-xl bg-white/[0.03] border border-white/5 p-5 sm:p-6">
                ...
                <p className="text-white/85 leading-relaxed text-sm sm:text-base">
                  In Trivandrum we offer <strong className="text-white">outcall only</strong>—she comes to your hotel or your place. We don&apos;t arrange incall. That applies to all profiles: regular, housewife, college girls, and also celebrity, models, artists and actress. You stay in a space you control; she travels to you.
                </p>
              </div>
              <div className="rounded-xl bg-white/[0.03] border border-white/5 p-5 sm:p-6">
      ...
      {/* Area keyword blocks – Kowdiar/Statue & Technopark/Kazhakootam */}
      <section className="py-14 px-4 sm:px-6 lg:px-8 border-t border-white/10" aria-label="Escort service by area Trivandrum">
        <div className="mx-auto max-w-5xl">
          <div className="text-center mb-10">
            <span className="inline-block text-xs font-semibold tracking-[0.2em] text-[var(--accent-gold)] uppercase mb-2">
              By area
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="group rounded-2xl border border-white/10 bg-white/[0.03] p-6 sm:p-8 hover:border-[var(--accent-gold)]/40 transition-colors">
              <div className="flex flex-wrap gap-2 mb-4">
                <Link href="/kowdiar-escorts" className="inline-flex items-center px-3 py-1.5 rounded-full text-xs font-semibold bg-[var(--accent-gold)]/15 text-[var(--accent-gold)] border border-[var(--accent-gold)]/30 hover:bg-[var(--accent-gold)]/25 transition-colors">
                  Kowdiar
                </Link>
                <Link href="/statue-escorts" className="inline-flex items-center px-3 py-1.5 rounded-full text-xs font-semibold bg-[var(--accent-gold)]/15 text-[var(--accent-gold)] border border-[var(--accent-gold)]/30 hover:bg-[var(--accent-gold)]/25 transition-colors">
                  Statue
                </Link>
              </div>
              <h3 className="text-lg sm:text-xl font-bold text-white mb-3">
                Escort Service in Kowdiar and Statue
              </h3>
              <p className="text-white/80 text-sm sm:text-base leading-relaxed">
                Most of our Trivandrum hotel bookings are in Kowdiar and Statue—central, plenty of hotels, easy for us to send someone. Outcall to your room; we need proof and room details, and you give her name at reception. Pay when she arrives.
              </p>
            </div>
            <div className="group rounded-2xl border border-white/10 bg-white/[0.03] p-6 sm:p-8 hover:border-[var(--accent-gold)]/40 transition-colors">
              <div className="flex flex-wrap gap-2 mb-4">
                <Link href="/technopark-escorts" className="inline-flex items-center px-3 py-1.5 rounded-full text-xs font-semibold bg-[var(--accent-gold)]/15 text-[var(--accent-gold)] border border-[var(--accent-gold)]/30 hover:bg-[var(--accent-gold)]/25 transition-colors">
                  Technopark
                </Link>
                <Link href="/kazhakootam-escorts" className="inline-flex items-center px-3 py-1.5 rounded-full text-xs font-semibold bg-[var(--accent-gold)]/15 text-[var(--accent-gold)] border border-[var(--accent-gold)]/30 hover:bg-[var(--accent-gold)]/25 transition-colors">
                  Kazhakootam
                </Link>
              </div>
              <h3 className="text-lg sm:text-xl font-bold text-white mb-3">
                Outcall Escorts in Technopark and Kazhakootam
              </h3>
              <p className="text-white/80 text-sm sm:text-base leading-relaxed">
                Technopark and Kazhakootam are big for IT and corporate clients. We get a lot of bookings from business travelers staying there. Outcall only—she comes to your hotel or your place. Tell us your area and when you need someone; we&apos;ll suggest who&apos;s free and can reach you on time.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="relative rounded-2xl border border-white/10 bg-gradient-to-br from-white/[0.04] to-transparent overflow-hidden">
            ...
            <div className="p-6 sm:p-8">
              ...
              <p className="text-white/85 leading-relaxed mb-6">
                We cover all of Trivandrum. When you book we factor in where you are and where she&apos;s coming from so we suggest someone who can reach you on time. Tell us your area (or hotel name and area) when you message; we don&apos;t need the exact address until we confirm. Clear gate or lobby instructions help so there&apos;s no back-and-forth on the day.
              </p>
              <div className="flex flex-wrap gap-2">
                {[
                  { name: "Kowdiar", slug: "kowdiar-escorts" },
                  { name: "Statue", slug: "statue-escorts" },
                  { name: "MG Road", slug: "mg-road-escorts" },
                  { name: "Pattom", slug: "pattom-escorts" },
                  { name: "Kazhakootam", slug: "kazhakootam-escorts" },
                  { name: "Technopark", slug: "technopark-escorts" },
                  { name: "Sreekaryam", slug: "sreekaryam-escorts" },
                  { name: "Ulloor", slug: "ulloor-escorts" },
                  { name: "Peroorkada", slug: "peroorkada-escorts" },
                  { name: "Nemom", slug: "nemom-escorts" },
                  { name: "Thampanoor", slug: "thampanoor-escorts" },
                  { name: "Vazhuthacaud", slug: "vazhuthacaud-escorts" },
                ].map((area) => (
                  <Link
                    key={area.slug}
                    href={`/${area.slug}`}
      ...
      {/* Trusted Trivandrum Escort Service – content left, image right */}
      <section className="py-14 px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-6xl grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-14 items-center">
          <div>
            <h2 className="text-2xl sm:text-3xl font-bold text-white mb-6">
              Trusted Trivandrum Escort Service
            </h2>
            <p className="text-lg leading-relaxed text-white/85 mb-6">
              In the heart of Kerala, Trivandrum runs on work, travel, and the need for company that doesn&apos;t come with strings. We&apos;re the city&apos;s trusted escort service—discreet, straightforward, and built for people who don&apos;t want to waste time. Outcall to your hotel in Kowdiar or your place in Statue. Same process everywhere: you book, we fix someone who shows up, you pay when she&apos;s there.
            </p>
            <h3 className="text-xl font-bold text-[var(--accent-gold)] mb-3">
              Why Trivandrum&apos;s clients choose us
            </h3>
            ...
            <h3 className="text-xl font-bold text-[var(--accent-gold)] mb-3">
              How we match you with a Trivandrum escort
            </h3>
          ...
          <div className="relative aspect-[4/3] lg:aspect-[3/4] rounded-xl overflow-hidden bg-white/5 shrink-0">
            <Image
              src="/images/3.avif"
              alt="Trusted Trivandrum escort service – discreet outcall to your hotel or place"
              fill
              className="object-cover object-center"
              sizes="(max-width: 1023px) 100vw, 50vw"
            />
        ...
        <div className="mx-auto max-w-4xl">
          <div className="rounded-2xl border border-white/10 bg-black/20 px-6 sm:px-10 py-10 text-center">
            ...
            <p className="text-white/70 mb-8 max-w-2xl mx-auto">
              Trivandrum is a major hub; we also arrange outcall in Chennai, Bangalore, Hyderabad, Kochi, Coimbatore, Madurai and more. Ask when you message—availability depends on who&apos;s free and where. Same rules: discretion, pay when you meet, no advance for regular and housewife profiles.
            </p>
      ...
      <section className="border-y border-white/10 py-14 px-4 sm:px-6 lg:px-8 bg-white/[0.02]" aria-label="Blog and guides">
        <div className="mx-auto max-w-4xl">
          <div className="text-center mb-8">
            ...
            <p className="text-white/70 max-w-xl mx-auto">
              Straightforward guides on booking, discretion, and what to expect in Trivandrum and South India.
            </p>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            <Link
      ...
      {/* FAQ – label + cards */}
      <section className="border-y border-white/10 py-14 px-4 sm:px-6 lg:px-8 bg-white/[0.02]" aria-label="Frequently asked questions about Trivandrum escorts">
        <div className="mx-auto max-w-3xl">
          <div className="text-center mb-10">
            <span className="inline-block text-xs font-semibold tracking-[0.2em] text-[var(--accent-gold)] uppercase mb-2">
              FAQ
            ...
            <h2 className="text-2xl sm:text-3xl font-bold text-white mb-3">
              Top Questions about Escorts in Trivandrum
            </h2>
        ...
        <div className="mx-auto max-w-2xl">
          <div className="rounded-2xl border border-[var(--accent-gold)]/30 bg-black/50 px-6 sm:px-10 py-10 sm:py-12 text-center">
            ...
            <h2 className="text-2xl font-bold text-white mb-4">
              Ready to Book a Trivandrum Escort?
            </h2>
            <p className="text-white/70 mb-6">
              Message us with your area, when you need someone, and what you have in mind. We&apos;re on Telegram. No bots—you&apos;ll talk to someone who handles Trivandrum bookings every day. Questions about areas, payment, or what to expect? Ask when you message.
            </p>
            <div className="flex flex-wrap justify-center gap-4">
              <a
                ...
                title="Contact Trivandrum escorts on Telegram"
              ...
              <Link
                href="/contact"
                title="Contact us to book Trivandrum escorts"
