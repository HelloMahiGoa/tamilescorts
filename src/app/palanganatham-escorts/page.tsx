...
const url = `${base}/palanganatham-escorts`;

const metaTitle = "Palanganatham Escorts | Madurai Escorts in Palanganatham – Outcall to Your Place";
const metaDescription =
  "Palanganatham escorts and escort service in Madurai. Outcall to your place in Palanganatham. Discreet, verified. Tamil & Mallu companions. Pay when you meet. No advance for regular & housewife.";

export const metadata: Metadata = {
  title: metaTitle,
  description: metaDescription,
  keywords: [
    "Palanganatham escorts",
    "escorts in Palanganatham",
    "Palanganatham escort service",
    "Madurai escorts Palanganatham",
    "outcall Palanganatham",
    "hotel escort Palanganatham",
    "Tamil escorts Palanganatham",
    "escort service Madurai Palanganatham",
    "business hotel escorts Palanganatham",
    "Palanganatham hotel escorts",
    "discreet escorts Palanganatham",
    "verified escorts Palanganatham",
    "Mallu escorts Palanganatham",
    "Malayalam escorts Palanganatham",
    "housewife escorts Palanganatham",
    "college girls escorts Palanganatham",
    "model escorts Palanganatham",
    "regular escorts Palanganatham",
    "escort booking Palanganatham",
    "escort service Palanganatham Madurai",
    "outcall escort service Palanganatham",
    "24/7 escorts Palanganatham",
    "same day escorts Palanganatham",
    "business traveler escorts Palanganatham",
    "corporate escort Palanganatham",
    "dinner escort Palanganatham",
    "event escort Palanganatham",
  ],
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Palanganatham escorts – premium outcall escort service in Madurai",
        type: "image/avif",
      },
    ],
  },
  ...
  other: {
    "geo.region": "IN-TN",
    "geo.placename": "Palanganatham, Madurai",
    "geo.position": "9.9;78.085",
    "ICBM": "9.9, 78.085",
  },
};

const OTHER_AREAS = [
  { name: "KK Nagar", slug: "kk-nagar-escorts", desc: "Central & hotels" },
  { name: "Anna Nagar", slug: "madurai-anna-nagar-escorts", desc: "Residential & stays" },
  { name: "Koodal Nagar", slug: "koodal-nagar-escorts", desc: "Commercial hub" },
  { name: "Goripalayam", slug: "goripalayam-escorts", desc: "Near temple" },
  { name: "Simakkal", slug: "simakkal-escorts", desc: "Central Madurai" },
];

const HOW_IT_WORKS = [
  { step: 1, title: "Contact Us", body: "Message with your location in Palanganatham (hotel or area), when you need someone, and what you have in mind. We'll ask the basics-hotel proof if you're at a hotel, type (regular, housewife, model, etc.)." },
  { step: 2, title: "We Suggest Who's Free", body: "We'll tell you who can reach you on time in Palanganatham. If you're at a hotel we need proof and room details; you give her name at reception when she arrives." },
  { step: 3, title: "She Comes to You", body: "Outcall only. She'll come to your hotel or your place in Palanganatham. Payment when she's there - cash or UPI. No advance for regular, housewife and college-girl profiles." },
];
...
const WHY_CHOOSE = [
  ...
  { title: "Complete Discretion", body: "We don't share your number. Your booking stays between you and us. Palanganatham is a prime area in central Madurai with many hotels—we're used to discreet hotel outcall." },
  { title: "Central Location", body: "Palanganatham is Madurai's central commercial and residential area with many hotels. We send someone who can reach you on time." },
...
const LANGUAGES = [
  { name: "Tamil", desc: "Tamil escorts available in Palanganatham. Popular for Tamil-speaking clients and visitors to Madurai." },
  { name: "Malayalam", desc: "Most bookings in Palanganatham are Mallu. Perfect for Kerala locals and Malayalam speakers. Most popular language in Madurai." },
];

const POPULAR_HOTELS = [
  { name: "Business Hotels", area: "Palanganatham", note: "Many business hotels in central Madurai" },
  { name: "Corporate Hotels", area: "Palanganatham", note: "Hotels popular with business travelers and corporate clients" },
  { name: "Budget Hotels", area: "Palanganatham", note: "Affordable hotels in Palanganatham area" },
  { name: "Service Apartments", area: "Palanganatham", note: "Popular for extended business stays" },
];

const DURATION_OPTIONS = [
  { title: "Short Time (2-3 hours)", desc: "Most popular in Palanganatham. Perfect for business travelers staying at hotels who want company for a few hours-dinner, conversation, or relaxed evening. Pay when she arrives; no advance for regular and housewife profiles.", popular: true },
  { title: "Dinner or Evening", desc: "Fixed slot for a dinner, event, or party in Palanganatham. Tell us the start time and when it ends. Same payment rules. We match someone who fits the occasion.", popular: false },
  { title: "Full Night", desc: "Dinner plus the night-typically 8–10 hours. Advance notice helps so we can confirm who's free in Palanganatham. Payment when she's there; for models and above we take a small advance.", popular: false },
  { title: "Outstation Travel", desc: "Trips from Palanganatham to Rameshwaram, Kodaikanal, or Thekkady. We need a few days' notice. Not every companion does outstation. Same discretion and payment.", popular: false },
];

const WHO_BOOKS_RS_PURAM = [
  { title: "Tourists", body: "Staying at hotels in Palanganatham for leisure. Want company to explore Madurai or nearby hill stations. Need discreet company that's hassle-free. Many bookings from visitors." },
  { title: "Business Travelers", body: "Staying at hotels in Palanganatham for work. Don't want to eat alone or sit in a room. Need discreet company that's hassle-free. Popular for business travelers." },
  { title: "Locals", body: "Living in or near Palanganatham and want company for an evening-dinner, event, or just a few hours. Same process: tell us your area, when, and type; we fix someone who shows up." },
];

const TIPS_FOR_EXPERIENCE = [
  { tip: "Be Clear About Location", detail: "Tell us your exact location in Palanganatham-hotel name and area, or your residential area. Clear gate or lobby instructions help avoid delays." },
...
const SERVICES_OCCASIONS = [
  { title: "Dinner Dates", desc: "Company for dinner at restaurants in Palanganatham. Presentable, conversation-ready. Perfect for business dinners or casual evenings.", popular: true },
  ...
  { title: "Parties & Social Events", desc: "Companion for parties, celebrations, or social gatherings in Palanganatham. Fun, engaging, fits the occasion.", popular: false },
  { title: "Travel Companion", desc: "Company for outstation trips from Palanganatham—Rameshwaram, Kodaikanal, or Thekkady. Advance notice required.", popular: false },
...
const WHY_PALANGANATHAM = [
  { title: "Residential Area", desc: "Palanganatham is a residential area in Madurai. Easy for escorts to reach your place discreetly." },
  { title: "Quiet & Discreet", desc: "Residential area with privacy. We're experienced with discreet outcall to residences." },
  { title: "Accessible Area", desc: "Palanganatham is easily accessible from other parts of Madurai. Popular for locals and extended-stay visitors." },
  { title: "Good Connectivity", desc: "Well-connected residential area. We know the layout and can coordinate timely arrival." },
];

const TRANSPORTATION_INFO = [
  { title: "Travel Time", desc: "Escorts typically reach Palanganatham within 30-60 minutes from other parts of Madurai. We factor in travel time when suggesting who can reach you on time." },
  ...
  { title: "Traffic Considerations", desc: "Madurai traffic can vary. We account for peak hours (evening rush) when scheduling. Advance bookings give us more flexibility to avoid delays." },
];
...
const COMMON_CONCERNS = [
  { concern: "Is this legitimate?", answer: "Yes. We're a professional escort service operating in Madurai. All escorts are verified, real people. We maintain discretion and professionalism." },
...
const AREA_HIGHLIGHTS = [
  { name: "Business Hotels", type: "Hotels", note: "Many business hotels in Palanganatham area, popular with travelers and corporate clients" },
  { name: "Central Location", type: "Location", note: "Prime central Madurai area with good access to other parts of the city" },
  { name: "Transport Access", type: "Transport", note: "Easy access to transportation connecting to other parts of Madurai" },
  ...
  { name: "Accessibility", type: "Location", note: "Convenient location for visitors staying in North Madurai" },
];

const AREA_COMPARISON = [
  { area: "Palanganatham", advantage: "Residential", note: "Residential area in Madurai with discreet outcall" },
  { area: "KK Nagar", advantage: "Central & hotels", note: "Central area with many business hotels" },
  { area: "Anna Nagar", advantage: "Residential & stays", note: "Residential area with stays" },
  { area: "Koodal Nagar", advantage: "Commercial hub", note: "Commercial and retail center" },
  { area: "Goripalayam", advantage: "Near temple", note: "Near Meenakshi Temple" },
  { area: "Simakkal", advantage: "Central Madurai", note: "Central business area" },
];

const SEASONAL_AVAILABILITY = [
  { period: "Peak Business Season", months: "October - March", desc: "Most business travelers visit Madurai during these months. Weekday evenings are busiest. Advance booking recommended for preferred times.", busy: true },
  { period: "Festival Season", months: "August - January", desc: "Pongal, Diwali, and other festivals bring more visitors to Madurai. Weekend bookings increase. Book ahead for festival dates.", busy: true },
...
const GROUP_BOOKING_INFO = [
  { title: "Multiple Escorts", desc: "Need multiple escorts for a corporate event, party, or group gathering in Palanganatham? We can arrange 2-4 escorts depending on availability. Advance notice required-at least 2-3 days." },
...
const FAQ_ITEMS = [
  { q: "Do you cover Palanganatham?", a: "Yes. Palanganatham is one of our main areas in Madurai. We do outcall to hotels and residences in Palanganatham. Tell us your location (hotel name or area) and when you need someone; we'll suggest who can reach you on time." },
  { q: "Do I need to pay advance in Palanganatham?", a: "For regular, housewife and college-girl profiles -no advance. We need hotel proof and room details if you're at a hotel, and you give her name at reception. For models, artists, celebrity and actress we take a small advance; the rest when she arrives." },
  { q: "What's the best way to book an escort in Palanganatham?", a: "Message us on Telegram. Tell us you're in Palanganatham, when you need someone, and what you're looking for (regular, housewife, model, Tamil, Mallu, etc.). We'll suggest who's free. Same-day and advance bookings both work." },
  { q: "Outcall or incall in Palanganatham?", a: "We do outcall only - she comes to your hotel or your place in Palanganatham. Have the address and any gate or lobby instructions ready." },
  { q: "Why is Palanganatham popular for escort bookings?", a: "Palanganatham is a well-connected area in North Madurai with many business hotels, making it popular with business travelers and visitors. It's easily accessible from other parts of Madurai. Same process as the rest of Madurai: discreet, pay when you meet." },
];

// Build JSON-LD after all constants are defined
function buildPalanganathamJsonLd() {
  ...
  return [
    {
      ...
      itemListElement: [
        ...
        { "@type": "ListItem", position: 2, name: "Madurai Escorts", item: `${base}/madurai-escorts` },
        { "@type": "ListItem", position: 3, name: "Palanganatham Escorts", item: url },
      ],
    },
    {
      "@context": "https://schema.org",
    ...
    },
    {
      ...
      "@type": "LocalBusiness",
      "@id": localBusinessId,
      name: "Palanganatham Escorts",
      description: "Premium escort service in Palanganatham, Madurai. Outcall to hotels and residences. Discreet, verified companions. Tamil & Mallu escorts available.",
      url,
      image: [
        `${base}/images/2.avif`,
      ],
      ...
      address: {
        "@type": "PostalAddress",
        addressLocality: "Palanganatham",
        addressRegion: "Madurai",
            ...
            itemListElement: [
              {
                ...
                itemOffered: {
                  ...
                  description: "Regular escort service in Palanganatham. No advance required.",
                },
              },
            ],
          },
            ...
            itemListElement: [
              {
                ...
                itemOffered: {
                  ...
                  description: "Housewife escort service in Palanganatham. Mature, discreet companions.",
                },
              },
            ],
          },
    ...
    },
    {
      ...
      "@type": "Service",
      "@id": serviceId,
      name: "Escort Service in Palanganatham",
      description: "Premium outcall escort service in Palanganatham, Madurai. Available 24/7. Discreet, verified companions.",
      provider: {
        "@id": organizationId,
      },
      areaServed: {
        "@type": "Place",
        name: "Palanganatham, Madurai",
      },
    ...
    },
    {
      "@context": "https://schema.org",
      "@type": "ItemList",
      name: "Popular Hotels in Palanganatham",
      description: "Popular hotels and locations where we provide escort services in Palanganatham",
    ...
    },
    {
      "@context": "https://schema.org",
      "@type": "ItemList",
      name: "Languages Available in Palanganatham",
      description: "Languages spoken by escorts available in Palanganatham",
...
export default function PalanganathamEscortsPage() {
  const jsonLd = buildPalanganathamJsonLd();
  return (
    <main id="main-content" className="min-h-screen bg-black" itemScope itemType="https://schema.org/WebPage" lang="en-IN">
      ...
      <header className="relative w-full min-h-screen flex flex-col justify-end overflow-hidden" role="banner" itemScope itemType="https://schema.org/WPHeader">
        ...
        <div className="absolute inset-0" aria-hidden="true">
          <Image
            src="/images/2.avif"
            alt="Palanganatham escorts – premium outcall escort service in Madurai. Discreet, verified companions available for hotel and residential bookings in central Madurai."
            fill
          ...
          <div className="mx-auto max-w-7xl">
            ...
            <nav className="mb-6 sm:mb-8" aria-label="Breadcrumb" itemScope itemType="https://schema.org/BreadcrumbList">
              <ol className="flex flex-wrap items-center gap-2 text-xs sm:text-sm text-white/50" role="list">
                ...
                <li itemProp="itemListElement" itemScope itemType="https://schema.org/ListItem">
                  <Link href="/madurai-escorts" className="hover:text-[var(--accent-gold)] transition-colors" itemProp="item" rel="up" aria-label="View Madurai escorts page">
                    <span itemProp="name">Madurai</span>
                  </Link>
                  <meta itemProp="position" content="2" />
                </li>
                <li aria-hidden="true" className="text-white/30">/</li>
                <li itemProp="itemListElement" itemScope itemType="https://schema.org/ListItem">
                  <span className="text-white/70" itemProp="name">Palanganatham</span>
            ...
            <div>
              ...
              <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl 2xl:text-9xl font-black text-white leading-[0.9] mb-4 sm:mb-6 md:mb-8 tracking-tight">
                <span className="block">Palanganatham</span>
              ...
              <p className="text-base sm:text-lg md:text-xl lg:text-2xl text-white/95 leading-relaxed mb-6 sm:mb-8 md:mb-10 max-w-2xl lg:max-w-3xl font-light" itemProp="description">
                Premium escort service in central Madurai. Outcall to your hotel or your place - discreet, verified, pay when you meet.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="grid lg:grid-cols-12 gap-8 sm:gap-10 lg:gap-12 items-start">
            ...
            <div className="lg:col-span-9">
              <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-white mb-6 sm:mb-8 leading-tight" itemProp="name">
                Madurai&apos;s Premier Escort Service in Palanganatham
              </h2>
              <div className="prose prose-invert max-w-none space-y-4 sm:space-y-6 text-base sm:text-lg text-white/80 leading-relaxed" itemProp="description">
                <p>
                  <strong className="text-white">Palanganatham</strong> is a residential area in Madurai. If you live here or are staying and want company for a dinner or an evening, we've got you.</p>
                <p>
                ...
                <p>
                  Outcall only - she comes to you. We don&apos;t share your number; discretion is default. Tell us your location in Palanganatham, when you need someone, and what type you want (Tamil, Mallu, regular, model, etc.). We&apos;ll suggest who&apos;s free and can reach you on time.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="mx-auto max-w-7xl">
          <div className="text-center mb-8 sm:mb-10">
            ...
            <h2 id="why-choose-heading" className="text-3xl sm:text-4xl md:text-5xl font-bold text-white mb-3 sm:mb-4">
              Trusted Service in Palanganatham
            </h2>
          </div>
      ...
      {/* Why Palanganatham Specifically - Diagonal Split Design */}
      <section className="relative py-10 sm:py-12 md:py-16 px-4 sm:px-6 lg:px-8" aria-labelledby="why-palanganatham-heading" itemScope itemType="https://schema.org/ItemList">
        <div className="mx-auto max-w-7xl">
          <div className="mb-10 sm:mb-12">
            <div className="flex items-center gap-4 mb-4" aria-hidden="true">
              <div className="h-1 w-16 bg-[var(--accent-gold)]" />
              <span className="text-xs font-mono tracking-widest text-[var(--accent-gold)] uppercase">Why Palanganatham</span>
            </div>
            <h2 id="why-palanganatham-heading" className="text-4xl sm:text-5xl md:text-6xl font-black text-white mb-4 leading-tight" itemProp="name">
              Why Choose<br />Palanganatham?
            </h2>
          </div>

          <div className="grid lg:grid-cols-2 gap-6 sm:gap-8" itemProp="itemListElement" role="list">
            {WHY_PALANGANATHAM.map((item, idx) => (
              <article
                key={item.title}
          ...
          <div className="grid lg:grid-cols-12 gap-6 sm:gap-8 mb-6 sm:mb-8">
            <div className="lg:col-span-4">
              ...
              <p className="text-base sm:text-lg text-white/70" itemProp="description">
                Regular, housewife, college girls, models and more. All available for outcall in Palanganatham.
              </p>
            </div>
                ...
                {CATEGORIES.map((cat, idx) => (
                  ...
                  >
                    <Link
                      ...
                      rel="follow"
                      aria-label={`Browse ${cat.label} in Palanganatham`}
                      itemProp="item"
                    >
        ...
        <div className="mx-auto max-w-7xl">
          <div className="text-center mb-8 sm:mb-10">
            ...
            <h2 id="languages-heading" className="text-3xl sm:text-4xl md:text-5xl font-bold text-white mb-3 sm:mb-4" itemProp="name">
              Languages Available in Palanganatham
            </h2>
            <p className="text-base sm:text-lg md:text-xl text-white/70 max-w-2xl mx-auto" itemProp="description">
              Tamil and Mallu escorts available for outcall in Palanganatham.
            </p>
          </div>
        ...
        <div className="mx-auto max-w-7xl">
          <div className="text-center mb-8 sm:mb-10">
            ...
            <h2 id="hotels-heading" className="text-3xl sm:text-4xl md:text-5xl font-bold text-white mb-3 sm:mb-4" itemProp="name">
              Popular Hotels & Locations in Palanganatham
            </h2>
            <p className="text-base sm:text-lg md:text-xl text-white/70 max-w-2xl mx-auto" itemProp="description">
              We cover hotels in Palanganatham central business district. Central location with good connectivity makes it easy for outcall.
            </p>
          </div>
          ...
          <div className="mt-8 p-6 bg-black/40 border border-white/10 rounded-xl">
            <p className="text-white/80 text-center">
              Hotels in <strong className="text-white">Palanganatham</strong>, <strong className="text-white">MG Road</strong>, and surrounding business areas are all covered. Tell us your hotel name and area when you book.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="relative py-10 sm:py-12 md:py-16 px-4 sm:px-6 lg:px-8 bg-white/[0.02] overflow-hidden" aria-labelledby="highlights-heading" itemScope itemType="https://schema.org/ItemList">
        ...
        <div className="mx-auto max-w-7xl relative z-10">
          <div className="text-center mb-10 sm:mb-12">
            ...
            <p className="text-base sm:text-lg text-white/60 max-w-xl mx-auto" itemProp="description">
              Key locations and landmarks in and around Palanganatham.
            </p>
          </div>
        ...
        <div className="mx-auto max-w-7xl">
          <div className="text-center mb-8 sm:mb-10">
            ...
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-white mb-3 sm:mb-4">
              Duration Options in Palanganatham
            </h2>
            <p className="text-base sm:text-lg md:text-xl text-white/70 max-w-2xl mx-auto">
              Flexible durations. All outcall to your hotel or your place in Palanganatham.
            </p>
          </div>
          ...
          <div className="space-y-6">
            <div className="p-6 sm:p-8 bg-white/5 border border-white/10 rounded-xl">
              ...
              <p className="text-white/75 mb-4">
                We accept cash or UPI payments. Payment is made when the escort arrives at your location in Palanganatham.
              </p>
            ...
            <div className="p-6 sm:p-8 bg-white/5 border border-white/10 rounded-xl">
              ...
              <p className="text-white/75 mb-4">
                For regular, housewife and college-girl profiles -no advance required. Payment when she arrives at your hotel or your place in Palanganatham. Have payment ready-cash or UPI-to make the transaction smooth.
              </p>
            ...
            <div className="p-6 sm:p-8 bg-white/5 border border-white/10 rounded-xl">
              ...
              <p className="text-white/75">
                If you&apos;re at a hotel in Palanganatham, we need proof you&apos;re staying there (room key photo or bill) and your room number. You give her name at reception when she arrives so she can come up. Payment is made when she arrives.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="relative py-10 sm:py-12 md:py-16 px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-6xl">
          <div className="text-center mb-10 sm:mb-12">
            ...
            <p className="text-base sm:text-lg text-white/60 max-w-xl mx-auto">
              What affects the rates in Palanganatham.
            </p>
          </div>
        ...
        <div className="mx-auto max-w-5xl">
          ...
          <div className="space-y-6">
            <div className="p-6 sm:p-8 bg-black/40 border border-white/10 rounded-xl">
              ...
              <p className="text-white/75">
                Message as early as you can. We usually reply within 1–2 hours; we&apos;ll tell you who&apos;s free and can reach you in Palanganatham. Popular for business travelers who decide last minute.
              </p>
            </div>
            <div className="p-6 sm:p-8 bg-black/40 border border-white/10 rounded-xl">
            ...
            <div className="p-6 sm:p-8 bg-black/40 border border-white/10 rounded-xl">
              ...
              <p className="text-white/75">
                Evenings and weekends can be busier in Palanganatham. We&apos;ll still respond; advance notice helps secure your preferred time. Business travelers often book weekday evenings.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="relative py-10 sm:py-12 md:py-16 px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-7xl">
          <div className="text-center mb-8 sm:mb-10">
            ...
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-white mb-3 sm:mb-4">
              Who Books Escorts in Palanganatham?
            </h2>
            <p className="text-base sm:text-lg md:text-xl text-white/70 max-w-2xl mx-auto">
      ...
      <section className="relative py-10 sm:py-12 md:py-16 px-4 sm:px-6 lg:px-8 bg-white/[0.02]">
        <div className="mx-auto max-w-5xl">
          <div className="text-center mb-8 sm:mb-10">
            ...
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-white mb-3 sm:mb-4">
              Safety & Discretion in Palanganatham
            </h2>
            <p className="text-base sm:text-lg md:text-xl text-white/70 max-w-2xl mx-auto">
          ...
          <div className="grid sm:grid-cols-2 gap-4 sm:gap-6">
            {[
              { title: "Complete Discretion", desc: "We don't share your number with escorts. Your booking stays between you and us. Palanganatham is a business district-we're used to discreet hotel outcall and understand the need for privacy." },
              { title: "Verified Profiles", desc: "All escorts are verified before listing. Real photos, real people. No fake profiles or bait-and-switch in Palanganatham bookings." },
              { title: "Outcall Only", desc: "She comes to you-your hotel or your place in Palanganatham. You control the environment. No incall locations." },
          ...
          <div className="space-y-6">
            {[
              ...
              },
              {
                ...
                icon: "📊",
                content: "We monitor feedback and maintain quality standards. If an escort doesn't meet expectations, we address it immediately. Your feedback helps us maintain service quality in Palanganatham.",
                items: null,
                note: null
              }
            ].map((item, idx) => (
      ...
      <section className="relative py-10 sm:py-12 md:py-16 px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-5xl">
          <div className="text-center mb-8 sm:mb-10">
            ...
            <p className="text-base sm:text-lg md:text-xl text-white/70 max-w-2xl mx-auto">
              Have these ready so your booking in Palanganatham goes smoothly.
            </p>
          </div>

          <div className="space-y-4">
            {[
              { label: "Your Location", detail: "Exact location in Palanganatham-hotel name and area, or residential area and address. If it's your place, any gate or lobby instructions." },
          ...
          <div className="space-y-5">
            {[
              ...
              },
              {
                ...
                icon: "🏨",
                desc: "If you're staying at a hotel in Palanganatham, we need:",
                items: [
              ...
              },
              {
                ...
                icon: "🏠",
                desc: "For residential bookings in Palanganatham, we need your area and address. Clear gate or lobby instructions help avoid delays.",
                items: null
              },
              {
                title: "Communication",
      ...
      <section className="relative py-10 sm:py-12 md:py-16 px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-5xl">
          <div className="text-center mb-8 sm:mb-10">
            ...
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-white mb-3 sm:mb-4">
              Getting Around Palanganatham
            </h2>
            <p className="text-base sm:text-lg md:text-xl text-white/70 max-w-2xl mx-auto">
              Well-planned residential area with good connectivity. Easy to reach from other parts of Madurai.
            </p>
          </div>

          <div className="p-6 sm:p-8 bg-black/40 border border-white/10 rounded-xl">
            <p className="text-white/80 leading-relaxed mb-4">
              <strong className="text-white">Palanganatham</strong> is the central business district of Madurai with many business hotels. Whether you're staying at a hotel near the railway station, MG Road, or other business areas, we factor in travel time when suggesting who can reach you.
            </p>
            <p className="text-white/80 leading-relaxed mb-4">
            ...
            <p className="text-white/80 leading-relaxed">
              <strong className="text-white">Nearby areas:</strong> Marine Drive (5 min), Kakkanad (15 min), Edappally (20 min), Palanganatham (25 min). Palanganatham&apos;s central location makes it ideal for business travelers and visitors.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="relative py-10 sm:py-12 md:py-16 px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-5xl">
          ...
          <div className="mt-10 p-8 bg-gradient-to-r from-[var(--accent-gold)]/10 via-[var(--accent-gold)]/5 to-[var(--accent-gold)]/10 border-l-4 border-[var(--accent-gold)] rounded-xl">
            <p className="text-white/90 text-center leading-relaxed">
              <strong className="text-white">You don&apos;t need to arrange transportation.</strong> We handle all coordination. The escort will come directly to your location in Palanganatham.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="relative py-10 sm:py-12 md:py-16 px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-5xl">
          <div className="text-center mb-8 sm:mb-10">
            ...
            <p className="text-base sm:text-lg md:text-xl text-white/70 max-w-2xl mx-auto">
              Make your booking in Palanganatham smooth and hassle-free.
            </p>
          </div>
      ...
      {/* Comparison with Other Madurai Areas - Comparison Table Design */}
      <section className="relative py-10 sm:py-12 md:py-16 px-4 sm:px-6 lg:px-8 overflow-hidden">
        ...
        <div className="mx-auto max-w-7xl relative z-10">
          <div className="text-center mb-10 sm:mb-12">
            ...
            <h2 className="text-4xl sm:text-5xl md:text-6xl font-black text-white mb-4 leading-tight">
              Palanganatham vs<br />Other Areas
            </h2>
            <p className="text-base sm:text-lg text-white/60 max-w-xl mx-auto">
              What makes Palanganatham unique.
            </p>
          </div>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5 sm:gap-6">
            {AREA_COMPARISON.map((item, idx) => (
              <div
                key={item.area}
                className={`relative group ${
                  item.area === "Palanganatham" ? 'lg:col-span-3 sm:col-span-2' : ''
                }`}
              >
                {item.area === "Palanganatham" && (
                ...
                <div className={`relative p-6 sm:p-8 bg-black/60 backdrop-blur-md border-2 ${
                  ...
                  <div className={`text-center ${item.area === "Palanganatham" ? 'mt-4' : ''}`}>
          ...
          <div className="mt-10 p-8 bg-gradient-to-r from-black/80 via-[var(--accent-gold)]/10 to-black/80 border-2 border-[var(--accent-gold)]/30 rounded-2xl">
            <p className="text-white/90 text-center leading-relaxed text-base sm:text-lg">
              <strong className="text-white">Palanganatham&apos;s central location</strong> makes it ideal for business travelers and visitors. Central business district, main transport hub, many business hotels, and we're experienced with corporate clients.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="relative py-10 sm:py-12 md:py-16 px-4 sm:px-6 lg:px-8 bg-black" aria-labelledby="cta-heading" itemScope itemType="https://schema.org/ContactPage">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="text-lg sm:text-xl text-white/80 mb-8 sm:mb-10 max-w-2xl mx-auto" itemProp="description">
            Message us with your location in Palanganatham, when you need someone, and what you have in mind.
          </p>
          <div className="flex flex-wrap justify-center gap-3 sm:gap-4" role="group" aria-label="Contact options">
            <a
              href="https://t.me/LillyBabe_Madurai"
              target="_blank"
              ...
              aria-label="Contact us on Telegram for Palanganatham escort bookings"
            ...
            <Link
              ...
              rel="follow"
              aria-label="Contact page for Palanganatham escort service"
            >
              Contact
            </Link>
          </div>
