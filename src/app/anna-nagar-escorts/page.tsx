...
const url = `${base}/anna-nagar-escorts`;

const metaTitle = "Anna Nagar Escorts | Chennai Escorts in Anna Nagar – Outcall to Hotels & Your Place";
const metaDescription =
  "Anna Nagar escorts and escort service in Chennai. Outcall to your hotel or place in Anna Nagar. Discreet, verified. Tamil, Mallu, Telugu & Kannada. Pay when you meet. No advance for regular & housewife.";
...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "escort service Chennai Anna Nagar",
    "Anna Nagar West escorts",
    "Anna Nagar East escorts",
    "residential escorts Anna Nagar",
    "Anna Nagar hotel escorts",
    "discreet escorts Anna Nagar",
    "verified escorts Anna Nagar",
    "Mallu escorts Anna Nagar",
    "Telugu escorts Anna Nagar",
    "Kannada escorts Anna Nagar",
    ...
    "escort service Anna Nagar Chennai",
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Anna Nagar escorts – premium outcall escort service in Chennai",
        type: "image/avif",
      },
    ],
  },
  ...
  other: {
    "geo.region": "IN-TN",
    "geo.placename": "Anna Nagar, Chennai",
    "geo.position": "13.0900;80.2100",
    "ICBM": "13.0900, 80.2100",
  },
};
...
const WHY_CHOOSE = [
  ...
  { title: "Complete Discretion", body: "We don't share your number. Your booking stays between you and us. Anna Nagar is a residential area-we're used to discreet residential outcall and understand the need for privacy." },
  { title: "Residential Area", body: "Anna Nagar is a well-planned residential locality. We understand residential clients need discretion and privacy. We send someone who can reach you on time." },
...
const LANGUAGES = [
  { name: "Tamil", desc: "Most bookings in Anna Nagar are Tamil. Perfect for locals and Tamil-speaking clients." },
  { name: "Malayalam", desc: "Mallu escorts available in Anna Nagar. Great for Kerala clients and Malayalam speakers." },
  { name: "Telugu", desc: "Telugu-speaking companions in Anna Nagar. Popular for business travelers from Andhra/Telangana." },
  { name: "Kannada", desc: "Kannada escorts in Anna Nagar. Same booking process and discretion." },
];

const POPULAR_HOTELS = [
  { name: "Residential Hotels", area: "Anna Nagar West", note: "Smaller hotels popular with residential clients" },
  { name: "Business Hotels", area: "Anna Nagar East", note: "Convenient for business travelers" },
  { name: "Service Apartments", area: "Anna Nagar", note: "Popular for extended stays, residential feel" },
  { name: "Guest Houses", area: "Anna Nagar", note: "Family-friendly, discreet outcall" },
  { name: "Residential Areas", area: "Anna Nagar West & East", note: "Well-planned residential localities" },
  { name: "Shopping Area Hotels", area: "Near shopping malls", note: "Convenient location for residential clients" },
];

const DURATION_OPTIONS = [
  { title: "Short Time (2-3 hours)", desc: "Most popular in Anna Nagar. Perfect for residential clients who want company for a few hours-dinner, conversation, or relaxed evening. Also popular for business travelers staying at hotels. Pay when she arrives; no advance for regular and housewife profiles.", popular: true },
...
const SERVICES_OCCASIONS = [
  ...
  { title: "Travel Companion", desc: "Company for outstation trips from Anna Nagar-Pondicherry, Mahabalipuram, or elsewhere. Advance notice required.", popular: false },
...
const TRANSPORTATION_INFO = [
  { title: "Travel Time", desc: "Escorts typically reach Anna Nagar within 30-60 minutes from other parts of Chennai. We factor in travel time when suggesting who can reach you on time." },
...
const AREA_HIGHLIGHTS = [
  { name: "Anna Nagar West", type: "Residential area", note: "Well-planned residential locality, family-friendly" },
  { name: "Anna Nagar East", type: "Residential area", note: "Residential area with shopping hubs" },
  { name: "Shopping Malls", type: "Commercial", note: "Multiple shopping malls and commercial areas" },
  { name: "Residential Layouts", type: "Residential", note: "Well-planned residential layouts and colonies" },
  { name: "Shopping Hubs", type: "Commercial", note: "Popular shopping destinations in the area" },
  { name: "Family-Friendly Locality", type: "Residential", note: "Known for its residential and family-friendly environment" },
];

const AREA_COMPARISON = [
  { area: "Anna Nagar", advantage: "Residential advantage", note: "Well-planned residential area, family-friendly, shopping hubs, residential clients prefer this area" },
  { area: "Nungambakkam", advantage: "Central location", note: "Most central, highest hotel density, but more commercial than Anna Nagar" },
  { area: "T Nagar", advantage: "Shopping district", note: "Popular for hotel bookings, but less residential than Anna Nagar" },
  { area: "OMR", advantage: "IT corridor", note: "Good for IT professionals, but further from city center" },
  { area: "Adyar", advantage: "Residential & upscale", note: "Residential area, but different character than Anna Nagar" },
  { area: "Guindy", advantage: "Business district", note: "Corporate hub, but less residential than Anna Nagar" },
  { area: "Velachery", advantage: "South Chennai hub", note: "Growing area with good connectivity, but further from central Chennai" },
  { area: "Egmore", advantage: "Transport hub", note: "Near railway station, convenient but less residential than Anna Nagar" },
];
...
const FAQ_ITEMS = [
  { q: "Do you cover Anna Nagar?", a: "Yes. Anna Nagar is one of our main areas in Chennai. We do outcall to hotels and residences in Anna Nagar. Tell us your location (hotel name or area) and when you need someone; we'll suggest who can reach you on time." },
  ...
  { q: "Why is Anna Nagar popular for escort bookings?", a: "Anna Nagar is a well-planned residential area with shopping hubs and residential clients who value discretion. It's well-connected, making it easy for us to send someone there. Residential clients appreciate the privacy and family-friendly nature of the area. Same process as the rest of Chennai: discreet, pay when you meet." },
];
...
function buildAnnaNagarJsonLd() {
  ...
  return [
    ...
    },
    {
      ...
      description: "Premium escort service in Anna Nagar, Chennai. Outcall to hotels and residences. Discreet, verified companions. Tamil, Mallu, Telugu & Kannada escorts available.",
      url,
      image: [
        `${base}/images/2.avif`,
      ],
    ...
    },
    {
      ...
      description: "Premium outcall escort service in Anna Nagar, Chennai. Available 24/7. Discreet, verified companions.",
      provider: {
        "@id": organizationId,
      },
      areaServed: {
    ...
    <main id="main-content" className="min-h-screen bg-black" itemScope itemType="https://schema.org/WebPage" lang="en-IN">
      ...
      <header className="relative w-full min-h-screen flex flex-col justify-end overflow-hidden" role="banner" itemScope itemType="https://schema.org/WPHeader">
        ...
        <div className="absolute inset-0" aria-hidden="true">
          <Image
            src="/images/2.avif"
            alt="Anna Nagar escorts – premium outcall escort service in Chennai. Discreet, verified companions available for hotel and residential bookings in central Chennai."
            fill
          ...
          <div className="grid lg:grid-cols-12 gap-8 sm:gap-10 lg:gap-12 items-start">
            ...
            <div className="lg:col-span-9">
              <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-white mb-6 sm:mb-8 leading-tight" itemProp="name">
                Residential Chennai&apos;s Premier Escort Service
              </h2>
              <div className="prose prose-invert max-w-none space-y-4 sm:space-y-6 text-base sm:text-lg text-white/80 leading-relaxed" itemProp="description">
                <p>
                  <strong className="text-white">Anna Nagar</strong> is a well-planned residential area in Chennai, known for its family-friendly environment and shopping hubs. If you live in Anna Nagar West or East and want discreet company for a dinner or an evening, we&apos;ve got you. We also serve clients staying at hotels in the area.
                </p>
                <p>
      ...
      <section className="relative py-10 sm:py-12 md:py-16 px-4 sm:px-6 lg:px-8" aria-labelledby="why-anna-nagar-heading" itemScope itemType="https://schema.org/ItemList">
        <div className="mx-auto max-w-7xl">
          <div className="mb-10 sm:mb-12">
            ...
            <h2 id="why-anna-nagar-heading" className="text-4xl sm:text-5xl md:text-6xl font-black text-white mb-4 leading-tight" itemProp="name">
      ...
      <section className="relative py-10 sm:py-12 md:py-16 px-4 sm:px-6 lg:px-8 bg-white/[0.02]" aria-labelledby="languages-heading" itemScope itemType="https://schema.org/ItemList">
        <div className="mx-auto max-w-7xl">
          <div className="text-center mb-8 sm:mb-10">
            ...
            <p className="text-base sm:text-lg md:text-xl text-white/70 max-w-2xl mx-auto" itemProp="description">
              Tamil, Mallu, Telugu, and Kannada escorts available for outcall in Anna Nagar.
            </p>
          </div>
      ...
      <section className="relative py-10 sm:py-12 md:py-16 px-4 sm:px-6 lg:px-8 bg-white/[0.02]" aria-labelledby="hotels-heading" itemScope itemType="https://schema.org/ItemList">
        <div className="mx-auto max-w-7xl">
          <div className="text-center mb-8 sm:mb-10">
            ...
            <p className="text-base sm:text-lg md:text-xl text-white/70 max-w-2xl mx-auto" itemProp="description">
              We cover hotels and residential areas in Anna Nagar. Well-planned residential area with good connectivity makes it easy for outcall.
            </p>
          </div>
          ...
          <div className="mt-8 p-6 bg-black/40 border border-white/10 rounded-xl">
            <p className="text-white/80 text-center">
              <strong className="text-white">Anna Nagar West</strong>, <strong className="text-white">Anna Nagar East</strong>, and surrounding residential areas are all covered. Tell us your hotel name or residential area when you book.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="relative py-10 sm:py-12 md:py-16 px-4 sm:px-6 lg:px-8 bg-white/[0.02]">
        <div className="mx-auto max-w-5xl">
          ...
          <div className="grid sm:grid-cols-2 gap-4 sm:gap-6">
            {[
              { title: "Complete Discretion", desc: "We don't share your number with escorts. Your booking stays between you and us. Anna Nagar is a residential area-we're used to discreet residential outcall and understand the need for privacy." },
      ...
      <section className="relative py-10 sm:py-12 md:py-16 px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-5xl">
          <div className="text-center mb-8 sm:mb-10">
            ...
            <p className="text-base sm:text-lg md:text-xl text-white/70 max-w-2xl mx-auto">
              Well-planned residential area with good connectivity. Easy to reach from other parts of Chennai.
            </p>
          </div>

          <div className="p-6 sm:p-8 bg-black/40 border border-white/10 rounded-xl">
            <p className="text-white/80 leading-relaxed mb-4">
              <strong className="text-white">Anna Nagar</strong> is a well-planned residential area in Chennai, known for its family-friendly environment. Whether you live in Anna Nagar West, Anna Nagar East, or are staying at a hotel in the area, we factor in travel time when suggesting who can reach you.
            </p>
            <p className="text-white/80 leading-relaxed mb-4">
            ...
            <p className="text-white/80 leading-relaxed">
              <strong className="text-white">Nearby areas:</strong> T Nagar (10 min), Egmore (15 min), Adyar (20 min), Guindy (25 min). Anna Nagar&apos;s residential character makes it ideal for clients who value privacy and discretion.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="relative py-10 sm:py-12 md:py-16 px-4 sm:px-6 lg:px-8 overflow-hidden">
        ...
        <div className="mx-auto max-w-7xl relative z-10">
          ...
          <div className="mt-10 p-8 bg-gradient-to-r from-black/80 via-[var(--accent-gold)]/10 to-black/80 border-2 border-[var(--accent-gold)]/30 rounded-2xl">
            <p className="text-white/90 text-center leading-relaxed text-base sm:text-lg">
              <strong className="text-white">Anna Nagar&apos;s residential advantage</strong> makes it ideal for clients who value privacy and discretion. Well-planned residential area, family-friendly environment, shopping hubs, and we understand the needs of residential clients better than any other area in Chennai.
            </p>
          </div>
        </div>
      </section>
