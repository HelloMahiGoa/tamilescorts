...
const url = `${base}/omr-escorts`;

const metaTitle = "OMR Escorts | Chennai Escorts in OMR – Outcall to Hotels & Your Place";
const metaDescription =
  "OMR escorts and escort service in Chennai. Outcall to your hotel or place in OMR. Discreet, verified. Tamil, Mallu, Telugu & Kannada. Pay when you meet. No advance for regular & housewife.";
...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "hotel escort OMR",
    "Tamil escorts OMR",
    "escort service Chennai OMR",
    "Old Mahabalipuram Road escorts",
    "IT corridor escorts",
    "escorts near Sholinganallur",
    "OMR hotel escorts",
    "discreet escorts OMR",
    "verified escorts OMR",
    "Mallu escorts OMR",
    "Telugu escorts OMR",
    "Kannada escorts OMR",
    "housewife escorts OMR",
    "college girls escorts OMR",
    "model escorts OMR",
    "regular escorts OMR",
    "escort booking OMR",
    "escort service OMR Chennai",
    "outcall escort service OMR",
    "24/7 escorts OMR",
    "same day escorts OMR",
    "business traveler escorts OMR",
    "corporate escort OMR",
    "dinner escort OMR",
    "event escort OMR",
  ],
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "OMR escorts – premium outcall escort service in Chennai",
        type: "image/avif",
      },
    ],
  },
  ...
  other: {
    "geo.region": "IN-TN",
    "geo.placename": "OMR, Chennai",
    "geo.position": "12.9000;80.2000",
    "ICBM": "12.9000, 80.2000",
  },
};
...
const HOW_IT_WORKS = [
  { step: 1, title: "Contact Us", body: "Message with your location in OMR (hotel or area), when you need someone, and what you have in mind. We'll ask the basics-hotel proof if you're at a hotel, type (regular, housewife, model, etc.)." },
  { step: 2, title: "We Suggest Who's Free", body: "We'll tell you who can reach you on time in OMR. If you're at a hotel we need proof and room details; you give her name at reception when she arrives." },
  { step: 3, title: "She Comes to You", body: "Outcall only. She'll come to your hotel or your place in OMR. Payment when she's there -cash or UPI. No advance for regular, housewife and college-girl profiles." },
];
...
const WHY_CHOOSE = [
  ...
  { title: "Complete Discretion", body: "We don't share your number. Your booking stays between you and us. OMR is Chennai's IT corridor-we're used to discreet hotel and corporate outcall." },
  { title: "IT Corridor Hub", body: "OMR is Chennai's premier IT corridor with tech parks. We send someone who can reach you on time. No fuss." },
...
const LANGUAGES = [
  { name: "Tamil", desc: "Most bookings in OMR are Tamil. Perfect for locals and Tamil-speaking IT professionals." },
  { name: "Malayalam", desc: "Mallu escorts available in OMR. Great for Kerala IT professionals and Malayalam speakers." },
  { name: "Telugu", desc: "Telugu-speaking companions in OMR. Popular for IT professionals and business travelers from Andhra/Telangana." },
  { name: "Kannada", desc: "Kannada escorts in OMR. Same booking process and discretion." },
];

const POPULAR_HOTELS = [
  { name: "ITC Grand Chola", area: "Guindy Road", note: "Luxury hotel, popular for IT executives" },
  { name: "Leela Palace", area: "Adyar", note: "High-end, discreet outcall" },
  { name: "Radisson Blu", area: "OMR", note: "IT corridor location, tech park proximity" },
  { name: "Holiday Inn", area: "OMR", note: "Popular with IT professionals" },
  { name: "Novotel", area: "OMR", note: "Corporate hotel, convenient for tech companies" },
  { name: "ITC Kohenur", area: "HITEC City", note: "Tech hub hotel, many corporate bookings" },
];

const DURATION_OPTIONS = [
  { title: "Short Time (2-3 hours)", desc: "Most popular in OMR. Perfect for IT professionals staying at hotels. She comes to you for a few hours-dinner, conversation, or relaxed evening. Pay when she arrives; no advance for regular and housewife profiles.", popular: true },
  { title: "Dinner or Evening", desc: "Fixed slot for a dinner, event, or party in OMR. Tell us the start time and when it ends. Same payment rules. We match someone who fits the occasion.", popular: false },
  { title: "Full Night", desc: "Dinner plus the night-typically 8–10 hours. Advance notice helps so we can confirm who's free in OMR. Payment when she's there; for models and above we take a small advance.", popular: false },
  { title: "Outstation Travel", desc: "Trips from OMR to Pondicherry, Mahabalipuram, or elsewhere. We need a few days' notice. Not every companion does outstation. Same discretion and payment.", popular: false },
];

const WHO_BOOKS_OMR = [
  { title: "IT Professionals", body: "Working in OMR tech parks and staying at hotels. Don't want to eat alone or sit in a room. Need discreet company that's hassle-free. Most bookings are from IT professionals." },
  { title: "Corporate Clients", body: "Living in or near OMR and want company for an evening-dinner, event, or just a few hours. Same process: tell us your area, when, and type; we fix someone who shows up." },
  { title: "Tech Industry Events", body: "Need a plus-one for a client dinner or corporate event in OMR. We send someone presentable who knows how to keep the evening smooth. Popular for tech industry gatherings." },
];

const TIPS_FOR_EXPERIENCE = [
  { tip: "Be Clear About Location", detail: "Tell us your exact location in OMR-hotel name and area, or your residential area. Clear gate or lobby instructions help avoid delays." },
...
const SERVICES_OCCASIONS = [
  { title: "Dinner Dates", desc: "Company for dinner at restaurants in OMR. Presentable, conversation-ready. Perfect for business dinners or casual evenings.", popular: true },
  { title: "Corporate Events", desc: "Plus-one for client meetings, corporate dinners, or tech industry events. Professional, well-dressed, knows how to keep the evening smooth.", popular: true },
  { title: "Parties & Social Events", desc: "Companion for parties, celebrations, or social gatherings in OMR. Fun, engaging, fits the occasion.", popular: false },
  { title: "Travel Companion", desc: "Company for outstation trips from OMR-Pondicherry, Mahabalipuram, or elsewhere. Advance notice required.", popular: false },
...
const WHY_OMR = [
  { title: "IT Corridor Hub", desc: "OMR is Chennai's premier IT corridor with major tech parks and corporate offices. Easy access for escorts from across Chennai. Perfect for IT professionals and corporate clients." },
  { title: "Tech Park Hotels", desc: "High concentration of hotels near tech parks in OMR means we're experienced with IT corridor bookings. We know the area, the hotels, and how to coordinate discreet outcall." },
  { title: "Corporate Focus", desc: "Many IT professionals and corporate clients stay in OMR. We're used to tech industry clients, corporate dinners, and professional occasions. Discretion is our default." },
  { title: "Growing Infrastructure", desc: "Well-connected by road, close to major IT parks like Sholinganallur, Perungudi, Navalur, and Siruseri. Escorts can reach you quickly, whether you're at a hotel or corporate accommodation." },
];

const TRANSPORTATION_INFO = [
  { title: "Travel Time", desc: "Escorts typically reach OMR within 30-60 minutes from other parts of Chennai. We factor in travel time when suggesting who can reach you on time." },
...
const AREA_HIGHLIGHTS = [
  { name: "Sholinganallur", type: "IT Park", note: "Major tech park with corporate offices" },
  { name: "Perungudi", type: "IT Hub", note: "Tech companies and IT parks" },
  { name: "Navalur", type: "IT Corridor", note: "Growing tech hub with corporate offices" },
  { name: "Siruseri", type: "IT Park", note: "SIPCOT IT Park, major tech companies" },
  { name: "HITEC City", type: "Tech Hub", note: "Hyderabad IT Corridor extension, corporate offices" },
  { name: "DLF IT Park", type: "Corporate Hub", note: "Major IT park with tech companies" },
];

const AREA_COMPARISON = [
  { area: "OMR", advantage: "IT Corridor Advantage", note: "Premier IT corridor with tech parks, perfect for IT professionals and corporate clients" },
  { area: "T Nagar", advantage: "Shopping district", note: "Popular for hotel bookings, but not IT-focused like OMR" },
  { area: "Nungambakkam", advantage: "Central location", note: "Central Chennai location, but lacks OMR's IT corridor advantage" },
  { area: "Adyar", advantage: "Residential & upscale", note: "Quieter area, good hotels but fewer tech companies than OMR" },
  { area: "Guindy", advantage: "Business district", note: "Corporate hub, but not as IT-focused as OMR" },
  { area: "Velachery", advantage: "South Chennai hub", note: "Growing area with good connectivity, but fewer tech parks than OMR" },
  { area: "Egmore", advantage: "Transport hub", note: "Near railway station, convenient but not IT corridor focused" },
];
...
const GROUP_BOOKING_INFO = [
  { title: "Multiple Escorts", desc: "Need multiple escorts for a corporate event, party, or group gathering in OMR? We can arrange 2-4 escorts depending on availability. Advance notice required-at least 2-3 days." },
...
const FAQ_ITEMS = [
  { q: "Do you cover OMR?", a: "Yes. OMR is one of our main areas in Chennai. We do outcall to hotels and residences in OMR. Tell us your location (hotel name or area) and when you need someone; we'll suggest who can reach you on time." },
  { q: "Do I need to pay advance in OMR?", a: "For regular, housewife and college-girl profiles -no advance. We need hotel proof and room details if you're at a hotel, and you give her name at reception. For models, artists, celebrity and actress we take a small advance; the rest when she arrives." },
  { q: "What's the best way to book an escort in OMR?", a: "Message us on Telegram. Tell us you're in OMR, when you need someone, and what you're looking for (regular, housewife, model, Tamil, Mallu, etc.). We'll suggest who's free. Same-day and advance bookings both work." },
  { q: "Outcall or incall in OMR?", a: "We do outcall only -she comes to your hotel or your place in OMR. Have the address and any gate or lobby instructions ready." },
  { q: "Why is OMR popular for escort bookings?", a: "OMR is Chennai's premier IT corridor with tech parks and corporate offices. Many IT professionals stay here, making it ideal for discreet bookings. Same process as the rest of Chennai: discreet, pay when you meet." },
];

// Build JSON-LD after all constants are defined
function buildOMRJsonLd() {
  ...
  return [
    {
      ...
      itemListElement: [
        ...
        { "@type": "ListItem", position: 3, name: "OMR Escorts", item: url },
      ],
    },
    {
      "@context": "https://schema.org",
    ...
    },
    {
      ...
      "@id": localBusinessId,
      name: "OMR Escorts",
      description: "Premium escort service in OMR, Chennai. Outcall to hotels and residences. Discreet, verified companions. Tamil, Mallu, Telugu & Kannada escorts available.",
      url,
      image: [
        `${base}/images/2.avif`,
      ],
            ...
            itemListElement: [
              {
                ...
                itemOffered: {
                  ...
                  description: "Regular escort service in OMR. No advance required.",
                },
              },
            ],
          },
            ...
            itemListElement: [
              {
                ...
                itemOffered: {
                  ...
                  description: "Housewife escort service in OMR. Mature, discreet companions.",
                },
              },
            ],
          },
    ...
    },
    {
      ...
      "@type": "Service",
      "@id": serviceId,
      name: "Escort Service in OMR",
      description: "Premium outcall escort service in OMR, Chennai. Available 24/7. Discreet, verified companions.",
      provider: {
        "@id": organizationId,
      },
      areaServed: {
    ...
    },
    {
      "@context": "https://schema.org",
      "@type": "ItemList",
      name: "Popular Hotels in OMR",
      description: "Popular hotels and locations where we provide escort services in OMR",
    ...
    },
    {
      "@context": "https://schema.org",
      "@type": "ItemList",
      name: "Languages Available in OMR",
      description: "Languages spoken by escorts available in OMR",
    ...
    <main id="main-content" className="min-h-screen bg-black" itemScope itemType="https://schema.org/WebPage" lang="en-IN">
      ...
      <header className="relative w-full min-h-screen flex flex-col justify-end overflow-hidden" role="banner" itemScope itemType="https://schema.org/WPHeader">
        ...
        <div className="absolute inset-0" aria-hidden="true">
          <Image
            src="/images/2.avif"
            alt="OMR escorts – premium outcall escort service in Chennai. Discreet, verified companions available for hotel and residential bookings in IT corridor Chennai."
            fill
          ...
          <div className="mx-auto max-w-7xl">
            ...
            <nav className="mb-6 sm:mb-8" aria-label="Breadcrumb" itemScope itemType="https://schema.org/BreadcrumbList">
              <ol className="flex flex-wrap items-center gap-2 text-xs sm:text-sm text-white/50" role="list">
                ...
                <li aria-hidden="true" className="text-white/30">/</li>
                <li itemProp="itemListElement" itemScope itemType="https://schema.org/ListItem">
                  <span className="text-white/70" itemProp="name">OMR</span>
          ...
          <div className="grid lg:grid-cols-12 gap-8 sm:gap-10 lg:gap-12 items-start">
            ...
            <div className="lg:col-span-9">
              <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-white mb-6 sm:mb-8 leading-tight" itemProp="name">
                OMR IT Corridor&apos;s Premier Escort Service
              </h2>
              <div className="prose prose-invert max-w-none space-y-4 sm:space-y-6 text-base sm:text-lg text-white/80 leading-relaxed" itemProp="description">
                <p>
                  <strong className="text-white">OMR</strong> is Chennai&apos;s premier IT corridor with tech parks and corporate offices. If you&apos;re staying at a hotel here or you live in the area and want company for a dinner or an evening, we&apos;ve got you.
                </p>
                <p>
                ...
                <p>
                  Outcall only -she comes to you. We don&apos;t share your number; discretion is default. Tell us your location in OMR, when you need someone, and what type you want (Tamil, Mallu, regular, model, etc.). We&apos;ll suggest who&apos;s free and can reach you on time.
                </p>
              </div>
            </div>
          </div>
      ...
      {/* Why OMR Specifically - Diagonal Split Design */}
      <section className="relative py-10 sm:py-12 md:py-16 px-4 sm:px-6 lg:px-8" aria-labelledby="why-omr-heading" itemScope itemType="https://schema.org/ItemList">
        <div className="mx-auto max-w-7xl">
          <div className="mb-10 sm:mb-12">
            <div className="flex items-center gap-4 mb-4" aria-hidden="true">
              <div className="h-1 w-16 bg-[var(--accent-gold)]" />
              <span className="text-xs font-mono tracking-widest text-[var(--accent-gold)] uppercase">Why OMR</span>
            </div>
            <h2 id="why-omr-heading" className="text-4xl sm:text-5xl md:text-6xl font-black text-white mb-4 leading-tight" itemProp="name">
              Why Choose<br />OMR?
            </h2>
          </div>

          <div className="grid lg:grid-cols-2 gap-6 sm:gap-8" itemProp="itemListElement" role="list">
            {WHY_OMR.map((item, idx) => (
              <article
                key={item.title}
          ...
          <div className="grid lg:grid-cols-12 gap-6 sm:gap-8 mb-6 sm:mb-8">
            <div className="lg:col-span-4">
              ...
              <p className="text-base sm:text-lg text-white/70" itemProp="description">
                Regular, housewife, college girls, models and more. All available for outcall in OMR.
              </p>
            </div>
                ...
                {CATEGORIES.map((cat, idx) => (
                  ...
                  >
                    <Link
                      ...
                      rel="follow"
                      aria-label={`Browse ${cat.label} in OMR`}
                      itemProp="item"
                    >
        ...
        <div className="mx-auto max-w-7xl">
          <div className="text-center mb-8 sm:mb-10">
            ...
            <h2 id="languages-heading" className="text-3xl sm:text-4xl md:text-5xl font-bold text-white mb-3 sm:mb-4" itemProp="name">
              Languages Available in OMR
            </h2>
            <p className="text-base sm:text-lg md:text-xl text-white/70 max-w-2xl mx-auto" itemProp="description">
              Tamil, Mallu, Telugu, and Kannada escorts available for outcall in OMR.
            </p>
          </div>
        ...
        <div className="mx-auto max-w-7xl">
          <div className="text-center mb-8 sm:mb-10">
            ...
            <h2 id="hotels-heading" className="text-3xl sm:text-4xl md:text-5xl font-bold text-white mb-3 sm:mb-4" itemProp="name">
              Popular Hotels & Locations in OMR
            </h2>
            <p className="text-base sm:text-lg md:text-xl text-white/70 max-w-2xl mx-auto" itemProp="description">
              We cover major hotels and residential areas in OMR. IT corridor location makes it easy for outcall.
            </p>
          </div>
          ...
          <div className="mt-8 p-6 bg-black/40 border border-white/10 rounded-xl">
            <p className="text-white/80 text-center">
              <strong className="text-white">Sholinganallur</strong>, <strong className="text-white">Perungudi</strong>, <strong className="text-white">Navalur</strong>, <strong className="text-white">Siruseri</strong>, and surrounding IT parks are all covered. Tell us your hotel name or residential area when you book.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="relative py-10 sm:py-12 md:py-16 px-4 sm:px-6 lg:px-8 bg-white/[0.02] overflow-hidden" aria-labelledby="highlights-heading" itemScope itemType="https://schema.org/ItemList">
        ...
        <div className="mx-auto max-w-7xl relative z-10">
          <div className="text-center mb-10 sm:mb-12">
            ...
            <p className="text-base sm:text-lg text-white/60 max-w-xl mx-auto" itemProp="description">
              Key locations and landmarks in and around OMR.
            </p>
          </div>
        ...
        <div className="mx-auto max-w-7xl">
          <div className="text-center mb-8 sm:mb-10">
            ...
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-white mb-3 sm:mb-4">
              Duration Options in OMR
            </h2>
            <p className="text-base sm:text-lg md:text-xl text-white/70 max-w-2xl mx-auto">
              Flexible durations. All outcall to your hotel or your place in OMR.
            </p>
          </div>
          ...
          <div className="space-y-6">
            <div className="p-6 sm:p-8 bg-white/5 border border-white/10 rounded-xl">
              ...
              <p className="text-white/75 mb-4">
                We accept cash or UPI payments. Payment is made when the escort arrives at your location in OMR.
              </p>
            ...
            <div className="p-6 sm:p-8 bg-white/5 border border-white/10 rounded-xl">
              ...
              <p className="text-white/75 mb-4">
                For regular, housewife and college-girl profiles -no advance required. Payment when she arrives at your hotel or your place in OMR. Have payment ready-cash or UPI-to make the transaction smooth.
              </p>
            ...
            <div className="p-6 sm:p-8 bg-white/5 border border-white/10 rounded-xl">
              ...
              <p className="text-white/75">
                If you&apos;re at a hotel in OMR, we need proof you&apos;re staying there (room key photo or bill) and your room number. You give her name at reception when she arrives so she can come up. Payment is made when she arrives.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="mx-auto max-w-5xl">
          ...
          <div className="space-y-6">
            <div className="p-6 sm:p-8 bg-black/40 border border-white/10 rounded-xl">
              ...
              <p className="text-white/75">
                Message as early as you can. We usually reply within 1–2 hours; we&apos;ll tell you who&apos;s free and can reach you in OMR. Popular for IT professionals who decide last minute.
              </p>
            </div>
            <div className="p-6 sm:p-8 bg-black/40 border border-white/10 rounded-xl">
            ...
            <div className="p-6 sm:p-8 bg-black/40 border border-white/10 rounded-xl">
              ...
              <p className="text-white/75">
                Evenings and weekends can be busier in OMR. We&apos;ll still respond; advance notice helps secure your preferred time. IT professionals often book weekday evenings.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="relative py-10 sm:py-12 md:py-16 px-4 sm:px-6 lg:px-8 bg-white/[0.02]">
        <div className="mx-auto max-w-5xl">
          ...
          <div className="grid sm:grid-cols-2 gap-4 sm:gap-6">
            {[
              { title: "Complete Discretion", desc: "We don't share your number with escorts. Your booking stays between you and us. OMR is Chennai's IT corridor-we're used to discreet hotel and corporate outcall." },
              { title: "Verified Profiles", desc: "All escorts are verified before listing. Real photos, real people. No fake profiles or bait-and-switch in OMR bookings." },
              { title: "Outcall Only", desc: "She comes to you-your hotel or your place in OMR. You control the environment. No incall locations." },
          ...
          <div className="space-y-6">
            {[
              ...
              },
              {
                ...
                icon: "📊",
                content: "We monitor feedback and maintain quality standards. If an escort doesn't meet expectations, we address it immediately. Your feedback helps us maintain service quality in OMR.",
                items: null,
                note: null
              }
            ].map((item, idx) => (
      ...
      <section className="relative py-10 sm:py-12 md:py-16 px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-5xl">
          <div className="text-center mb-8 sm:mb-10">
            ...
            <p className="text-base sm:text-lg md:text-xl text-white/70 max-w-2xl mx-auto">
              Have these ready so your booking in OMR goes smoothly.
            </p>
          </div>

          <div className="space-y-4">
            {[
              { label: "Your Location", detail: "Exact location in OMR-hotel name and area, or residential area and address. If it's your place, any gate or lobby instructions." },
          ...
          <div className="space-y-5">
            {[
              ...
              },
              {
                ...
                icon: "🏨",
                desc: "If you're staying at a hotel in OMR, we need:",
                items: [
              ...
              },
              {
                ...
                icon: "🏠",
                desc: "For residential bookings in OMR, we need your area and address. Clear gate or lobby instructions help avoid delays.",
                items: null
              },
              {
                title: "Communication",
      ...
      <section className="relative py-10 sm:py-12 md:py-16 px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-5xl">
          <div className="text-center mb-8 sm:mb-10">
            ...
            <p className="text-base sm:text-lg md:text-xl text-white/70 max-w-2xl mx-auto">
              IT corridor location makes OMR easy to reach from anywhere in Chennai.
            </p>
          </div>

          <div className="p-6 sm:p-8 bg-black/40 border border-white/10 rounded-xl">
            <p className="text-white/80 leading-relaxed mb-4">
              <strong className="text-white">OMR</strong> is Chennai&apos;s premier IT corridor, making it easy for escorts to reach you from other parts of the city. Whether you&apos;re staying at a hotel near Sholinganallur, Perungudi, Navalur, Siruseri, or in a residential area, we factor in travel time when suggesting who can reach you.
            </p>
            <p className="text-white/80 leading-relaxed mb-4">
              The area is well-connected by road and has good access to major IT parks and tech companies. Tell us your location when you book-we don&apos;t need the exact address until we confirm, but clear gate or lobby instructions help avoid delays.
            </p>
            <p className="text-white/80 leading-relaxed">
              <strong className="text-white">Nearby areas:</strong> Sholinganallur, Perungudi, Navalur, Siruseri. Easy access makes OMR one of Chennai&apos;s most convenient areas for IT professionals and corporate outcall bookings.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="relative py-10 sm:py-12 md:py-16 px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-5xl">
          ...
          <div className="mt-10 p-8 bg-gradient-to-r from-[var(--accent-gold)]/10 via-[var(--accent-gold)]/5 to-[var(--accent-gold)]/10 border-l-4 border-[var(--accent-gold)] rounded-xl">
            <p className="text-white/90 text-center leading-relaxed">
              <strong className="text-white">You don&apos;t need to arrange transportation.</strong> We handle all coordination. The escort will come directly to your location in OMR.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="relative py-10 sm:py-12 md:py-16 px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-5xl">
          <div className="text-center mb-8 sm:mb-10">
            ...
            <p className="text-base sm:text-lg md:text-xl text-white/70 max-w-2xl mx-auto">
              Make your booking in OMR smooth and hassle-free.
            </p>
          </div>
      ...
      <section className="relative py-10 sm:py-12 md:py-16 px-4 sm:px-6 lg:px-8 overflow-hidden">
        ...
        <div className="mx-auto max-w-7xl relative z-10">
          <div className="text-center mb-10 sm:mb-12">
            ...
            <h2 className="text-4xl sm:text-5xl md:text-6xl font-black text-white mb-4 leading-tight">
              OMR vs<br />Other Areas
            </h2>
            <p className="text-base sm:text-lg text-white/60 max-w-xl mx-auto">
              What makes OMR unique.
            </p>
          </div>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5 sm:gap-6">
            {AREA_COMPARISON.map((item, idx) => (
              <div
                key={item.area}
                className={`relative group ${
                  item.area === "OMR" ? 'lg:col-span-3 sm:col-span-2' : ''
                }`}
              >
                {item.area === "OMR" && (
                ...
                <div className={`relative p-6 sm:p-8 bg-black/60 backdrop-blur-md border-2 ${
                  ...
                  <div className={`text-center ${item.area === "OMR" ? 'mt-4' : ''}`}>
          ...
          <div className="mt-10 p-8 bg-gradient-to-r from-black/80 via-[var(--accent-gold)]/10 to-black/80 border-2 border-[var(--accent-gold)]/30 rounded-2xl">
            <p className="text-white/90 text-center leading-relaxed text-base sm:text-lg">
              <strong className="text-white">OMR&apos;s IT corridor advantage</strong> makes it the most convenient area for IT professionals and corporate escort bookings in Chennai. Premier tech parks, easy access from all parts of the city, and we&apos;re experienced with this area.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="relative py-10 sm:py-12 md:py-16 px-4 sm:px-6 lg:px-8 bg-black" aria-labelledby="cta-heading" itemScope itemType="https://schema.org/ContactPage">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="text-lg sm:text-xl text-white/80 mb-8 sm:mb-10 max-w-2xl mx-auto" itemProp="description">
            Message us with your location in OMR, when you need someone, and what you have in mind.
          </p>
          <div className="flex flex-wrap justify-center gap-3 sm:gap-4" role="group" aria-label="Contact options">
            <a
              ...
              aria-label="Contact us on Telegram for OMR escort bookings"
            ...
            <Link
              ...
              rel="follow"
              aria-label="Contact page for OMR escort service"
            >
              Contact
            </Link>
          </div>
