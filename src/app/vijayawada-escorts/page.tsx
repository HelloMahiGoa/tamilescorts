...
const url = `${base}/vijayawada-escorts`;

const metaTitle = "Vijayawada Escorts | Premium Escorts in Vijayawada – Benz Circle, MG Road, Governorpet, Labbipet";
const metaDescription =
  "Vijayawada escorts and escort service in Vijayawada. Outcall to your hotel or place in Benz Circle, MG Road, Governorpet, Labbipet, Siddhartha Nagar. Discreet, verified. Tamil, Telugu companions. Pay when you meet.";

function buildVijayawadaJsonLd() {
  ...
  return [
    {
      ...
      itemListElement: [
        ...
        { "@type": "ListItem", position: 2, name: "Vijayawada Escorts", item: url },
      ],
    },
    {
      "@context": "https://schema.org",
    ...
    },
    {
      ...
      description: "Premium escort service in Vijayawada. Outcall to Benz Circle, MG Road, Governorpet, Labbipet, Siddhartha Nagar. Discreet, verified. Tamil, Telugu companions.",
      url,
      ...
      areaServed: { "@type": "City", name: "Vijayawada", containedInPlace: { "@type": "State", name: "Andhra Pradesh" } },
    },
    {
      "@context": "https://schema.org",
      "@type": "FAQPage",
...
export const metadata: Metadata = {
  ...
  keywords: [
    "Vijayawada escorts",
    "escorts in Vijayawada",
    "Vijayawada escort service",
    "Benz Circle escorts",
    "MG Road Vijayawada escorts",
    "Governorpet escorts",
    "Labbipet escorts",
    "Siddhartha Nagar escorts",
    "outcall Vijayawada",
    "Tamil escorts Vijayawada",
    "Telugu escorts Vijayawada",
    "housewife escorts Vijayawada",
    "model escorts Vijayawada",
    "escort service Benz Circle",
    "hotel escort Vijayawada",
  ],
  openGraph: {
    type: "website",
    locale: "en_IN",
    ...
    title: metaTitle,
    description: metaDescription,
    images: [{ url: `${base}/images/2.avif`, width: 1200, height: 630, alt: "Vijayawada escorts – premium outcall escort service" }],
  },
  twitter: {
...
const POPULAR_AREAS = [
  { name: "Benz Circle", slug: "benz-circle", desc: "Central & landmark" },
  { name: "MG Road", slug: "mg-road", desc: "Commercial hub" },
  { name: "Governorpet", slug: "governorpet", desc: "Central Vijayawada" },
  { name: "Labbipet", slug: "labbipet", desc: "Residential & hotels" },
  { name: "Siddhartha Nagar", slug: "siddhartha-nagar", desc: "Upscale area" },
  { name: "Kanuru", slug: "kanuru", desc: "Outskirts & stays" },
];

const MORE_AREAS = [
  { name: "Bhavanipuram", slug: "bhavanipuram" },
  { name: "One Town", slug: "one-town" },
  { name: "Gunadala", slug: "gunadala" },
  { name: "Moghalrajpuram", slug: "moghalrajpuram" },
  { name: "Patamata", slug: "patamata" },
  { name: "Vijayawada Railway Station area", slug: "vijayawada-railway-station" },
];
...
const WHY_CHOOSE = [
  ...
  { title: "Direct Contact", body: "No bots, no long forms. You talk to someone who handles Vijayawada bookings every day. Quick response." },
...
const SERVICE_TYPES = [
  ...
  { title: "Dinner or event", desc: "Plus-one for a client dinner in Benz Circle or Governorpet, or company for an evening out. We'll match someone who's presentable and easy to be around." },
  ...
  { title: "Travel companion", desc: "Outstation trips (Amaravati, Vizag) need advance booking. Not every girl does it; we'll check when you ask." },
];

const WHO_BOOKS = [
  { title: "Business travelers", body: "In town for a few days, staying at a hotel in Benz Circle or Labbipet. Don't want to eat alone or sit in a room. Need company that's discreet and hassle-free." },
  { title: "Locals", body: "Living in Vijayawada and want company for an evening—dinner, event, or just a few hours. Same process: you tell us area, when, and type; we fix someone who shows up." },
  { title: "Events & client dinners", body: "Need a plus-one for a corporate dinner or a client meet in Governorpet or MG Road. We send someone presentable who knows how to keep the evening smooth." },
];
...
const FAQ_ITEMS = [
  { q: "What areas in Vijayawada do you cover?", a: "We cover Benz Circle, MG Road, Governorpet, Labbipet, Siddhartha Nagar, Kanuru, Bhavanipuram, One Town, Gunadala, Moghalrajpuram, Patamata and the rest of the city. Tell us your location when you book and we'll fix someone who can reach you on time." },
  ...
  { q: "How do I book a Vijayawada escort?", a: "Message us on Telegram. Tell us your area, when you need someone, and what you're looking for (Tamil, Telugu, regular, model, etc.). We'll suggest who's free. Same-day and advance bookings both work." },
  ...
  { q: "Outcall or incall in Vijayawada?", a: "We do outcall only in Vijayawada—she comes to your hotel or your place. Have the address and any gate or lobby instructions ready so there's no back-and-forth." },
  { q: "Are Vijayawada escorts verified?", a: "Yes. We verify profiles before listing. You get real photos and real people. No fake profiles or bait-and-switch. If something isn't right on the day, you can tell us—we take feedback seriously." },
  { q: "What is the best area for hotel bookings in Vijayawada?", a: "Benz Circle and Governorpet get the most hotel bookings—central, easy for us to send someone. MG Road and Labbipet are popular with business travelers. Siddhartha Nagar and Kanuru work well too. Tell us your hotel area and we'll match someone who can reach you on time." },
  { q: "Can I book a Tamil or Telugu escort in Vijayawada?", a: "Yes. We have Tamil and Telugu escorts in Vijayawada. When you message, tell us your preference—language or type (regular, housewife, model, etc.)—and we'll suggest who's free and fits." },
];

const VIJAYAWADA_CATEGORIES: { slug: CategorySlug; label: string; line: string }[] = [
  { slug: "regular", label: "Regular Escorts", line: "Most popular in Vijayawada. No advance; hotel proof and room details for hotel bookings." },
...
export default function VijayawadaEscortsPage() {
  const jsonLd = buildVijayawadaJsonLd();
  return (
    <main id="main-content" className="min-h-screen bg-black">
      ...
      <header className="relative w-full min-h-[100vh] flex flex-col justify-end overflow-hidden">
        <div className="absolute inset-0 hidden md:block">
          <Image
            src="/images/2.avif"
            alt="Vijayawada escorts – premium outcall escort service in Benz Circle, Governorpet, Labbipet and across Vijayawada"
            fill
        ...
        <div className="absolute inset-0 md:hidden">
          <Image
            ...
            alt="Premium Vijayawada escorts – discreet outcall booking to your hotel or place"
            fill
            className="object-cover object-center"
            priority
            sizes="100vw"
          ...
          <div className="mx-auto w-full max-w-7xl">
            ...
            <div className="max-w-2xl md:max-w-xl lg:max-w-2xl">
              ...
              <p className="mt-6 text-lg sm:text-xl text-white/85 leading-relaxed max-w-xl">
                Premium escort service in Vijayawada. Outcall to your hotel or your place—Benz Circle, Governorpet, Labbipet, Siddhartha Nagar and across the city.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="border-b border-white/10 py-6 px-4 sm:px-6 lg:px-8" aria-label="About Vijayawada escorts">
        <div className="mx-auto max-w-4xl text-center">
          <p className="text-base sm:text-lg text-white/80 leading-relaxed">
            <strong className="text-white">Vijayawada escorts</strong> and escort service in{" "}
            <strong className="text-white">Benz Circle</strong>, <strong className="text-white">Governorpet</strong>,{" "}
            <strong className="text-white">Labbipet</strong>, Siddhartha Nagar, Kanuru and across Vijayawada. Tamil & Telugu companions. Outcall to your hotel or place. Discreet, verified, pay when you meet.
          </p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 min-h-0">
          <div className="relative aspect-[4/3] lg:aspect-auto lg:min-h-[480px] overflow-hidden bg-black">
            <Image
              ...
              alt="Premium Vijayawada escorts – Tamil and Telugu companions for outcall in Vijayawada"
              fill
              className="object-cover object-center"
          ...
          <div className="flex flex-col justify-center px-4 py-12 sm:px-8 lg:px-12 xl:px-16 lg:py-16">
            <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-white mb-6 leading-tight">
              Looking for premium Vijayawada escorts? You&apos;ve found the city&apos;s trusted escort service.
            </h2>
            <p className="text-base sm:text-lg leading-relaxed text-white/85 mb-4">
              Most of our bookings in <strong className="text-white">Vijayawada</strong> are from people in town for work—staying at a hotel in <strong className="text-white">Benz Circle</strong> or <strong className="text-white">Siddhartha Nagar</strong>—or locals who want company for a dinner or an event. We don&apos;t do the &quot;pay first and hope someone shows up&quot; thing. You tell us your area, what kind of evening you have in mind, and when. We suggest someone who can reach you without a fuss.
            </p>
            <p className="text-base sm:text-lg leading-relaxed text-white/85 mb-4">
            ...
            <p className="text-base sm:text-lg leading-relaxed text-white/85">
              A lot of our clients are here for a few days on work. They don't want to eat alone in a hotel or sit in a room by themselves. Some need a plus-one for a client dinner in Governorpet or Labbipet. Some just want company for an evening with no strings. Same drill for everyone: you book, we fix someone who shows up, you pay when she's there.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-4xl">
          <div className="relative rounded-2xl border border-[var(--accent-gold)]/25 bg-black/50 px-6 sm:px-10 py-10 sm:py-12 text-center overflow-hidden">
            ...
            <h2 className="text-2xl sm:text-3xl font-bold text-white mb-5">
              What If Booking Escorts in Vijayawada Just Worked?
            </h2>
            ...
            <p className="text-white/70 text-sm sm:text-base">
              This is Vijayawada&apos;s trusted escort service that turns a simple booking into a smooth evening.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-6xl">
          <div className="text-center mb-10">
            ...
            <p className="text-white/70 max-w-2xl mx-auto">
              We cover Labbipet, Benz Circle, Governorpet, and the suburbs. Tell us your location when you book and we&apos;ll fix someone who can reach you on time.
            </p>
          </div>
          ...
          <div className="rounded-xl border border-white/10 bg-black/30 px-6 py-5 text-center">
            ...
            <p className="text-white/60 text-sm text-center mt-4 max-w-xl mx-auto">
              Benz Circle and Governorpet get the most hotel bookings. Siddhartha Nagar and Labbipet are big for IT and corporate. Kanuru, Bhavanipuram and One Town are a mix of hotels and residential. Wherever you are, give us the area and we&apos;ll sort it.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-5xl">
          <div className="text-center mb-10">
            ...
            <p className="text-white/70">
              Book your escort in Vijayawada in three simple steps.
            </p>
          </div>
        ...
        <div className="mx-auto max-w-6xl">
          <div className="text-center mb-10">
            ...
            <p className="text-white/70 max-w-xl mx-auto">
              Trusted Vijayawada escort service. No advance for regular profiles. Discreet and direct.
            </p>
          </div>
        ...
        <div className="mx-auto max-w-4xl">
          <div className="text-center mb-8">
            ...
            <p className="text-white/70 max-w-xl mx-auto mb-8">
              100% verified profiles. Tamil and Telugu escorts in Vijayawada. Choose a type to browse by category (regular, housewife, college girls, models, artists, celebrity, actress).
            </p>
      ...
      {/* Tamil & Telugu Escorts in Vijayawada – label + cards */}
      <section className="border-y border-white/10 py-14 px-4 sm:px-6 lg:px-8 bg-white/[0.02]" aria-label="Tamil Telugu escorts Vijayawada">
        <div className="mx-auto max-w-6xl">
          <div className="text-center mb-10">
            <span className="inline-block text-xs font-semibold tracking-[0.2em] text-[var(--accent-gold)] uppercase mb-2">
              By language
            ...
            <h2 className="text-2xl sm:text-3xl font-bold text-white mb-3">
              Tamil & Telugu Escorts in Vijayawada
            </h2>
            <p className="text-white/70 max-w-2xl mx-auto">
              We have companions who speak Tamil and Telugu. Many clients in Vijayawada want someone who gets the culture and can hold a conversation in their language—for a dinner, an event, or a relaxed evening at your hotel or place.
            </p>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            {[
              { href: "/tamil-escorts", label: "Tamil Escorts", desc: "Tamil companions in Vijayawada. Benz Circle, Governorpet, Labbipet—outcall to your hotel or place. Same discretion and pay-when-you-meet policy." },
              { href: "/telugu-escorts", label: "Telugu Escorts", desc: "Telugu companions in Vijayawada for dinner, events or travel. Most requested in Andhra. Presentable, easy to talk to. Outcall; pay when she arrives." },
            ].map((item) => (
      ...
      {/* Languages in Vijayawada – card with pills */}
      <section className="py-14 px-4 sm:px-6 lg:px-8 border-t border-white/10">
        <div className="mx-auto max-w-4xl">
          <div className="relative rounded-2xl border border-white/10 bg-gradient-to-br from-white/[0.04] to-transparent overflow-hidden">
            ...
            <div className="pl-8 pr-6 sm:pr-8 py-8 sm:py-10">
              ...
              <p className="text-white/85 leading-relaxed">
                Our companions in Vijayawada speak Tamil and Telugu, plus English. Many are multilingual. If you want someone who can hold a conversation in a specific language—for a family function, a dinner where everyone&apos;s speaking Telugu or Tamil, or just because you&apos;re more comfortable—tell us when you book. We&apos;ll suggest who fits. It&apos;s one of the things we get asked most in Vijayawada.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-14 px-4 sm:px-6 lg:px-8 border-t border-white/10" aria-label="Escort categories Vijayawada">
        <div className="mx-auto max-w-6xl">
          <div className="text-center mb-10">
            <span className="inline-block text-xs font-semibold tracking-[0.2em] text-[var(--accent-gold)] uppercase mb-2">
              Categories
            ...
            <p className="text-white/70 max-w-xl mx-auto">
              Regular, housewife, college girls, models and more. All available in Vijayawada with outcall to your location.
            </p>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {VIJAYAWADA_CATEGORIES.map((cat) => (
              <Link
                key={cat.slug}
      ...
      <section className="border-y border-white/10 py-14 px-4 sm:px-6 lg:px-8 bg-white/[0.02]">
        <div className="mx-auto max-w-6xl">
          <div className="text-center mb-10">
            ...
            <h2 className="text-2xl sm:text-3xl font-bold text-white mb-3">
              What We Offer in Vijayawada
            </h2>
            <p className="text-white/70 max-w-2xl mx-auto">
              From a few hours to a full night, dinner dates to travel. Outcall to your hotel or your place in Vijayawada. Tell us what you need and we&apos;ll match you.
            </p>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
      ...
      <section className="py-14 px-4 sm:px-6 lg:px-8 border-t border-white/10 bg-white/[0.02]">
        <div className="mx-auto max-w-6xl">
          <div className="text-center mb-10">
            ...
            <p className="text-white/70 max-w-xl mx-auto">
              We offer flexible durations. All outcall to your hotel or your place in Vijayawada.
            </p>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            {[
              ...
              { title: "Outstation (travel)", desc: "Trips to Amaravati, Vizag or elsewhere. We need a few days' notice. Not every companion does outstation. Same discretion and payment when she's with you.", num: "4" },
            ].map((item) => (
      ...
      {/* Outstation from Vijayawada – card */}
          ...
          <div className="relative rounded-2xl border border-white/10 bg-white/[0.03] overflow-hidden">
            ...
            <div className="pl-8 pr-6 sm:pr-8 py-6 sm:py-8">
              ...
              <h2 className="text-xl sm:text-2xl font-bold text-white mb-3">
                Outstation from Vijayawada
              </h2>
              <p className="text-white/85 leading-relaxed">
                We get requests for trips to Amaravati, Vizag, and elsewhere. Not every companion does outstation, and we need advance notice—often a few days—to check who&apos;s free and willing to travel. Same rules: discretion, pay when she&apos;s with you (cash or UPI), and for regular and housewife profiles no advance. Tell us where you&apos;re going, how many nights, and when; we&apos;ll see what we can arrange.
              </p>
            </div>
          </div>
        </div>
      ...
      {/* Who Books Vijayawada Escorts – label + cards */}
      <section className="py-14 px-4 sm:px-6 lg:px-8 border-t border-white/10 bg-white/[0.02]">
        <div className="mx-auto max-w-5xl">
          <div className="text-center mb-10">
            <span className="inline-block text-xs font-semibold tracking-[0.2em] text-[var(--accent-gold)] uppercase mb-2">
      ...
      {/* First time booking in Vijayawada – card */}
      <section className="py-14 px-4 sm:px-6 lg:px-8 border-t border-white/10" aria-label="First time booking Vijayawada">
        <div className="mx-auto max-w-4xl">
          <div className="relative rounded-2xl border border-white/10 bg-gradient-to-br from-white/[0.04] to-transparent overflow-hidden">
            <div className="absolute left-0 top-0 bottom-0 w-1.5 bg-[var(--accent-gold)]/60" aria-hidden />
            <div className="pl-8 pr-6 sm:pr-8 py-8 sm:py-10">
              ...
              <h2 className="text-2xl sm:text-3xl font-bold text-white mb-5">
                First Time Booking in Vijayawada?
              </h2>
        ...
        <div className="mx-auto max-w-4xl">
          <div className="relative rounded-2xl border border-white/10 overflow-hidden">
            ...
            <div className="p-6 sm:p-8">
              ...
              <p className="text-white/85 leading-relaxed mb-4">
                Same-day bookings work—we often confirm within a few hours. For peak times (weekends, evenings in Benz Circle or Governorpet) a few hours&apos; notice helps. For full-night or outstation (Amaravati, Vizag) we need advance notice; not every girl does it, and we need to line it up.
              </p>
              <p className="text-white/85 leading-relaxed">
      ...
      {/* Why outcall only in Vijayawada – card */}
      <section className="py-14 px-4 sm:px-6 lg:px-8 border-t border-white/10 bg-white/[0.02]">
        <div className="mx-auto max-w-4xl">
          <div className="rounded-2xl border border-white/10 overflow-hidden">
            <div className="bg-black/50 px-6 sm:px-8 py-6 border-b border-white/10">
              ...
              <h2 className="text-2xl sm:text-3xl font-bold text-white">
                Why Outcall Only in Vijayawada for Celebrity, Models, Artists and Actress?
              </h2>
            </div>
            <div className="p-6 sm:p-8 space-y-6">
              <div className="rounded-xl bg-white/[0.03] border border-white/5 p-5 sm:p-6">
                ...
                <p className="text-white/85 leading-relaxed text-sm sm:text-base">
                  In Vijayawada we offer <strong className="text-white">outcall only</strong>—she comes to your hotel or your place. We don&apos;t arrange incall. That applies to all profiles: regular, housewife, college girls, and also celebrity, models, artists and actress. You stay in a space you control; she travels to you.
                </p>
              </div>
              <div className="rounded-xl bg-white/[0.03] border border-white/5 p-5 sm:p-6">
      ...
      {/* Area keyword blocks – Benz Circle/Governorpet & Siddhartha Nagar/Labbipet */}
      <section className="py-14 px-4 sm:px-6 lg:px-8 border-t border-white/10" aria-label="Escort service by area Vijayawada">
        <div className="mx-auto max-w-5xl">
          <div className="text-center mb-10">
            <span className="inline-block text-xs font-semibold tracking-[0.2em] text-[var(--accent-gold)] uppercase mb-2">
              By area
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="group rounded-2xl border border-white/10 bg-white/[0.03] p-6 sm:p-8 hover:border-[var(--accent-gold)]/40 transition-colors">
              <div className="flex flex-wrap gap-2 mb-4">
                <Link href="/benz-circle-escorts" className="inline-flex items-center px-3 py-1.5 rounded-full text-xs font-semibold bg-[var(--accent-gold)]/15 text-[var(--accent-gold)] border border-[var(--accent-gold)]/30 hover:bg-[var(--accent-gold)]/25 transition-colors">
                  Benz Circle
                </Link>
                <Link href="/governorpet-escorts" className="inline-flex items-center px-3 py-1.5 rounded-full text-xs font-semibold bg-[var(--accent-gold)]/15 text-[var(--accent-gold)] border border-[var(--accent-gold)]/30 hover:bg-[var(--accent-gold)]/25 transition-colors">
                  Governorpet
                </Link>
              </div>
              <h3 className="text-lg sm:text-xl font-bold text-white mb-3">
                Escort Service in Benz Circle and Governorpet
              </h3>
              <p className="text-white/80 text-sm sm:text-base leading-relaxed">
                Most of our Vijayawada hotel bookings are in Benz Circle and Governorpet—central, plenty of hotels, easy for us to send someone. Outcall to your room; we need proof and room details, and you give her name at reception. Pay when she arrives.
              </p>
            </div>
            <div className="group rounded-2xl border border-white/10 bg-white/[0.03] p-6 sm:p-8 hover:border-[var(--accent-gold)]/40 transition-colors">
              <div className="flex flex-wrap gap-2 mb-4">
                <Link href="/siddhartha-nagar-escorts" className="inline-flex items-center px-3 py-1.5 rounded-full text-xs font-semibold bg-[var(--accent-gold)]/15 text-[var(--accent-gold)] border border-[var(--accent-gold)]/30 hover:bg-[var(--accent-gold)]/25 transition-colors">
                  Siddhartha Nagar
                </Link>
                <Link href="/labbipet-escorts" className="inline-flex items-center px-3 py-1.5 rounded-full text-xs font-semibold bg-[var(--accent-gold)]/15 text-[var(--accent-gold)] border border-[var(--accent-gold)]/30 hover:bg-[var(--accent-gold)]/25 transition-colors">
                  Labbipet
                </Link>
              </div>
              <h3 className="text-lg sm:text-xl font-bold text-white mb-3">
                Outcall Escorts in Siddhartha Nagar and Labbipet
              </h3>
              <p className="text-white/80 text-sm sm:text-base leading-relaxed">
                Siddhartha Nagar and Labbipet are popular with business travelers and locals. We get a lot of bookings from business travelers staying there. Outcall only—she comes to your hotel or your place. Tell us your area and when you need someone; we&apos;ll suggest who&apos;s free and can reach you on time.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="relative rounded-2xl border border-white/10 bg-gradient-to-br from-white/[0.04] to-transparent overflow-hidden">
            ...
            <div className="p-6 sm:p-8">
              ...
              <p className="text-white/85 leading-relaxed mb-6">
                We cover all of Vijayawada. When you book we factor in where you are and where she&apos;s coming from so we suggest someone who can reach you on time. Tell us your area (or hotel name and area) when you message; we don&apos;t need the exact address until we confirm. Clear gate or lobby instructions help so there&apos;s no back-and-forth on the day.
              </p>
              <div className="flex flex-wrap gap-2">
                {[
                  { name: "Benz Circle", slug: "benz-circle-escorts" },
                  { name: "Governorpet", slug: "governorpet-escorts" },
                  { name: "MG Road", slug: "mg-road-escorts" },
                  { name: "Kanuru", slug: "kanuru-escorts" },
                  { name: "Siddhartha Nagar", slug: "siddhartha-nagar-escorts" },
                  { name: "Labbipet", slug: "labbipet-escorts" },
                  { name: "Bhavanipuram", slug: "bhavanipuram-escorts" },
                  { name: "One Town", slug: "one-town-escorts" },
                  { name: "Gunadala", slug: "gunadala-escorts" },
                  { name: "Moghalrajpuram", slug: "moghalrajpuram-escorts" },
                  { name: "Patamata", slug: "patamata-escorts" },
                ].map((area) => (
                  <Link
                    key={area.slug}
                    href={`/${area.slug}`}
      ...
      <section className="py-14 px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-6xl grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-14 items-center">
          ...
          <div className="relative aspect-[4/3] lg:aspect-[3/4] rounded-xl overflow-hidden bg-white/5 shrink-0">
            <Image
              src="/images/3.avif"
              alt="Trusted Vijayawada escort service – discreet outcall to your hotel or place"
              fill
              className="object-cover object-center"
              sizes="(max-width: 1023px) 100vw, 50vw"
            />
        ...
        <div className="mx-auto max-w-4xl">
          <div className="rounded-2xl border border-white/10 bg-black/20 px-6 sm:px-10 py-10 text-center">
            ...
            <p className="text-white/70 mb-8 max-w-2xl mx-auto">
              Vijayawada is a major hub; we also arrange outcall in Chennai, Bangalore, Hyderabad, Kochi, Coimbatore, Madurai, Trivandrum and more. Ask when you message—availability depends on who&apos;s free and where. Same rules: discretion, pay when you meet, no advance for regular and housewife profiles.
            </p>
      ...
      <section className="border-y border-white/10 py-14 px-4 sm:px-6 lg:px-8 bg-white/[0.02]" aria-label="Blog and guides">
        <div className="mx-auto max-w-4xl">
          <div className="text-center mb-8">
            ...
            <p className="text-white/70 max-w-xl mx-auto">
              Straightforward guides on booking, discretion, and what to expect in Vijayawada and South India.
            </p>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            <Link
      ...
      {/* FAQ – label + cards */}
      <section className="border-y border-white/10 py-14 px-4 sm:px-6 lg:px-8 bg-white/[0.02]" aria-label="Frequently asked questions about Vijayawada escorts">
        <div className="mx-auto max-w-3xl">
          <div className="text-center mb-10">
            <span className="inline-block text-xs font-semibold tracking-[0.2em] text-[var(--accent-gold)] uppercase mb-2">
              FAQ
            ...
            <h2 className="text-2xl sm:text-3xl font-bold text-white mb-3">
              Top Questions about Escorts in Vijayawada
            </h2>
        ...
        <div className="mx-auto max-w-2xl">
          <div className="rounded-2xl border border-[var(--accent-gold)]/30 bg-black/50 px-6 sm:px-10 py-10 sm:py-12 text-center">
            ...
            <h2 className="text-2xl font-bold text-white mb-4">
              Ready to Book a Vijayawada Escort?
            </h2>
            <p className="text-white/70 mb-6">
              Message us with your area, when you need someone, and what you have in mind. We&apos;re on Telegram. No bots—you&apos;ll talk to someone who handles Vijayawada bookings every day. Questions about areas, payment, or what to expect? Ask when you message.
            </p>
            <div className="flex flex-wrap justify-center gap-4">
              <a
                ...
                title="Contact Vijayawada escorts on Telegram"
              ...
              <Link
                href="/contact"
                title="Contact us to book Vijayawada escorts"
