...
const url = `${base}/adyar-escorts`;

const metaTitle = "Adyar Escorts | Chennai Escorts in Adyar – Outcall to Hotels & Your Place";
const metaDescription =
  "Adyar escorts and escort service in Chennai. Outcall to your hotel or place in Adyar. Discreet, verified. Tamil, Mallu, Telugu & Kannada. Pay when you meet. No advance for regular & housewife.";
...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "hotel escort Adyar",
    "Tamil escorts Adyar",
    "escort service Chennai Adyar",
    "Adyar River escorts",
    "Besant Nagar escorts",
    "residential escorts Adyar",
    "Adyar hotel escorts",
    "discreet escorts Adyar",
    "verified escorts Adyar",
    "Mallu escorts Adyar",
    "Telugu escorts Adyar",
    "Kannada escorts Adyar",
    "housewife escorts Adyar",
    "college girls escorts Adyar",
    "model escorts Adyar",
    "regular escorts Adyar",
    "escort booking Adyar",
    "escort service Adyar Chennai",
    "outcall escort service Adyar",
    "24/7 escorts Adyar",
    "same day escorts Adyar",
    "business traveler escorts Adyar",
    "corporate escort Adyar",
    "dinner escort Adyar",
    "event escort Adyar",
  ],
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Adyar escorts – premium outcall escort service in Chennai",
        type: "image/avif",
      },
    ],
  },
  ...
  other: {
    "geo.region": "IN-TN",
    "geo.placename": "Adyar, Chennai",
    "geo.position": "13.0000;80.2600",
    "ICBM": "13.0000, 80.2600",
  },
};
...
const OTHER_AREAS = [
  ...
  { name: "Nungambakkam", slug: "nungambakkam-escorts", desc: "Central & hotels" },
  { name: "Velachery", slug: "velachery-escorts", desc: "South Chennai" },
  { name: "Egmore", slug: "egmore-escorts", desc: "Central" },
];

const HOW_IT_WORKS = [
  { step: 1, title: "Contact Us", body: "Message with your location in Adyar (hotel or area), when you need someone, and what you have in mind. We'll ask the basics-hotel proof if you're at a hotel, type (regular, housewife, model, etc.)." },
  { step: 2, title: "We Suggest Who's Free", body: "We'll tell you who can reach you on time in Adyar. If you're at a hotel we need proof and room details; you give her name at reception when she arrives." },
  { step: 3, title: "She Comes to You", body: "Outcall only. She'll come to your hotel or your place in Adyar. Payment when she's there -cash or UPI. No advance for regular, housewife and college-girl profiles." },
];
...
const WHY_CHOOSE = [
  ...
  { title: "Complete Discretion", body: "We don't share your number. Your booking stays between you and us. Adyar's residential nature means we're experts at discreet residential and upscale hotel outcall." },
  { title: "Residential & Upscale", body: "Adyar is Chennai's premier residential area with upscale hotels. We specialize in discreet residential and upscale hotel bookings. Privacy and discretion guaranteed." },
...
const LANGUAGES = [
  { name: "Tamil", desc: "Most bookings in Adyar are Tamil. Perfect for locals and Tamil-speaking clients." },
  { name: "Malayalam", desc: "Mallu escorts available in Adyar. Great for Kerala clients and Malayalam speakers." },
  { name: "Telugu", desc: "Telugu-speaking companions in Adyar. Popular for residential clients and upscale hotel guests from Andhra/Telangana." },
  { name: "Kannada", desc: "Kannada escorts in Adyar. Same booking process and discretion." },
];

const POPULAR_HOTELS = [
  { name: "Leela Palace", area: "Adyar", note: "Luxury hotel, upscale outcall" },
  { name: "Taj Connemara", area: "Adyar", note: "Premium hotel, discreet service" },
  { name: "ITC Grand Chola", area: "Guindy Road", note: "Luxury hotel, near Adyar" },
  { name: "Residential Areas", area: "Adyar", note: "Upscale residential bookings" },
  { name: "Besant Nagar", area: "Adyar", note: "Residential area, quiet location" },
  { name: "Adyar River Area", area: "Adyar", note: "Residential & upscale properties" },
];

const DURATION_OPTIONS = [
  { title: "Short Time (2-3 hours)", desc: "Most popular in Adyar. Perfect for residential clients and upscale hotel guests. She comes to you for a few hours-dinner, conversation, or relaxed evening. Pay when she arrives; no advance for regular and housewife profiles.", popular: true },
  { title: "Dinner or Evening", desc: "Fixed slot for a dinner, event, or party in Adyar. Tell us the start time and when it ends. Same payment rules. We match someone who fits the occasion.", popular: false },
  { title: "Full Night", desc: "Dinner plus the night-typically 8–10 hours. Advance notice helps so we can confirm who's free in Adyar. Payment when she's there; for models and above we take a small advance.", popular: false },
  { title: "Outstation Travel", desc: "Trips from Adyar to Pondicherry, Mahabalipuram, or elsewhere. We need a few days' notice. Not every companion does outstation. Same discretion and payment.", popular: false },
];

const WHO_BOOKS_ADYAR = [
  { title: "Residential Clients", body: "Living in Adyar's upscale residential areas and want discreet company for an evening-dinner, event, or relaxed time at home. We understand residential bookings and maintain complete discretion." },
  { title: "Upscale Hotel Guests", body: "Staying at luxury hotels in Adyar for work or leisure. Need presentable company for dinners, events, or evenings. We're experienced with upscale hotel bookings and discretion." },
  { title: "Corporate & Events", body: "Need a plus-one for a client dinner or corporate event in Adyar. We send someone presentable who knows how to keep the evening smooth. Popular for business gatherings and upscale occasions." },
];

const TIPS_FOR_EXPERIENCE = [
  { tip: "Be Clear About Location", detail: "Tell us your exact location in Adyar-hotel name and area, or your residential area. Clear gate or lobby instructions help avoid delays." },
...
const SERVICES_OCCASIONS = [
  { title: "Dinner Dates", desc: "Company for dinner at restaurants in Adyar. Presentable, conversation-ready. Perfect for business dinners or casual evenings.", popular: true },
  ...
  { title: "Parties & Social Events", desc: "Companion for parties, celebrations, or social gatherings in Adyar. Fun, engaging, fits the occasion.", popular: false },
  { title: "Travel Companion", desc: "Company for outstation trips from Adyar-Pondicherry, Mahabalipuram, or elsewhere. Advance notice required.", popular: false },
...
const WHY_ADYAR = [
  { title: "Residential & Upscale", desc: "Adyar is Chennai's premier residential area with upscale hotels and quiet neighborhoods. Perfect for clients who value discretion and privacy. We're experienced with residential bookings." },
  { title: "Upscale Hotels", desc: "Home to luxury hotels like Leela Palace and upscale residential properties. We understand the needs of upscale clients and maintain complete discretion for both hotel and residential bookings." },
  { title: "Quiet & Discreet", desc: "Adyar offers a quieter, more private environment compared to busier commercial areas. Ideal for clients who prefer discreet bookings without the hustle of central Chennai." },
  { title: "Residential Focus", desc: "Many of our clients in Adyar are residents or long-term visitors. We're used to residential outcall, understand gate security, and coordinate discreetly for home bookings." },
];

const TRANSPORTATION_INFO = [
  { title: "Travel Time", desc: "Escorts typically reach Adyar within 30-60 minutes from other parts of Chennai. We factor in travel time when suggesting who can reach you on time." },
...
const AREA_HIGHLIGHTS = [
  { name: "Adyar River", type: "Landmark", note: "Scenic river area with upscale residential properties" },
  { name: "Besant Nagar", type: "Residential area", note: "Quiet, upscale neighborhood popular for residential bookings" },
  { name: "Leela Palace", type: "Luxury hotel", note: "Premium hotel in Adyar, popular for upscale bookings" },
  { name: "Adyar Bridge", type: "Landmark", note: "Key location reference point in Adyar" },
  { name: "Residential Areas", type: "Residential", note: "Upscale residential neighborhoods throughout Adyar" },
  { name: "Elliot's Beach", type: "Landmark", note: "Nearby beach area, popular destination" },
];

const AREA_COMPARISON = [
  { area: "Adyar", advantage: "Residential & upscale", note: "Premier residential area with luxury hotels, quiet and discreet" },
  { area: "Nungambakkam", advantage: "Central location", note: "Most central with highest hotel density, but busier than Adyar" },
  { area: "T Nagar", advantage: "Shopping district", note: "Popular for hotel bookings, but less residential than Adyar" },
  { area: "OMR", advantage: "IT corridor", note: "Good for IT professionals, but further from city center" },
  { area: "Guindy", advantage: "Business district", note: "Corporate hub, but less residential than Adyar" },
  { area: "Velachery", advantage: "South Chennai hub", note: "Growing area with good connectivity, but further from central Chennai" },
  { area: "Egmore", advantage: "Transport hub", note: "Near railway station, convenient but less upscale than Adyar" },
];
...
const GROUP_BOOKING_INFO = [
  { title: "Multiple Escorts", desc: "Need multiple escorts for a corporate event, party, or group gathering in Adyar? We can arrange 2-4 escorts depending on availability. Advance notice required-at least 2-3 days." },
...
const FAQ_ITEMS = [
  { q: "Do you cover Adyar?", a: "Yes. Adyar is one of our main areas in Chennai. We do outcall to hotels and residences in Adyar. Tell us your location (hotel name or area) and when you need someone; we'll suggest who can reach you on time." },
  { q: "Do I need to pay advance in Adyar?", a: "For regular, housewife and college-girl profiles -no advance. We need hotel proof and room details if you're at a hotel, and you give her name at reception. For models, artists, celebrity and actress we take a small advance; the rest when she arrives." },
  { q: "What's the best way to book an escort in Adyar?", a: "Message us on Telegram. Tell us you're in Adyar, when you need someone, and what you're looking for (regular, housewife, model, Tamil, Mallu, etc.). We'll suggest who's free. Same-day and advance bookings both work." },
  { q: "Outcall or incall in Adyar?", a: "We do outcall only -she comes to your hotel or your place in Adyar. Have the address and any gate or lobby instructions ready." },
  { q: "Why is Adyar popular for escort bookings?", a: "Adyar is Chennai's premier residential area with upscale hotels and quiet neighborhoods. Perfect for clients who value discretion and privacy. Many residents and upscale hotel guests prefer Adyar for its residential nature and upscale environment. Same process: discreet, pay when you meet." },
];

// Build JSON-LD after all constants are defined
function buildAdyarJsonLd() {
  ...
  return [
    {
      ...
      itemListElement: [
        ...
        { "@type": "ListItem", position: 3, name: "Adyar Escorts", item: url },
      ],
    },
    {
      "@context": "https://schema.org",
    ...
    },
    {
      ...
      "@id": localBusinessId,
      name: "Adyar Escorts",
      description: "Premium escort service in Adyar, Chennai. Specializing in residential and upscale hotel bookings. Discreet, verified companions. Tamil, Mallu, Telugu & Kannada escorts available.",
      url,
      image: [
        `${base}/images/2.avif`,
      ],
            ...
            itemListElement: [
              {
                ...
                itemOffered: {
                  ...
                  description: "Regular escort service in Adyar. No advance required.",
                },
              },
            ],
          },
            ...
            itemListElement: [
              {
                ...
                itemOffered: {
                  ...
                  description: "Housewife escort service in Adyar. Mature, discreet companions.",
                },
              },
            ],
          },
    ...
    },
    {
      ...
      "@type": "Service",
      "@id": serviceId,
      name: "Escort Service in Adyar",
      description: "Premium outcall escort service in Adyar, Chennai. Specializing in residential and upscale hotel bookings. Available 24/7. Discreet, verified companions.",
      provider: {
        "@id": organizationId,
      },
      areaServed: {
    ...
    },
    {
      "@context": "https://schema.org",
      "@type": "ItemList",
      name: "Popular Hotels in Adyar",
      description: "Popular hotels and locations where we provide escort services in Adyar",
    ...
    },
    {
      "@context": "https://schema.org",
      "@type": "ItemList",
      name: "Languages Available in Adyar",
      description: "Languages spoken by escorts available in Adyar",
    ...
    <main id="main-content" className="min-h-screen bg-black" itemScope itemType="https://schema.org/WebPage" lang="en-IN">
      ...
      <header className="relative w-full min-h-screen flex flex-col justify-end overflow-hidden" role="banner" itemScope itemType="https://schema.org/WPHeader">
        ...
        <div className="absolute inset-0" aria-hidden="true">
          <Image
            src="/images/2.avif"
            alt="Adyar escorts – premium outcall escort service in Chennai. Discreet, verified companions available for upscale hotel and residential bookings in Adyar."
            fill
          ...
          <div className="mx-auto max-w-7xl">
            ...
            <nav className="mb-6 sm:mb-8" aria-label="Breadcrumb" itemScope itemType="https://schema.org/BreadcrumbList">
              <ol className="flex flex-wrap items-center gap-2 text-xs sm:text-sm text-white/50" role="list">
                ...
                <li aria-hidden="true" className="text-white/30">/</li>
                <li itemProp="itemListElement" itemScope itemType="https://schema.org/ListItem">
                  <span className="text-white/70" itemProp="name">Adyar</span>
            ...
            <div>
              ...
              <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl 2xl:text-9xl font-black text-white leading-[0.9] mb-4 sm:mb-6 md:mb-8 tracking-tight">
                <span className="block">Adyar</span>
              ...
              <p className="text-base sm:text-lg md:text-xl lg:text-2xl text-white/95 leading-relaxed mb-6 sm:mb-8 md:mb-10 max-w-2xl lg:max-w-3xl font-light" itemProp="description">
                Premium escort service in Adyar. Outcall to your hotel or residence-discreet, verified, pay when you meet. Specializing in residential and upscale bookings.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="grid lg:grid-cols-12 gap-8 sm:gap-10 lg:gap-12 items-start">
            ...
            <div className="lg:col-span-9">
              <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-white mb-6 sm:mb-8 leading-tight" itemProp="name">
                Adyar&apos;s Premier Residential & Upscale Escort Service
              </h2>
              <div className="prose prose-invert max-w-none space-y-4 sm:space-y-6 text-base sm:text-lg text-white/80 leading-relaxed" itemProp="description">
                <p>
                  <strong className="text-white">Adyar</strong> is Chennai&apos;s premier residential area with upscale hotels and quiet neighborhoods. If you&apos;re staying at a luxury hotel here or you live in the area and want discreet company for a dinner or an evening, we&apos;ve got you.
                </p>
                <p>
                ...
                <p>
                  Outcall only -she comes to you. We don&apos;t share your number; discretion is default. Tell us your location in Adyar, when you need someone, and what type you want (Tamil, Mallu, regular, model, etc.). We&apos;ll suggest who&apos;s free and can reach you on time.
                </p>
              </div>
            </div>
          </div>
      ...
      {/* Why Adyar Specifically - Diagonal Split Design */}
      <section className="relative py-10 sm:py-12 md:py-16 px-4 sm:px-6 lg:px-8" aria-labelledby="why-Adyar-heading" itemScope itemType="https://schema.org/ItemList">
        <div className="mx-auto max-w-7xl">
          <div className="mb-10 sm:mb-12">
            <div className="flex items-center gap-4 mb-4" aria-hidden="true">
              <div className="h-1 w-16 bg-[var(--accent-gold)]" />
              <span className="text-xs font-mono tracking-widest text-[var(--accent-gold)] uppercase">Why Adyar</span>
            </div>
            <h2 id="why-Adyar-heading" className="text-4xl sm:text-5xl md:text-6xl font-black text-white mb-4 leading-tight" itemProp="name">
              Why Choose<br />Adyar?
            </h2>
          </div>

          <div className="grid lg:grid-cols-2 gap-6 sm:gap-8" itemProp="itemListElement" role="list">
            {WHY_ADYAR.map((item, idx) => (
              <article
                key={item.title}
          ...
          <div className="grid lg:grid-cols-12 gap-6 sm:gap-8 mb-6 sm:mb-8">
            <div className="lg:col-span-4">
              ...
              <p className="text-base sm:text-lg text-white/70" itemProp="description">
                Regular, housewife, college girls, models and more. All available for outcall in Adyar.
              </p>
            </div>
                ...
                {CATEGORIES.map((cat, idx) => (
                  ...
                  >
                    <Link
                      ...
                      rel="follow"
                      aria-label={`Browse ${cat.label} in Adyar`}
                      itemProp="item"
                    >
        ...
        <div className="mx-auto max-w-7xl">
          <div className="text-center mb-8 sm:mb-10">
            ...
            <h2 id="languages-heading" className="text-3xl sm:text-4xl md:text-5xl font-bold text-white mb-3 sm:mb-4" itemProp="name">
              Languages Available in Adyar
            </h2>
            <p className="text-base sm:text-lg md:text-xl text-white/70 max-w-2xl mx-auto" itemProp="description">
              Tamil, Mallu, Telugu, and Kannada escorts available for outcall in Adyar.
            </p>
          </div>
        ...
        <div className="mx-auto max-w-7xl">
          <div className="text-center mb-8 sm:mb-10">
            ...
            <h2 id="hotels-heading" className="text-3xl sm:text-4xl md:text-5xl font-bold text-white mb-3 sm:mb-4" itemProp="name">
              Popular Hotels & Locations in Adyar
            </h2>
            <p className="text-base sm:text-lg md:text-xl text-white/70 max-w-2xl mx-auto" itemProp="description">
              We cover luxury hotels and upscale residential areas in Adyar. Residential and upscale focus ensures discreet outcall.
            </p>
          </div>
          ...
          <div className="mt-8 p-6 bg-black/40 border border-white/10 rounded-xl">
            <p className="text-white/80 text-center">
              <strong className="text-white">Adyar River area</strong>, <strong className="text-white">Besant Nagar</strong>, and surrounding residential areas are all covered. Tell us your hotel name or residential area when you book.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="relative py-10 sm:py-12 md:py-16 px-4 sm:px-6 lg:px-8 bg-white/[0.02] overflow-hidden" aria-labelledby="highlights-heading" itemScope itemType="https://schema.org/ItemList">
        ...
        <div className="mx-auto max-w-7xl relative z-10">
          <div className="text-center mb-10 sm:mb-12">
            ...
            <p className="text-base sm:text-lg text-white/60 max-w-xl mx-auto" itemProp="description">
              Key locations and landmarks in and around Adyar.
            </p>
          </div>
        ...
        <div className="mx-auto max-w-7xl">
          <div className="text-center mb-8 sm:mb-10">
            ...
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-white mb-3 sm:mb-4">
              Duration Options in Adyar
            </h2>
            <p className="text-base sm:text-lg md:text-xl text-white/70 max-w-2xl mx-auto">
              Flexible durations. All outcall to your hotel or your place in Adyar.
            </p>
          </div>
          ...
          <div className="space-y-6">
            <div className="p-6 sm:p-8 bg-white/5 border border-white/10 rounded-xl">
              ...
              <p className="text-white/75 mb-4">
                We accept cash or UPI payments. Payment is made when the escort arrives at your location in Adyar.
              </p>
            ...
            <div className="p-6 sm:p-8 bg-white/5 border border-white/10 rounded-xl">
              ...
              <p className="text-white/75 mb-4">
                For regular, housewife and college-girl profiles -no advance required. Payment when she arrives at your hotel or your place in Adyar. Have payment ready-cash or UPI-to make the transaction smooth.
              </p>
            ...
            <div className="p-6 sm:p-8 bg-white/5 border border-white/10 rounded-xl">
              ...
              <p className="text-white/75">
                If you&apos;re at a hotel in Adyar, we need proof you&apos;re staying there (room key photo or bill) and your room number. You give her name at reception when she arrives so she can come up. Payment is made when she arrives.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="relative py-10 sm:py-12 md:py-16 px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-6xl">
          <div className="text-center mb-10 sm:mb-12">
            ...
            <p className="text-base sm:text-lg text-white/60 max-w-xl mx-auto">
              What affects the rates in Adyar.
            </p>
          </div>
        ...
        <div className="mx-auto max-w-5xl">
          ...
          <div className="space-y-6">
            <div className="p-6 sm:p-8 bg-black/40 border border-white/10 rounded-xl">
              ...
              <p className="text-white/75">
                Message as early as you can. We usually reply within 1–2 hours; we&apos;ll tell you who&apos;s free and can reach you in Adyar. Popular for residential clients and upscale hotel guests who decide last minute.
              </p>
            </div>
            <div className="p-6 sm:p-8 bg-black/40 border border-white/10 rounded-xl">
            ...
            <div className="p-6 sm:p-8 bg-black/40 border border-white/10 rounded-xl">
              ...
              <p className="text-white/75">
                Evenings and weekends can be busier in Adyar. We&apos;ll still respond; advance notice helps secure your preferred time. Residential clients and upscale hotel guests often book weekday evenings.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="relative py-10 sm:py-12 md:py-16 px-4 sm:px-6 lg:px-8 bg-white/[0.02]">
        <div className="mx-auto max-w-5xl">
          ...
          <div className="grid sm:grid-cols-2 gap-4 sm:gap-6">
            {[
              { title: "Complete Discretion", desc: "We don't share your number with escorts. Your booking stays between you and us. Adyar is central-we're used to discreet hotel and residential outcall." },
              { title: "Verified Profiles", desc: "All escorts are verified before listing. Real photos, real people. No fake profiles or bait-and-switch in Adyar bookings." },
              { title: "Outcall Only", desc: "She comes to you-your hotel or your place in Adyar. You control the environment. No incall locations." },
          ...
          <div className="space-y-6">
            {[
              ...
              },
              {
                ...
                icon: "📊",
                content: "We monitor feedback and maintain quality standards. If an escort doesn't meet expectations, we address it immediately. Your feedback helps us maintain service quality in Adyar.",
                items: null,
                note: null
              }
            ].map((item, idx) => (
      ...
      <section className="relative py-10 sm:py-12 md:py-16 px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-5xl">
          <div className="text-center mb-8 sm:mb-10">
            ...
            <p className="text-base sm:text-lg md:text-xl text-white/70 max-w-2xl mx-auto">
              Have these ready so your booking in Adyar goes smoothly.
            </p>
          </div>

          <div className="space-y-4">
            {[
              { label: "Your Location", detail: "Exact location in Adyar-hotel name and area, or residential area and address. If it's your place, any gate or lobby instructions." },
          ...
          <div className="space-y-5">
            {[
              ...
              },
              {
                ...
                icon: "🏨",
                desc: "If you're staying at a hotel in Adyar, we need:",
                items: [
              ...
              },
              {
                ...
                icon: "🏠",
                desc: "For residential bookings in Adyar, we need your area and address. Clear gate or lobby instructions help avoid delays.",
                items: null
              },
              {
                title: "Communication",
      ...
      <section className="relative py-10 sm:py-12 md:py-16 px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-5xl">
          <div className="text-center mb-8 sm:mb-10">
            ...
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-white mb-3 sm:mb-4">
              Getting Around Adyar
            </h2>
            <p className="text-base sm:text-lg md:text-xl text-white/70 max-w-2xl mx-auto">
              Adyar's residential and upscale nature makes it ideal for clients seeking privacy and discretion.
            </p>
          </div>

          <div className="p-6 sm:p-8 bg-black/40 border border-white/10 rounded-xl">
            <p className="text-white/80 leading-relaxed mb-4">
              <strong className="text-white">Adyar</strong> is well-connected in Chennai, making it easy for escorts to reach you from other parts of the city. Whether you&apos;re staying at a luxury hotel or in a residential area near Adyar River, Besant Nagar, or other neighborhoods, we factor in travel time when suggesting who can reach you.
            </p>
            <p className="text-white/80 leading-relaxed mb-4">
            ...
            <p className="text-white/80 leading-relaxed">
              <strong className="text-white">Nearby areas:</strong> Nungambakkam (10 min), T Nagar (15 min), Egmore (15 min), Guindy (20 min). Adyar&apos;s residential and upscale nature makes it ideal for clients seeking privacy and discretion.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="relative py-10 sm:py-12 md:py-16 px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-5xl">
          ...
          <div className="mt-10 p-8 bg-gradient-to-r from-[var(--accent-gold)]/10 via-[var(--accent-gold)]/5 to-[var(--accent-gold)]/10 border-l-4 border-[var(--accent-gold)] rounded-xl">
            <p className="text-white/90 text-center leading-relaxed">
              <strong className="text-white">You don&apos;t need to arrange transportation.</strong> We handle all coordination. The escort will come directly to your location in Adyar.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="relative py-10 sm:py-12 md:py-16 px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-5xl">
          <div className="text-center mb-8 sm:mb-10">
            ...
            <p className="text-base sm:text-lg md:text-xl text-white/70 max-w-2xl mx-auto">
              Make your booking in Adyar smooth and hassle-free.
            </p>
          </div>
      ...
      <section className="relative py-10 sm:py-12 md:py-16 px-4 sm:px-6 lg:px-8 overflow-hidden">
        ...
        <div className="mx-auto max-w-7xl relative z-10">
          <div className="text-center mb-10 sm:mb-12">
            ...
            <h2 className="text-4xl sm:text-5xl md:text-6xl font-black text-white mb-4 leading-tight">
              Adyar vs<br />Other Areas
            </h2>
            <p className="text-base sm:text-lg text-white/60 max-w-xl mx-auto">
              What makes Adyar unique.
            </p>
          </div>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5 sm:gap-6">
            {AREA_COMPARISON.map((item, idx) => (
              <div
                key={item.area}
                className={`relative group ${
                  item.area === "Adyar" ? 'lg:col-span-3 sm:col-span-2' : ''
                }`}
              >
                {item.area === "Adyar" && (
                ...
                <div className={`relative p-6 sm:p-8 bg-black/60 backdrop-blur-md border-2 ${
                  ...
                  <div className={`text-center ${item.area === "Adyar" ? 'mt-4' : ''}`}>
          ...
          <div className="mt-10 p-8 bg-gradient-to-r from-black/80 via-[var(--accent-gold)]/10 to-black/80 border-2 border-[var(--accent-gold)]/30 rounded-2xl">
            <p className="text-white/90 text-center leading-relaxed text-base sm:text-lg">
              <strong className="text-white">Adyar&apos;s residential and upscale nature</strong> makes it ideal for clients who value discretion and privacy. With luxury hotels and quiet residential neighborhoods, Adyar offers a more private environment compared to busier commercial areas. We specialize in residential and upscale bookings.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="relative py-10 sm:py-12 md:py-16 px-4 sm:px-6 lg:px-8 bg-black" aria-labelledby="cta-heading" itemScope itemType="https://schema.org/ContactPage">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="text-lg sm:text-xl text-white/80 mb-8 sm:mb-10 max-w-2xl mx-auto" itemProp="description">
            Message us with your location in Adyar, when you need someone, and what you have in mind.
          </p>
          <div className="flex flex-wrap justify-center gap-3 sm:gap-4" role="group" aria-label="Contact options">
            <a
              ...
              aria-label="Contact us on Telegram for Adyar escort bookings"
            ...
            <Link
              ...
              rel="follow"
              aria-label="Contact page for Adyar escort service"
            >
              Contact
            </Link>
          </div>
