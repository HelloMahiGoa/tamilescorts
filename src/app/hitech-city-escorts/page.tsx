...
const url = `${base}/hitech-city-escorts`;

const metaTitle = "Hitech City Escorts | Hyderabad Escorts in Hitech City - Outcall to Hotels & Your Place";
const metaDescription =
  "Hitech City escorts and escort service in Hyderabad. Outcall to your hotel or place in Hitech City. Discreet, verified. Tamil, Mallu, Telugu & Kannada. Pay when you meet. No advance for regular & housewife.";
...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "Hyderabad escorts Hitech City",
    "outcall Hitech City",
    "hotel escort Hitech City",
    "Tamil escorts Hitech City",
    "escort service Hyderabad Hitech City",
    "Hitech City Main Road escorts",
    "IT companies escorts",
    "escorts near corporate offices",
    "Hitech City hotel escorts",
    "discreet escorts Hitech City",
    "verified escorts Hitech City",
    "Mallu escorts Hitech City",
    "Telugu escorts Hitech City",
    "Kannada escorts Hitech City",
    "housewife escorts Hitech City",
    "college girls escorts Hitech City",
    "model escorts Hitech City",
    "regular escorts Hitech City",
    "escort booking Hitech City",
    "escort service Hitech City Hyderabad",
    "outcall escort service Hitech City",
    "24/7 escorts Hitech City",
    "same day escorts Hitech City",
    "business traveler escorts Hitech City",
    "corporate escort Hitech City",
    "dinner escort Hitech City",
    "event escort Hitech City",
  ],
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Hitech City escorts – premium outcall escort service in Hyderabad",
        type: "image/avif",
      },
    ],
  },
  ...
  other: {
    "geo.region": "IN-TG",
    "geo.placename": "Hitech City, Hyderabad",
    "geo.position": "17.4500;78.3800",
    "ICBM": "17.4500, 78.3800",
  },
};

const OTHER_AREAS = [
  { name: "Banjara Hills", slug: "banjara-hills-escorts", desc: "Upscale residential & hotels" },
  { name: "Jubilee Hills", slug: "jubilee-hills-escorts", desc: "Premium area & corporate" },
  { name: "Gachibowli", slug: "gachibowli-escorts", desc: "IT hub & tech parks" },
  ...
  { name: "Begumpet", slug: "begumpet-escorts", desc: "Corporate & hotels" },
];

const HOW_IT_WORKS = [
  { step: 1, title: "Contact Us", body: "Message with your location in Hitech City (hotel or area), when you need someone, and what you have in mind. We'll ask the basics - hotel proof if you're at a hotel, type (regular, housewife, model, etc.)." },
  { step: 2, title: "We Suggest Who's Free", body: "We'll tell you who can reach you on time in Hitech City. If you're at a hotel we need proof and room details; you give her name at reception when she arrives." },
  { step: 3, title: "She Comes to You", body: "Outcall only. She'll come to your hotel or your place in Hitech City. Payment when she's there - cash or UPI. No advance for regular, housewife and college-girl profiles." },
];
...
const WHY_CHOOSE = [
  ...
  { title: "Complete Discretion", body: "We don't share your number. Your booking stays between you and us. Hitech City is central - we're used to discreet hotel and residential outcall." },
  { title: "Corporate & Hotels Hub", body: "Hitech City is Hyderabad's premier corporate and hotels area. Highest concentration of business hotels and corporate offices. We send someone who can reach you on time. No fuss." },
...
const LANGUAGES = [
  { name: "Telugu", desc: "Most bookings in Hitech City are Telugu. Perfect for locals and Telugu-speaking clients. Most popular language in Hyderabad." },
  { name: "Tamil", desc: "Tamil escorts available in Hitech City. Great for Tamil-speaking clients and business travelers." },
  { name: "Malayalam", desc: "Mallu escorts available in Hitech City. Popular for Kerala clients and Malayalam speakers." },
  { name: "Kannada", desc: "Kannada escorts in Hitech City. Same booking process and discretion." },
];

const POPULAR_HOTELS = [
  { name: "ITC Kohenur", area: "Hitech City Main Road", note: "Luxury hotel, popular for business travelers" },
  { name: "Taj Krishna", area: "Banjara Hills", note: "High-end, discreet outcall" },
  { name: "Novotel Hyderabad", area: "Hitech City", note: "Business hotel, easy access" },
  { name: "Radisson Blu", area: "Gachibowli", note: "IT hub, many corporate bookings" },
  { name: "The Park", area: "Hitech City", note: "Corporate area, convenient for outcall" },
  { name: "Marriott", area: "Hitech City", note: "Popular with business travelers" },
];

const DURATION_OPTIONS = [
  { title: "Short Time (2-3 hours)", desc: "Most popular in Hitech City. Perfect for business travelers staying at hotels. She comes to you for a few hours - dinner, conversation, or relaxed evening. Pay when she arrives; no advance for regular and housewife profiles.", popular: true },
  { title: "Dinner or Evening", desc: "Fixed slot for a dinner, event, or party in Hitech City. Tell us the start time and when it ends. Same payment rules. We match someone who fits the occasion.", popular: false },
  { title: "Full Night", desc: "Dinner plus the night - typically 8-10 hours. Advance notice helps so we can confirm who's free in Hitech City. Payment when she's there; for models and above we take a small advance.", popular: false },
  { title: "Outstation Travel", desc: "Trips from Hitech City to Goa, Bangalore, or elsewhere. We need a few days' notice. Not every companion does outstation. Same discretion and payment.", popular: false },
];

const WHO_BOOKS_HITECH_CITY = [
  { title: "Business Travelers", body: "Staying at hotels in Hitech City for work. Don't want to eat alone or sit in a room. Need discreet company that's hassle-free. Most bookings are from business travelers." },
  { title: "Locals", body: "Living in or near Hitech City and want company for an evening - dinner, event, or just a few hours. Same process: tell us your area, when, and type; we fix someone who shows up." },
  { title: "Events & Corporate", body: "Need a plus-one for a client dinner or corporate event in Hitech City. We send someone presentable who knows how to keep the evening smooth. Popular for business gatherings." },
];

const TIPS_FOR_EXPERIENCE = [
  { tip: "Be Clear About Location", detail: "Tell us your exact location in Hitech City - hotel name and area, or your residential area. Clear gate or lobby instructions help avoid delays." },
...
const SERVICES_OCCASIONS = [
  { title: "Dinner Dates", desc: "Company for dinner at restaurants in Hitech City. Presentable, conversation-ready. Perfect for business dinners or casual evenings.", popular: true },
  ...
  { title: "Parties & Social Events", desc: "Companion for parties, celebrations, or social gatherings in Hitech City. Fun, engaging, fits the occasion.", popular: false },
  { title: "Travel Companion", desc: "Company for outstation trips from Hitech City - Goa, Bangalore, or elsewhere. Advance notice required.", popular: false },
...
const WHY_HITECH_CITY = [
  { title: "Corporate & Hotels Hub", desc: "Hitech City is Hyderabad's premier corporate and hotels area. High concentration of business hotels and corporate offices makes it ideal for business travelers and corporate bookings." },
  { title: "Hotel Density", desc: "Highest concentration of business hotels in Hyderabad. We're experienced with hotel bookings in Hitech City. We know the area, the hotels, and how to coordinate discreet outcall." },
  { title: "IT & Business Hub", desc: "Many IT professionals and business travelers stay in Hitech City. We're used to corporate clients, business dinners, and professional occasions. Discretion is our default." },
  { title: "Easy Access", desc: "Well-connected by road, close to Hyderabad's IT companies and tech parks. Escorts can reach you quickly, whether you're at a hotel or corporate office." },
];

const TRANSPORTATION_INFO = [
  { title: "Travel Time", desc: "Escorts typically reach Hitech City within 30-60 minutes from other parts of Hyderabad. We factor in travel time when suggesting who can reach you on time." },
...
const AREA_HIGHLIGHTS = [
  { name: "Hitech City Main Road", type: "Main thoroughfare", note: "Many hotels and corporate offices along this road" },
  { name: "IT Companies", type: "Corporate area", note: "Tech parks and IT companies, business district" },
  { name: "Corporate Offices", type: "Business hub", note: "Major corporate offices and business centers" },
  { name: "Tech Parks", type: "IT hub", note: "Technology parks and innovation centers" },
  { name: "Business Hotels", type: "Hotels", note: "Concentration of business hotels for corporate travelers" },
  { name: "Gachibowli", type: "Nearby area", note: "Adjacent IT hub, easy access" },
];

const AREA_COMPARISON = [
  { area: "Hitech City", advantage: "Corporate & Hotels Hub", note: "Highest concentration of business hotels and corporate offices. Best for business travelers and corporate bookings." },
  { area: "Banjara Hills", advantage: "Upscale residential", note: "Premium area with good hotels, but fewer corporate offices than Hitech City" },
  { area: "Gachibowli", advantage: "IT hub", note: "Good for IT professionals, but less hotel density than Hitech City" },
  { area: "Jubilee Hills", advantage: "Premium area", note: "Upscale residential and hotels, but fewer business hotels than Hitech City" },
  { area: "Madhapur", advantage: "IT corridor", note: "IT companies and tech parks, but less central than Hitech City" },
  { area: "Secunderabad", advantage: "Business district", note: "Business area, but fewer corporate hotels than Hitech City" },
  { area: "Begumpet", advantage: "Corporate area", note: "Corporate offices and hotels, but less hotel density than Hitech City" },
];
...
const GROUP_BOOKING_INFO = [
  { title: "Multiple Escorts", desc: "Need multiple escorts for a corporate event, party, or group gathering in Hitech City? We can arrange 2-4 escorts depending on availability. Advance notice required - at least 2-3 days." },
...
const FAQ_ITEMS = [
  { q: "Do you cover Hitech City?", a: "Yes. Hitech City is one of our main areas in Hyderabad. We do outcall to hotels and residences in Hitech City. Tell us your location (hotel name or area) and when you need someone; we'll suggest who can reach you on time." },
  { q: "Do I need to pay advance in Hitech City?", a: "For regular, housewife and college-girl profiles - no advance. We need hotel proof and room details if you're at a hotel, and you give her name at reception. For models, artists, celebrity and actress we take a small advance; the rest when she arrives." },
  { q: "What's the best way to book an escort in Hitech City?", a: "Message us on Telegram. Tell us you're in Hitech City, when you need someone, and what you're looking for (regular, housewife, model, Tamil, Mallu, etc.). We'll suggest who's free. Same-day and advance bookings both work." },
  { q: "Outcall or incall in Hitech City?", a: "We do outcall only - she comes to your hotel or your place in Hitech City. Have the address and any gate or lobby instructions ready." },
  { q: "Why is Hitech City popular for escort bookings?", a: "Hitech City is Hyderabad's corporate & hotels hub with many business hotels and corporate travelers. It's easy for us to send someone there, and clients often stay in the area. Same process as the rest of Hyderabad: discreet, pay when you meet." },
];

// Build JSON-LD after all constants are defined
function buildHitechCityJsonLd() {
  ...
  return [
    {
      ...
      itemListElement: [
        ...
        { "@type": "ListItem", position: 3, name: "Hitech City Escorts", item: url },
      ],
    },
    {
      "@context": "https://schema.org",
    ...
    },
    {
      ...
      "@type": "LocalBusiness",
      "@id": localBusinessId,
      name: "Hitech City Escorts",
      description: "Premium escort service in Hitech City, Hyderabad. Outcall to hotels and residences. Discreet, verified companions. Tamil, Mallu, Telugu & Kannada escorts available.",
      url,
      image: [
        `${base}/images/2.avif`,
      ],
            ...
            itemListElement: [
              {
                ...
                itemOffered: {
                  ...
                  description: "Regular escort service in Hitech City. No advance required.",
                },
              },
            ],
          },
            ...
            itemListElement: [
              {
                ...
                itemOffered: {
                  ...
                  description: "Housewife escort service in Hitech City. Mature, discreet companions.",
                },
              },
            ],
          },
    ...
    },
    {
      ...
      "@type": "Service",
      "@id": serviceId,
      name: "Escort Service in Hitech City",
      description: "Premium outcall escort service in Hitech City, Hyderabad. Available 24/7. Discreet, verified companions.",
      provider: {
        "@id": organizationId,
      },
      areaServed: {
    ...
    },
    {
      "@context": "https://schema.org",
      "@type": "ItemList",
      name: "Popular Hotels in Hitech City",
      description: "Popular hotels and locations where we provide escort services in Hitech City",
    ...
    },
    {
      "@context": "https://schema.org",
      "@type": "ItemList",
      name: "Languages Available in Hitech City",
      description: "Languages spoken by escorts available in Hitech City",
    ...
    <main id="main-content" className="min-h-screen bg-black" itemScope itemType="https://schema.org/WebPage" lang="en-IN">
      ...
      <header className="relative w-full min-h-screen flex flex-col justify-end overflow-hidden" role="banner" itemScope itemType="https://schema.org/WPHeader">
        ...
        <div className="absolute inset-0" aria-hidden="true">
          <Image
            src="/images/2.avif"
            alt="Hitech City escorts – premium outcall escort service in Hyderabad. Discreet, verified companions available for hotel and residential bookings in central Hyderabad."
            fill
          ...
          <div className="mx-auto max-w-7xl">
            ...
            <nav className="mb-6 sm:mb-8" aria-label="Breadcrumb" itemScope itemType="https://schema.org/BreadcrumbList">
              <ol className="flex flex-wrap items-center gap-2 text-xs sm:text-sm text-white/50" role="list">
                ...
                <li aria-hidden="true" className="text-white/30">/</li>
                <li itemProp="itemListElement" itemScope itemType="https://schema.org/ListItem">
                  <span className="text-white/70" itemProp="name">Hitech City</span>
            ...
            <div>
              ...
              <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl 2xl:text-9xl font-black text-white leading-[0.9] mb-4 sm:mb-6 md:mb-8 tracking-tight">
                <span className="block">Hitech City</span>
          ...
          <div className="grid lg:grid-cols-12 gap-8 sm:gap-10 lg:gap-12 items-start">
            ...
            <div className="lg:col-span-9">
              ...
              <div className="prose prose-invert max-w-none space-y-4 sm:space-y-6 text-base sm:text-lg text-white/80 leading-relaxed" itemProp="description">
                <p>
                  <strong className="text-white">Hitech City</strong> is one of Hyderabad&apos;s busiest areas for hotel and outcall bookings. If you&apos;re staying at a hotel here or you live in the area and want company for a dinner or an evening, we&apos;ve got you.
                </p>
                <p>
                ...
                <p>
                  Outcall only - she comes to you. We don&apos;t share your number; discretion is default. Tell us your location in Hitech City, when you need someone, and what type you want (Tamil, Mallu, regular, model, etc.). We&apos;ll suggest who&apos;s free and can reach you on time.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="mx-auto max-w-7xl">
          <div className="text-center mb-8 sm:mb-10">
            ...
            <h2 id="why-choose-heading" className="text-3xl sm:text-4xl md:text-5xl font-bold text-white mb-3 sm:mb-4">
              Trusted Service in Hitech City
            </h2>
          </div>
      ...
      {/* Why Hitech City Specifically - Diagonal Split Design */}
      <section className="relative py-10 sm:py-12 md:py-16 px-4 sm:px-6 lg:px-8" aria-labelledby="why-hitech-city-heading" itemScope itemType="https://schema.org/ItemList">
        <div className="mx-auto max-w-7xl">
          <div className="mb-10 sm:mb-12">
            <div className="flex items-center gap-4 mb-4" aria-hidden="true">
              <div className="h-1 w-16 bg-[var(--accent-gold)]" />
              <span className="text-xs font-mono tracking-widest text-[var(--accent-gold)] uppercase">Why Hitech City</span>
            </div>
            <h2 id="why-hitech-city-heading" className="text-4xl sm:text-5xl md:text-6xl font-black text-white mb-4 leading-tight" itemProp="name">
              Why Choose<br />Hitech City?
            </h2>
          </div>

          <div className="grid lg:grid-cols-2 gap-6 sm:gap-8" itemProp="itemListElement" role="list">
            {WHY_HITECH_CITY.map((item, idx) => (
              <article
                key={item.title}
          ...
          <div className="grid lg:grid-cols-12 gap-6 sm:gap-8 mb-6 sm:mb-8">
            <div className="lg:col-span-4">
              ...
              <p className="text-base sm:text-lg text-white/70" itemProp="description">
                Regular, housewife, college girls, models and more. All available for outcall in Hitech City.
              </p>
            </div>
                ...
                {CATEGORIES.map((cat, idx) => (
                  ...
                  >
                    <Link
                      ...
                      rel="follow"
                      aria-label={`Browse ${cat.label} in Hitech City`}
                      itemProp="item"
                    >
        ...
        <div className="mx-auto max-w-7xl">
          <div className="text-center mb-8 sm:mb-10">
            ...
            <h2 id="languages-heading" className="text-3xl sm:text-4xl md:text-5xl font-bold text-white mb-3 sm:mb-4" itemProp="name">
              Languages Available in Hitech City
            </h2>
            <p className="text-base sm:text-lg md:text-xl text-white/70 max-w-2xl mx-auto" itemProp="description">
              Tamil, Mallu, Telugu, and Kannada escorts available for outcall in Hitech City.
            </p>
          </div>
        ...
        <div className="mx-auto max-w-7xl">
          <div className="text-center mb-8 sm:mb-10">
            ...
            <h2 id="hotels-heading" className="text-3xl sm:text-4xl md:text-5xl font-bold text-white mb-3 sm:mb-4" itemProp="name">
              Popular Hotels & Locations in Hitech City
            </h2>
            <p className="text-base sm:text-lg md:text-xl text-white/70 max-w-2xl mx-auto" itemProp="description">
              We cover major hotels and residential areas in Hitech City. Central location makes it easy for outcall.
            </p>
          </div>
          ...
          <div className="mt-8 p-6 bg-black/40 border border-white/10 rounded-xl">
            <p className="text-white/80 text-center">
              <strong className="text-white">Hitech City Main Road</strong>, <strong className="text-white">IT companies</strong>, and surrounding corporate areas are all covered. Tell us your hotel name or corporate area when you book.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="relative py-10 sm:py-12 md:py-16 px-4 sm:px-6 lg:px-8 bg-white/[0.02] overflow-hidden" aria-labelledby="highlights-heading" itemScope itemType="https://schema.org/ItemList">
        ...
        <div className="mx-auto max-w-7xl relative z-10">
          <div className="text-center mb-10 sm:mb-12">
            ...
            <p className="text-base sm:text-lg text-white/60 max-w-xl mx-auto" itemProp="description">
              Key locations and landmarks in and around Hitech City.
            </p>
          </div>
        ...
        <div className="mx-auto max-w-7xl">
          <div className="text-center mb-8 sm:mb-10">
            ...
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-white mb-3 sm:mb-4">
              Duration Options in Hitech City
            </h2>
            <p className="text-base sm:text-lg md:text-xl text-white/70 max-w-2xl mx-auto">
              Flexible durations. All outcall to your hotel or your place in Hitech City.
            </p>
          </div>
          ...
          <div className="space-y-6">
            <div className="p-6 sm:p-8 bg-white/5 border border-white/10 rounded-xl">
              ...
              <p className="text-white/75 mb-4">
                We accept cash or UPI payments. Payment is made when the escort arrives at your location in Hitech City.
              </p>
            ...
            <div className="p-6 sm:p-8 bg-white/5 border border-white/10 rounded-xl">
              ...
              <p className="text-white/75 mb-4">
                For regular, housewife and college-girl profiles - no advance required. Payment when she arrives at your hotel or your place in Hitech City. Have payment ready - cash or UPI - to make the transaction smooth.
              </p>
            ...
            <div className="p-6 sm:p-8 bg-white/5 border border-white/10 rounded-xl">
              ...
              <p className="text-white/75">
                If you&apos;re at a hotel in Hitech City, we need proof you&apos;re staying there (room key photo or bill) and your room number. You give her name at reception when she arrives so she can come up. Payment is made when she arrives.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="relative py-10 sm:py-12 md:py-16 px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-6xl">
          <div className="text-center mb-10 sm:mb-12">
            ...
            <p className="text-base sm:text-lg text-white/60 max-w-xl mx-auto">
              What affects the rates in Hitech City.
            </p>
          </div>
        ...
        <div className="mx-auto max-w-5xl">
          ...
          <div className="space-y-6">
            <div className="p-6 sm:p-8 bg-black/40 border border-white/10 rounded-xl">
              ...
              <p className="text-white/75">
                Message as early as you can. We usually reply within 1–2 hours; we&apos;ll tell you who&apos;s free and can reach you in Hitech City. Popular for business travelers who decide last minute.
              </p>
            </div>
            <div className="p-6 sm:p-8 bg-black/40 border border-white/10 rounded-xl">
            ...
            <div className="p-6 sm:p-8 bg-black/40 border border-white/10 rounded-xl">
              ...
              <p className="text-white/75">
                Evenings and weekends can be busier in Hitech City. We&apos;ll still respond; advance notice helps secure your preferred time. Business travelers often book weekday evenings.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="relative py-10 sm:py-12 md:py-16 px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-7xl">
          <div className="text-center mb-8 sm:mb-10">
            ...
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-white mb-3 sm:mb-4">
              Who Books Escorts in Hitech City?
            </h2>
            <p className="text-base sm:text-lg md:text-xl text-white/70 max-w-2xl mx-auto">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
            {WHO_BOOKS_HITECH_CITY.map((item) => (
              <div
                key={item.title}
      ...
      <section className="relative py-10 sm:py-12 md:py-16 px-4 sm:px-6 lg:px-8 bg-white/[0.02]">
        <div className="mx-auto max-w-5xl">
          <div className="text-center mb-8 sm:mb-10">
            ...
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-white mb-3 sm:mb-4">
              Safety & Discretion in Hitech City
            </h2>
            <p className="text-base sm:text-lg md:text-xl text-white/70 max-w-2xl mx-auto">
          ...
          <div className="grid sm:grid-cols-2 gap-4 sm:gap-6">
            {[
              { title: "Complete Discretion", desc: "We don't share your number with escorts. Your booking stays between you and us. Hitech City is central - we're used to discreet hotel and residential outcall." },
              { title: "Verified Profiles", desc: "All escorts are verified before listing. Real photos, real people. No fake profiles or bait-and-switch in Hitech City bookings." },
              { title: "Outcall Only", desc: "She comes to you - your hotel or your place in Hitech City. You control the environment. No incall locations." },
          ...
          <div className="space-y-6">
            {[
              ...
              },
              {
                ...
                icon: "📊",
                content: "We monitor feedback and maintain quality standards. If an escort doesn't meet expectations, we address it immediately. Your feedback helps us maintain service quality in Hitech City.",
                items: null,
                note: null
              }
            ].map((item, idx) => (
      ...
      <section className="relative py-10 sm:py-12 md:py-16 px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-5xl">
          <div className="text-center mb-8 sm:mb-10">
            ...
            <p className="text-base sm:text-lg md:text-xl text-white/70 max-w-2xl mx-auto">
              Have these ready so your booking in Hitech City goes smoothly.
            </p>
          </div>

          <div className="space-y-4">
            {[
              { label: "Your Location", detail: "Exact location in Hitech City - hotel name and area, or residential area and address. If it's your place, any gate or lobby instructions." },
          ...
          <div className="space-y-5">
            {[
              ...
              },
              {
                ...
                icon: "🏨",
                desc: "If you're staying at a hotel in Hitech City, we need:",
                items: [
              ...
              },
              {
                ...
                icon: "🏠",
                desc: "For residential bookings in Hitech City, we need your area and address. Clear gate or lobby instructions help avoid delays.",
                items: null
              },
              {
                title: "Communication",
      ...
      <section className="relative py-10 sm:py-12 md:py-16 px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-5xl">
          <div className="text-center mb-8 sm:mb-10">
            ...
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-white mb-3 sm:mb-4">
              Getting Around Hitech City
            </h2>
            <p className="text-base sm:text-lg md:text-xl text-white/70 max-w-2xl mx-auto">
              Central location makes Hitech City easy to reach from anywhere in Hyderabad.
            </p>
          </div>

          <div className="p-6 sm:p-8 bg-black/40 border border-white/10 rounded-xl">
            <p className="text-white/80 leading-relaxed mb-4">
              <strong className="text-white">Hitech City</strong> is Hyderabad&apos;s premier corporate and hotels area, making it easy for escorts to reach you from other parts of the city. Whether you&apos;re staying at a hotel on Hitech City Main Road, at a corporate office, or in a business hotel, we factor in travel time when suggesting who can reach you.
            </p>
            <p className="text-white/80 leading-relaxed mb-4">
              The area is well-connected by road and has good access to major IT companies and tech parks. Tell us your location when you book - we don&apos;t need the exact address until we confirm, but clear gate or lobby instructions help avoid delays.
            </p>
            <p className="text-white/80 leading-relaxed">
              <strong className="text-white">Nearby areas:</strong> Gachibowli (5 min), Madhapur (10 min), Banjara Hills (15 min), Jubilee Hills (20 min). Easy access makes Hitech City one of Hyderabad&apos;s most convenient areas for corporate and hotel bookings.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="relative py-10 sm:py-12 md:py-16 px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-5xl">
          ...
          <div className="mt-10 p-8 bg-gradient-to-r from-[var(--accent-gold)]/10 via-[var(--accent-gold)]/5 to-[var(--accent-gold)]/10 border-l-4 border-[var(--accent-gold)] rounded-xl">
            <p className="text-white/90 text-center leading-relaxed">
              <strong className="text-white">You don&apos;t need to arrange transportation.</strong> We handle all coordination. The escort will come directly to your location in Hitech City.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="relative py-10 sm:py-12 md:py-16 px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-5xl">
          <div className="text-center mb-8 sm:mb-10">
            ...
            <p className="text-base sm:text-lg md:text-xl text-white/70 max-w-2xl mx-auto">
              Make your booking in Hitech City smooth and hassle-free.
            </p>
          </div>
      ...
      <section className="relative py-10 sm:py-12 md:py-16 px-4 sm:px-6 lg:px-8 overflow-hidden">
        ...
        <div className="mx-auto max-w-7xl relative z-10">
          <div className="text-center mb-10 sm:mb-12">
            ...
            <h2 className="text-4xl sm:text-5xl md:text-6xl font-black text-white mb-4 leading-tight">
              Hitech City vs<br />Other Areas
            </h2>
            <p className="text-base sm:text-lg text-white/60 max-w-xl mx-auto">
              What makes Hitech City unique.
            </p>
          </div>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5 sm:gap-6">
            {AREA_COMPARISON.map((item, idx) => (
              <div
                key={item.area}
                className={`relative group ${
                  item.area === "Hitech City" ? 'lg:col-span-3 sm:col-span-2' : ''
                }`}
              >
                {item.area === "Hitech City" && (
                ...
                <div className={`relative p-6 sm:p-8 bg-black/60 backdrop-blur-md border-2 ${
                  ...
                  <div className={`text-center ${item.area === "Hitech City" ? 'mt-4' : ''}`}>
          ...
          <div className="mt-10 p-8 bg-gradient-to-r from-black/80 via-[var(--accent-gold)]/10 to-black/80 border-2 border-[var(--accent-gold)]/30 rounded-2xl">
            <p className="text-white/90 text-center leading-relaxed text-base sm:text-lg">
              <strong className="text-white">Hitech City&apos;s corporate & hotels hub</strong> makes it the most convenient area for escort bookings in Hyderabad. Highest concentration of business hotels and corporate offices, easy access from all parts of the city, and we&apos;re most experienced with this area.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="relative py-10 sm:py-12 md:py-16 px-4 sm:px-6 lg:px-8 bg-black" aria-labelledby="cta-heading" itemScope itemType="https://schema.org/ContactPage">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="text-lg sm:text-xl text-white/80 mb-8 sm:mb-10 max-w-2xl mx-auto" itemProp="description">
            Message us with your location in Hitech City, when you need someone, and what you have in mind.
          </p>
          <div className="flex flex-wrap justify-center gap-3 sm:gap-4" role="group" aria-label="Contact options">
            <a
              ...
              aria-label="Contact us on Telegram for Hitech City escort bookings"
            ...
            <Link
              ...
              rel="follow"
              aria-label="Contact page for Hitech City escort service"
            >
              Contact
            </Link>
          </div>
