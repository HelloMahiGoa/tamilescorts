...
const url = `${base}/tambaram-escorts`;

const metaTitle = "Tambaram Escorts | Chennai Escorts in Tambaram - Outcall to Hotels & Your Place";
const metaDescription =
  "Tambaram escorts and escort service in Chennai. Outcall to your hotel or place in Tambaram. Discreet, verified. Tamil, Mallu, Telugu & Kannada. Pay when you meet. No advance for regular & housewife.";
...
export const metadata: Metadata = {
  ...
  keywords: [
    "Tambaram escorts",
    "escorts in Tambaram",
    "Tambaram escort service",
    "Chennai escorts Tambaram",
    "outcall Tambaram",
    "hotel escort Tambaram",
    "Tamil escorts Tambaram",
    "escort service Chennai Tambaram",
    "Tambaram Railway Station escorts",
    "South Chennai escorts",
    "escorts near Tambaram",
    "Tambaram hotel escorts",
    "discreet escorts Tambaram",
    "verified escorts Tambaram",
    "Mallu escorts Tambaram",
    "Telugu escorts Tambaram",
    "Kannada escorts Tambaram",
    "housewife escorts Tambaram",
    "college girls escorts Tambaram",
    "model escorts Tambaram",
    "regular escorts Tambaram",
    "escort booking Tambaram",
    "escort service Tambaram Chennai",
    "outcall escort service Tambaram",
    "24/7 escorts Tambaram",
    "same day escorts Tambaram",
    "business traveler escorts Tambaram",
    "corporate escort Tambaram",
    "dinner escort Tambaram",
    "event escort Tambaram",
  ],
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Tambaram escorts - premium outcall escort service in Chennai",
        type: "image/avif",
      },
    ],
  },
  ...
  other: {
    "geo.region": "IN-TN",
    "geo.placename": "Tambaram, Chennai",
    "geo.position": "12.9200;80.1100",
    "ICBM": "12.9200, 80.1100",
  },
};

const OTHER_AREAS = [
  { name: "Nungambakkam", slug: "nungambakkam-escorts", desc: "Central location" },
  { name: "T Nagar", slug: "t-nagar-escorts", desc: "Most hotel bookings" },
  { name: "OMR", slug: "omr-escorts", desc: "IT & corporate" },
  { name: "Guindy", slug: "guindy-escorts", desc: "Business district" },
  { name: "Adyar", slug: "adyar-escorts", desc: "Residential & hotels" },
  { name: "Velachery", slug: "velachery-escorts", desc: "South Chennai" },
  { name: "Egmore", slug: "egmore-escorts", desc: "Central" },
];

const HOW_IT_WORKS = [
  { step: 1, title: "Contact Us", body: "Message with your location in Tambaram (hotel or area), when you need someone, and what you have in mind. We'll ask the basics-hotel proof if you're at a hotel, type (regular, housewife, model, etc.)." },
  { step: 2, title: "We Suggest Who's Free", body: "We'll tell you who can reach you on time in Tambaram. If you're at a hotel we need proof and room details; you give her name at reception when she arrives." },
  { step: 3, title: "She Comes to You", body: "Outcall only. She'll come to your hotel or your place in Tambaram. Payment when she's there - cash or UPI. No advance for regular, housewife and college-girl profiles." },
];
...
const WHY_CHOOSE = [
  ...
  { title: "Complete Discretion", body: "We don't share your number. Your booking stays between you and us. Tambaram is South Chennai suburban - we're used to discreet hotel and residential outcall." },
  { title: "South Chennai Suburban & Easy", body: "Tambaram's South Chennai suburban location with railway station proximity makes it convenient for bookings. We send someone who can reach you on time. No fuss." },
...
const LANGUAGES = [
  { name: "Tamil", desc: "Most bookings in Tambaram are Tamil. Perfect for locals and Tamil-speaking clients." },
  { name: "Malayalam", desc: "Mallu escorts available in Tambaram. Great for Kerala clients and Malayalam speakers." },
  { name: "Telugu", desc: "Telugu-speaking companions in Tambaram. Popular for business travelers from Andhra/Telangana." },
  { name: "Kannada", desc: "Kannada escorts in Tambaram. Same booking process and discretion." },
];

const POPULAR_HOTELS = [
  { name: "South Chennai Hotels", area: "Tambaram area", note: "Suburban hotels, popular for business travelers" },
  { name: "Tambaram Railway Station Hotels", area: "Near railway station", note: "Convenient location, easy access" },
  { name: "Suburban Hotels", area: "South Chennai", note: "Residential area hotels, discreet outcall" },
  { name: "Business Hotels", area: "Tambaram", note: "South Chennai suburban location, many bookings" },
  { name: "Residential Area Hotels", area: "Tambaram", note: "South Chennai suburban, convenient for outcall" },
  { name: "Railway Station Proximity", area: "Tambaram", note: "Close to Tambaram Railway Station" },
];

const DURATION_OPTIONS = [
  { title: "Short Time (2-3 hours)", desc: "Most popular in Tambaram. Perfect for business travelers staying at hotels. She comes to you for a few hours-dinner, conversation, or relaxed evening. Pay when she arrives; no advance for regular and housewife profiles.", popular: true },
  { title: "Dinner or Evening", desc: "Fixed slot for a dinner, event, or party in Tambaram. Tell us the start time and when it ends. Same payment rules. We match someone who fits the occasion.", popular: false },
  { title: "Full Night", desc: "Dinner plus the night-typically 8-10 hours. Advance notice helps so we can confirm who's free in Tambaram. Payment when she's there; for models and above we take a small advance.", popular: false },
  { title: "Outstation Travel", desc: "Trips from Tambaram to Pondicherry, Mahabalipuram, or elsewhere. We need a few days' notice. Not every companion does outstation. Same discretion and payment.", popular: false },
];

const WHO_BOOKS_TAMBARAM = [
  { title: "Business Travelers", body: "Staying at hotels in Tambaram for work. Don't want to eat alone or sit in a room. Need discreet company that's hassle-free. Most bookings are from business travelers." },
  { title: "Locals", body: "Living in or near Tambaram and want company for an evening-dinner, event, or just a few hours. Same process: tell us your area, when, and type; we fix someone who shows up." },
  { title: "Events & Corporate", body: "Need a plus-one for a client dinner or corporate event in Tambaram. We send someone presentable who knows how to keep the evening smooth. Popular for business gatherings." },
];

const TIPS_FOR_EXPERIENCE = [
  { tip: "Be Clear About Location", detail: "Tell us your exact location in Tambaram-hotel name and area, or your residential area. Clear gate or lobby instructions help avoid delays." },
...
const SERVICES_OCCASIONS = [
  { title: "Dinner Dates", desc: "Company for dinner at restaurants in Tambaram. Presentable, conversation-ready. Perfect for business dinners or casual evenings.", popular: true },
  ...
  { title: "Parties & Social Events", desc: "Companion for parties, celebrations, or social gatherings in Tambaram. Fun, engaging, fits the occasion.", popular: false },
  { title: "Travel Companion", desc: "Company for outstation trips from Tambaram-Pondicherry, Mahabalipuram, or elsewhere. Advance notice required.", popular: false },
...
const WHY_TAMBARAM = [
  { title: "South Chennai Suburban Location", desc: "Tambaram is a key South Chennai suburban area with excellent connectivity. Railway station proximity makes it easy for escorts to reach you. Well-connected to both South Chennai and the city center." },
  { title: "Railway Station Proximity", desc: "Tambaram Railway Station is a major transport hub, making it convenient for both clients and escorts. Easy access from various parts of Chennai via train and road." },
  { title: "Residential Area Advantage", desc: "Tambaram's residential character offers discreet outcall service. We're experienced with suburban hotel bookings and residential area visits. Privacy and discretion are our priority." },
  { title: "South Chennai Hub", desc: "As a South Chennai suburban hub, Tambaram offers good hotel options and residential areas. Escorts can reach you efficiently, whether you're at a hotel or your place." },
];

const TRANSPORTATION_INFO = [
  { title: "Travel Time", desc: "Escorts typically reach Tambaram within 30-60 minutes from other parts of Chennai. We factor in travel time when suggesting who can reach you on time." },
  ...
  { title: "Traffic Considerations", desc: "Chennai traffic can vary. We account for peak hours (evening rush) when scheduling. Advance bookings give us more flexibility to avoid delays." },
];
...
const COMMON_CONCERNS = [
  { concern: "Is this legitimate?", answer: "Yes. We're a professional escort service operating in Chennai. All escorts are verified, real people. We maintain discretion and professionalism." },
...
const AREA_HIGHLIGHTS = [
  { name: "Tambaram Railway Station", type: "Transport hub", note: "Major railway station, convenient access" },
  { name: "Residential Areas", type: "Residential", note: "South Chennai suburban residential neighborhoods" },
  { name: "South Chennai Landmarks", type: "Landmarks", note: "Key South Chennai suburban location reference points" },
  { name: "Suburban Hotels", type: "Hotels", note: "South Chennai hotels serving business travelers" },
  { name: "Railway Station Proximity", type: "Location advantage", note: "Close to Tambaram Railway Station for easy access" },
  { name: "South Chennai Connectivity", type: "Transport", note: "Well-connected to South Chennai and city center" },
];

const AREA_COMPARISON = [
  { area: "Tambaram", advantage: "South Chennai suburban advantage", note: "Railway station proximity, residential area, South Chennai suburban location with good connectivity" },
  { area: "Nungambakkam", advantage: "Central location", note: "Most central, highest hotel density, but further from South Chennai" },
  { area: "T Nagar", advantage: "Shopping district", note: "Popular for hotel bookings, but central Chennai location" },
  { area: "OMR", advantage: "IT corridor", note: "Good for IT professionals, but further from city center" },
  { area: "Adyar", advantage: "Residential & upscale", note: "Quieter area, good hotels but central Chennai location" },
  { area: "Guindy", advantage: "Business district", note: "Corporate hub, but central Chennai location" },
  { area: "Velachery", advantage: "South Chennai hub", note: "Growing area with good connectivity, similar to Tambaram" },
  { area: "Egmore", advantage: "Transport hub", note: "Near railway station, convenient but central Chennai location" },
];

const SEASONAL_AVAILABILITY = [
  { period: "Peak Business Season", months: "October - March", desc: "Most business travelers visit Chennai during these months. Weekday evenings are busiest. Advance booking recommended for preferred times.", busy: true },
...
const GROUP_BOOKING_INFO = [
  { title: "Multiple Escorts", desc: "Need multiple escorts for a corporate event, party, or group gathering in Tambaram? We can arrange 2-4 escorts depending on availability. Advance notice required-at least 2-3 days." },
...
const FAQ_ITEMS = [
  { q: "Do you cover Tambaram?", a: "Yes. Tambaram is one of our main areas in Chennai. We do outcall to hotels and residences in Tambaram. Tell us your location (hotel name or area) and when you need someone; we'll suggest who can reach you on time." },
  { q: "Do I need to pay advance in Tambaram?", a: "For regular, housewife and college-girl profiles -no advance. We need hotel proof and room details if you're at a hotel, and you give her name at reception. For models, artists, celebrity and actress we take a small advance; the rest when she arrives." },
  { q: "What's the best way to book an escort in Tambaram?", a: "Message us on Telegram. Tell us you're in Tambaram, when you need someone, and what you're looking for (regular, housewife, model, Tamil, Mallu, etc.). We'll suggest who's free. Same-day and advance bookings both work." },
  { q: "Outcall or incall in Tambaram?", a: "We do outcall only - she comes to your hotel or your place in Tambaram. Have the address and any gate or lobby instructions ready." },
  { q: "Why is Tambaram popular for escort bookings?", a: "Tambaram is South Chennai suburban with many hotels and business travelers. It's easy for us to send someone there, and clients often stay in the area. Same process as the rest of Chennai: discreet, pay when you meet." },
];

// Build JSON-LD after all constants are defined
function buildTambaramJsonLd() {
  ...
  return [
    {
      ...
      itemListElement: [
        ...
        { "@type": "ListItem", position: 2, name: "Chennai Escorts", item: `${base}/chennai-escorts` },
        { "@type": "ListItem", position: 3, name: "Tambaram Escorts", item: url },
      ],
    },
    {
      "@context": "https://schema.org",
    ...
    },
    {
      ...
      "@type": "LocalBusiness",
      "@id": localBusinessId,
      name: "Tambaram Escorts",
      description: "Premium escort service in Tambaram, Chennai. Outcall to hotels and residences. Discreet, verified companions. Tamil, Mallu, Telugu & Kannada escorts available.",
      url,
      image: [
        `${base}/images/2.avif`,
      ],
      priceRange: "â‚¹â‚¹ - â‚¹â‚¹â‚¹â‚¹â‚¹",
      address: {
        "@type": "PostalAddress",
            ...
            itemListElement: [
              {
                ...
                itemOffered: {
                  ...
                  description: "Regular escort service in Tambaram. No advance required.",
                },
              },
            ],
          },
            ...
            itemListElement: [
              {
                ...
                itemOffered: {
                  ...
                  description: "Housewife escort service in Tambaram. Mature, discreet companions.",
                },
              },
            ],
          },
    ...
    },
    {
      ...
      "@type": "Service",
      "@id": serviceId,
      name: "Escort Service in Tambaram",
      description: "Premium outcall escort service in Tambaram, Chennai. Available 24/7. Discreet, verified companions.",
      provider: {
        "@id": organizationId,
      },
      areaServed: {
    ...
    },
    {
      "@context": "https://schema.org",
      "@type": "ItemList",
      name: "Popular Hotels in Tambaram",
      description: "Popular hotels and locations where we provide escort services in Tambaram",
    ...
    },
    {
      "@context": "https://schema.org",
      "@type": "ItemList",
      name: "Languages Available in Tambaram",
      description: "Languages spoken by escorts available in Tambaram",
...
export default function TambaramEscortsPage() {
  const jsonLd = buildTambaramJsonLd();
  return (
    <main id="main-content" className="min-h-screen bg-black" itemScope itemType="https://schema.org/WebPage" lang="en-IN">
      ...
      <header className="relative w-full min-h-screen flex flex-col justify-end overflow-hidden" role="banner" itemScope itemType="https://schema.org/WPHeader">
        ...
        <div className="absolute inset-0" aria-hidden="true">
          <Image
            src="/images/2.avif"
            alt="Tambaram escorts - premium outcall escort service in Chennai. Discreet, verified companions available for hotel and residential bookings in South Chennai suburban."
            fill
          ...
          <div className="mx-auto max-w-7xl">
            ...
            <nav className="mb-6 sm:mb-8" aria-label="Breadcrumb" itemScope itemType="https://schema.org/BreadcrumbList">
              <ol className="flex flex-wrap items-center gap-2 text-xs sm:text-sm text-white/50" role="list">
                ...
                <li itemProp="itemListElement" itemScope itemType="https://schema.org/ListItem">
                  <Link href="/chennai-escorts" className="hover:text-[var(--accent-gold)] transition-colors" itemProp="item" rel="up" aria-label="View Chennai escorts page">
                ...
                <li aria-hidden="true" className="text-white/30">/</li>
                <li itemProp="itemListElement" itemScope itemType="https://schema.org/ListItem">
                  <span className="text-white/70" itemProp="name">Tambaram</span>
            ...
            <div>
              ...
              <div className="inline-flex items-center gap-2 px-3 sm:px-4 py-1.5 sm:py-2 mb-4 sm:mb-6 bg-[var(--accent-gold)]/20 backdrop-blur-md border border-[var(--accent-gold)]/40 rounded-full">
                ...
                <span className="text-[10px] sm:text-xs font-semibold tracking-widest text-[var(--accent-gold)] uppercase">
                  Chennai · South Chennai Suburban
                </span>
              </div>
              ...
              <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl 2xl:text-9xl font-black text-white leading-[0.9] mb-4 sm:mb-6 md:mb-8 tracking-tight">
                <span className="block">Tambaram</span>
              ...
              <p className="text-base sm:text-lg md:text-xl lg:text-2xl text-white/95 leading-relaxed mb-6 sm:mb-8 md:mb-10 max-w-2xl lg:max-w-3xl font-light" itemProp="description">
                Premium escort service in South Chennai suburban. Outcall to your hotel or your place - discreet, verified, pay when you meet.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="grid lg:grid-cols-12 gap-8 sm:gap-10 lg:gap-12 items-start">
            ...
            <div className="lg:col-span-9">
              <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-white mb-6 sm:mb-8 leading-tight" itemProp="name">
                South Chennai Suburban&apos;s Premier Escort Service
              </h2>
              <div className="prose prose-invert max-w-none space-y-4 sm:space-y-6 text-base sm:text-lg text-white/80 leading-relaxed" itemProp="description">
                <p>
                  <strong className="text-white">Tambaram</strong> is a key South Chennai suburban area with railway station proximity and residential neighborhoods. If you&apos;re staying at a hotel here or you live in the area and want company for a dinner or an evening, we&apos;ve got you.
                </p>
                <p>
                ...
                <p>
                  Outcall only - she comes to you. We don&apos;t share your number; discretion is default. Tell us your location in Tambaram, when you need someone, and what type you want (Tamil, Mallu, regular, model, etc.). We&apos;ll suggest who&apos;s free and can reach you on time.
                </p>
              </div>
            </div>
          </div>
      ...
      {/* Why Tambaram Specifically - Diagonal Split Design */}
      <section className="relative py-10 sm:py-12 md:py-16 px-4 sm:px-6 lg:px-8" aria-labelledby="why-Tambaram-heading" itemScope itemType="https://schema.org/ItemList">
        <div className="mx-auto max-w-7xl">
          <div className="mb-10 sm:mb-12">
            <div className="flex items-center gap-4 mb-4" aria-hidden="true">
              <div className="h-1 w-16 bg-[var(--accent-gold)]" />
              <span className="text-xs font-mono tracking-widest text-[var(--accent-gold)] uppercase">Why Tambaram</span>
            </div>
            <h2 id="why-Tambaram-heading" className="text-4xl sm:text-5xl md:text-6xl font-black text-white mb-4 leading-tight" itemProp="name">
              Why Choose<br />Tambaram?
            </h2>
          </div>

          <div className="grid lg:grid-cols-2 gap-6 sm:gap-8" itemProp="itemListElement" role="list">
            {WHY_TAMBARAM.map((item, idx) => (
              <article
                key={item.title}
          ...
          <div className="grid lg:grid-cols-12 gap-6 sm:gap-8 mb-6 sm:mb-8">
            <div className="lg:col-span-4">
              ...
              <p className="text-base sm:text-lg text-white/70" itemProp="description">
                Regular, housewife, college girls, models and more. All available for outcall in Tambaram.
              </p>
            </div>
                ...
                {CATEGORIES.map((cat, idx) => (
                  ...
                  >
                    <Link
                      ...
                      rel="follow"
                      aria-label={`Browse ${cat.label} in Tambaram`}
                      itemProp="item"
                    >
        ...
        <div className="mx-auto max-w-7xl">
          <div className="text-center mb-8 sm:mb-10">
            ...
            <h2 id="languages-heading" className="text-3xl sm:text-4xl md:text-5xl font-bold text-white mb-3 sm:mb-4" itemProp="name">
              Languages Available in Tambaram
            </h2>
            <p className="text-base sm:text-lg md:text-xl text-white/70 max-w-2xl mx-auto" itemProp="description">
              Tamil, Mallu, Telugu, and Kannada escorts available for outcall in Tambaram.
            </p>
          </div>
        ...
        <div className="mx-auto max-w-7xl">
          <div className="text-center mb-8 sm:mb-10">
            ...
            <h2 id="hotels-heading" className="text-3xl sm:text-4xl md:text-5xl font-bold text-white mb-3 sm:mb-4" itemProp="name">
              Popular Hotels & Locations in Tambaram
            </h2>
            <p className="text-base sm:text-lg md:text-xl text-white/70 max-w-2xl mx-auto" itemProp="description">
              We cover major hotels and residential areas in Tambaram. South Chennai suburban location makes it easy for outcall.
            </p>
          </div>
          ...
          <div className="mt-8 p-6 bg-black/40 border border-white/10 rounded-xl">
            <p className="text-white/80 text-center">
              <strong className="text-white">Tambaram Railway Station</strong> area, <strong className="text-white">South Chennai hotels</strong>, and surrounding residential areas are all covered. Tell us your hotel name or residential area when you book.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-7xl relative z-10">
          <div className="text-center mb-10 sm:mb-12">
            <div className="inline-block mb-4" aria-hidden="true">
              <span className="text-xs font-mono tracking-widest text-[var(--accent-gold)] uppercase">ðŸ“ Landmarks</span>
            </div>
            ...
            <p className="text-base sm:text-lg text-white/60 max-w-xl mx-auto" itemProp="description">
              Key locations and landmarks in and around Tambaram.
            </p>
          </div>
        ...
        <div className="mx-auto max-w-7xl">
          <div className="text-center mb-8 sm:mb-10">
            ...
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-white mb-3 sm:mb-4">
              Duration Options in Tambaram
            </h2>
            <p className="text-base sm:text-lg md:text-xl text-white/70 max-w-2xl mx-auto">
              Flexible durations. All outcall to your hotel or your place in Tambaram.
            </p>
          </div>
          ...
          <div className="space-y-6">
            <div className="p-6 sm:p-8 bg-white/5 border border-white/10 rounded-xl">
              ...
              <p className="text-white/75 mb-4">
                We accept cash or UPI payments. Payment is made when the escort arrives at your location in Tambaram.
              </p>
            ...
            <div className="p-6 sm:p-8 bg-white/5 border border-white/10 rounded-xl">
              ...
              <p className="text-white/75 mb-4">
                For regular, housewife and college-girl profiles -no advance required. Payment when she arrives at your hotel or your place in Tambaram. Have payment ready-cash or UPI-to make the transaction smooth.
              </p>
            ...
            <div className="p-6 sm:p-8 bg-white/5 border border-white/10 rounded-xl">
              ...
              <p className="text-white/75">
                If you&apos;re at a hotel in Tambaram, we need proof you&apos;re staying there (room key photo or bill) and your room number. You give her name at reception when she arrives so she can come up. Payment is made when she arrives.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="relative py-10 sm:py-12 md:py-16 px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-6xl">
          <div className="text-center mb-10 sm:mb-12">
            ...
            <p className="text-base sm:text-lg text-white/60 max-w-xl mx-auto">
              What affects the rates in Tambaram.
            </p>
          </div>
        ...
        <div className="mx-auto max-w-5xl">
          ...
          <div className="space-y-6">
            <div className="p-6 sm:p-8 bg-black/40 border border-white/10 rounded-xl">
              ...
              <p className="text-white/75">
                Message as early as you can. We usually reply within 1-2 hours; we&apos;ll tell you who&apos;s free and can reach you in Tambaram. Popular for business travelers who decide last minute.
              </p>
            </div>
            <div className="p-6 sm:p-8 bg-black/40 border border-white/10 rounded-xl">
            ...
            <div className="p-6 sm:p-8 bg-black/40 border border-white/10 rounded-xl">
              ...
              <p className="text-white/75">
                Evenings and weekends can be busier in Tambaram. We&apos;ll still respond; advance notice helps secure your preferred time. Business travelers often book weekday evenings.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="relative py-10 sm:py-12 md:py-16 px-4 sm:px-6 lg:px-8 bg-white/[0.02]">
        <div className="mx-auto max-w-5xl">
          ...
          <div className="grid sm:grid-cols-2 gap-4 sm:gap-6">
            {[
              { title: "Complete Discretion", desc: "We don't share your number with escorts. Your booking stays between you and us. Tambaram is South Chennai suburban-we're used to discreet hotel and residential outcall." },
              { title: "Verified Profiles", desc: "All escorts are verified before listing. Real photos, real people. No fake profiles or bait-and-switch in Tambaram bookings." },
              { title: "Outcall Only", desc: "She comes to you-your hotel or your place in Tambaram. You control the environment. No incall locations." },
          ...
          <div className="space-y-6">
            {[
              ...
              },
              {
                ...
                icon: "ðŸ“Š",
                content: "We monitor feedback and maintain quality standards. If an escort doesn't meet expectations, we address it immediately. Your feedback helps us maintain service quality in Tambaram.",
                items: null,
                note: null
              }
            ].map((item, idx) => (
      ...
      <section className="relative py-10 sm:py-12 md:py-16 px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-5xl">
          <div className="text-center mb-8 sm:mb-10">
            ...
            <p className="text-base sm:text-lg md:text-xl text-white/70 max-w-2xl mx-auto">
              Have these ready so your booking in Tambaram goes smoothly.
            </p>
          </div>

          <div className="space-y-4">
            {[
              { label: "Your Location", detail: "Exact location in Tambaram-hotel name and area, or residential area and address. If it's your place, any gate or lobby instructions." },
          ...
          <div className="space-y-5">
            {[
              ...
              },
              {
                ...
                icon: "ðŸ¨",
                desc: "If you're staying at a hotel in Tambaram, we need:",
                items: [
              ...
              },
              {
                ...
                icon: "ðŸ ",
                desc: "For residential bookings in Tambaram, we need your area and address. Clear gate or lobby instructions help avoid delays.",
                items: null
              },
              {
                title: "Communication",
      ...
      <section className="relative py-10 sm:py-12 md:py-16 px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-5xl">
          <div className="text-center mb-8 sm:mb-10">
            ...
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-white mb-3 sm:mb-4">
              Getting Around Tambaram
            </h2>
            <p className="text-base sm:text-lg md:text-xl text-white/70 max-w-2xl mx-auto">
              Tambaram's South Chennai suburban location with railway station proximity makes it easy to reach from South Chennai and city center.
            </p>
          </div>

          <div className="p-6 sm:p-8 bg-black/40 border border-white/10 rounded-xl">
            <p className="text-white/80 leading-relaxed mb-4">
              <strong className="text-white">Tambaram</strong> is a South Chennai suburban area with excellent connectivity. Whether you&apos;re staying at a hotel near Tambaram Railway Station or in a residential area, we factor in travel time when suggesting who can reach you.
            </p>
            <p className="text-white/80 leading-relaxed mb-4">
              The area is well-connected by road and has good access to major Chennai landmarks. Tell us your location when you book-we don&apos;t need the exact address until we confirm, but clear gate or lobby instructions help avoid delays.
            </p>
            <p className="text-white/80 leading-relaxed">
              <strong className="text-white">Nearby areas:</strong> T Nagar (5 min), Egmore (10 min), Adyar (15 min), Guindy (20 min). Easy access makes Tambaram one of Chennai&apos;s most convenient areas for outcall bookings.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="relative py-10 sm:py-12 md:py-16 px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-5xl">
          ...
          <div className="mt-10 p-8 bg-gradient-to-r from-[var(--accent-gold)]/10 via-[var(--accent-gold)]/5 to-[var(--accent-gold)]/10 border-l-4 border-[var(--accent-gold)] rounded-xl">
            <p className="text-white/90 text-center leading-relaxed">
              <strong className="text-white">You don&apos;t need to arrange transportation.</strong> We handle all coordination. The escort will come directly to your location in Tambaram.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="relative py-10 sm:py-12 md:py-16 px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-5xl">
          <div className="text-center mb-8 sm:mb-10">
            ...
            <p className="text-base sm:text-lg md:text-xl text-white/70 max-w-2xl mx-auto">
              Make your booking in Tambaram smooth and hassle-free.
            </p>
          </div>
      ...
      <section className="relative py-10 sm:py-12 md:py-16 px-4 sm:px-6 lg:px-8 bg-white/[0.02] overflow-hidden">
        ...
        <div className="mx-auto max-w-5xl relative z-10">
          ...
          <div className="relative">
            ...
            <div className="space-y-8">
              {[
                { time: "9 AM - 6 PM", label: "Daytime", desc: "Fastest response, usually within 1-2 hours", icon: "â˜€ï¸" },
                { time: "6 PM - 11 PM", label: "Evenings", desc: "Busy period, may take 2-3 hours to respond", icon: "ðŸŒ†" },
                { time: "11 PM - 2 AM", label: "Late Night", desc: "Limited availability, response may be slower", icon: "ðŸŒ™" },
                { time: "2 AM - 9 AM", label: "Early Morning", desc: "Minimal availability, responses next day", icon: "ðŸŒ…" }
              ].map((item, idx) => (
                ...
                <div className={`relative p-6 sm:p-8 bg-black/60 backdrop-blur-md border-2 ${
                  ...
                  <div className="flex items-start justify-between mb-3">
                    ...
                    <div className="text-3xl opacity-50">
                      {idx === 0 ? "ðŸŒž" : idx === 1 ? "ðŸŽ‰" : idx === 2 ? "ðŸŒ§ï¸" : "â˜€ï¸"}
                    </div>
                  </div>
      ...
      {/* Comparison with Other Chennai Areas - Comparison Table Design */}
      <section className="relative py-10 sm:py-12 md:py-16 px-4 sm:px-6 lg:px-8 overflow-hidden">
        ...
        <div className="mx-auto max-w-7xl relative z-10">
          <div className="text-center mb-10 sm:mb-12">
            ...
            <h2 className="text-4xl sm:text-5xl md:text-6xl font-black text-white mb-4 leading-tight">
              Tambaram vs<br />Other Areas
            </h2>
            <p className="text-base sm:text-lg text-white/60 max-w-xl mx-auto">
              What makes Tambaram unique.
            </p>
          </div>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5 sm:gap-6">
            {AREA_COMPARISON.map((item, idx) => (
              <div
                key={item.area}
                className={`relative group ${
                  item.area === "Tambaram" ? 'lg:col-span-3 sm:col-span-2' : ''
                }`}
              >
                {item.area === "Tambaram" && (
                ...
                <div className={`relative p-6 sm:p-8 bg-black/60 backdrop-blur-md border-2 ${
                  ...
                  <div className={`text-center ${item.area === "Tambaram" ? 'mt-4' : ''}`}>
          ...
          <div className="mt-10 p-8 bg-gradient-to-r from-black/80 via-[var(--accent-gold)]/10 to-black/80 border-2 border-[var(--accent-gold)]/30 rounded-2xl">
            <p className="text-white/90 text-center leading-relaxed text-base sm:text-lg">
              <strong className="text-white">Tambaram&apos;s South Chennai suburban location</strong> offers railway station proximity and residential area advantages. Easy access from South Chennai and city center, good hotel options, and we&apos;re experienced with suburban bookings.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="relative py-10 sm:py-12 md:py-16 px-4 sm:px-6 lg:px-8 bg-black" aria-labelledby="cta-heading" itemScope itemType="https://schema.org/ContactPage">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="text-lg sm:text-xl text-white/80 mb-8 sm:mb-10 max-w-2xl mx-auto" itemProp="description">
            Message us with your location in Tambaram, when you need someone, and what you have in mind.
          </p>
          <div className="flex flex-wrap justify-center gap-3 sm:gap-4" role="group" aria-label="Contact options">
            <a
              ...
              aria-label="Contact us on Telegram for Tambaram escort bookings"
            ...
            <Link
              ...
              rel="follow"
              aria-label="Contact page for Tambaram escort service"
            >
              Contact
            </Link>
          </div>
