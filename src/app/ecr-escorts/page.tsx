...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "hotel escort ECR",
    "Tamil escorts ECR",
    "escort service Chennai ECR",
    "East Coast Road escorts",
    "ECR beach escorts",
    "resort escorts ECR",
    "ECR hotel escorts",
    "discreet escorts ECR",
    "verified escorts ECR",
    "Mallu escorts ECR",
    "Telugu escorts ECR",
    "Kannada escorts ECR",
    "housewife escorts ECR",
    "college girls escorts ECR",
    "model escorts ECR",
    "regular escorts ECR",
    "escort booking ECR",
    "escort service ECR Chennai",
    "outcall escort service ECR",
    "24/7 escorts ECR",
    "same day escorts ECR",
    "business traveler escorts ECR",
    "corporate escort ECR",
    "dinner escort ECR",
    "event escort ECR",
  ],
  ...
  other: {
    "geo.region": "IN-TN",
    "geo.placename": "East Coast Road, Chennai",
    "geo.position": "12.8500;80.2500",
    "ICBM": "12.8500, 80.2500",
  },
};

const OTHER_AREAS = [
  { name: "ECR", slug: "ecr-escorts", desc: "Beachside & resorts" },
...
const HOW_IT_WORKS = [
  { step: 1, title: "Contact Us", body: "Message with your location in ECR (hotel or area), when you need someone, and what you have in mind. We'll ask the basics-hotel proof if you're at a hotel, type (regular, housewife, model, etc.)." },
  { step: 2, title: "We Suggest Who's Free", body: "We'll tell you who can reach you on time in ECR. If you're at a hotel we need proof and room details; you give her name at reception when she arrives." },
  { step: 3, title: "She Comes to You", body: "Outcall only. She'll come to your hotel or your place in ECR. Payment when she's there - cash or UPI. No advance for regular, housewife and college-girl profiles." },
];
...
const WHY_CHOOSE = [
  ...
  { title: "Complete Discretion", body: "We don't share your number. Your booking stays between you and us. ECR is a beachside resort area-we're used to discreet resort and hotel outcall." },
  { title: "Beachside & Resort Area", body: "ECR is one of Chennai's most popular areas for resort bookings. We send someone who can reach you at your beachside resort or hotel. No fuss." },
...
const LANGUAGES = [
  { name: "Tamil", desc: "Most bookings in ECR are Tamil. Perfect for locals and Tamil-speaking clients." },
  { name: "Malayalam", desc: "Mallu escorts available in ECR. Great for Kerala clients and Malayalam speakers." },
  { name: "Telugu", desc: "Telugu-speaking companions in ECR. Popular for business travelers from Andhra/Telangana." },
  { name: "Kannada", desc: "Kannada escorts in ECR. Same booking process and discretion." },
];

const POPULAR_HOTELS = [
  { name: "Radisson Blu Resort", area: "ECR", note: "Beachside resort, popular for tourists" },
  { name: "Taj Fisherman's Cove", area: "ECR", note: "Luxury beach resort, discreet outcall" },
  { name: "Leela Palace", area: "ECR", note: "High-end resort hotel, scenic location" },
  { name: "ITC Grand Chola", area: "ECR", note: "Luxury resort, beachside location" },
  { name: "The Park", area: "ECR", note: "Beachside hotel, convenient for outcall" },
  { name: "Resort Hotels", area: "East Coast Road", note: "Multiple beachside resorts along ECR" },
];
...
const WHO_BOOKS_ECR = [
  { title: "Tourists & Resort Guests", body: "Staying at beachside resorts on ECR for vacation or travel. Don't want to spend evenings alone. Need discreet company that's hassle-free. Many bookings are from tourists staying at resorts." },
  { title: "Locals", body: "Living in or near ECR and want company for an evening-dinner, event, or just a few hours. Same process: tell us your area, when, and type; we fix someone who shows up." },
  { title: "Events & Corporate", body: "Need a plus-one for a client dinner, corporate event, or resort gathering in ECR. We send someone presentable who knows how to keep the evening smooth. Popular for business gatherings at resorts." },
];

const TIPS_FOR_EXPERIENCE = [
  { tip: "Be Clear About Location", detail: "Tell us your exact location in ECR-hotel name and area, or your residential area. Clear gate or lobby instructions help avoid delays." },
...
const SERVICES_OCCASIONS = [
  { title: "Dinner Dates", desc: "Company for dinner at restaurants in ECR. Presentable, conversation-ready. Perfect for business dinners or casual evenings.", popular: true },
  ...
  { title: "Parties & Social Events", desc: "Companion for parties, celebrations, or social gatherings in ECR. Fun, engaging, fits the occasion.", popular: false },
  { title: "Travel Companion", desc: "Company for outstation trips from ECR-Pondicherry, Mahabalipuram, or elsewhere. Advance notice required.", popular: false },
...
const WHY_ECR = [
  { title: "Beachside Location", desc: "ECR offers beautiful beachside resorts and hotels. Perfect for tourists and travelers looking for a scenic, relaxed environment. Many resorts along the coast provide ideal settings for discreet bookings." },
  { title: "Resort Hotels", desc: "High concentration of resort hotels along East Coast Road means we're experienced with resort bookings. We know the area, the resorts, and how to coordinate discreet outcall to beachside locations." },
  { title: "Tourist Destination", desc: "ECR is a popular tourist area with many visitors staying at resorts. We're used to tourist clients, resort bookings, and beachside occasions. Discretion is our default." },
  { title: "Scenic Route", desc: "East Coast Road is one of Chennai's most scenic routes, connecting beaches and resorts. Escorts can reach you at your resort or hotel along the coast, providing a unique beachside experience." },
];

const TRANSPORTATION_INFO = [
  { title: "Travel Time", desc: "Escorts typically reach ECR within 30-60 minutes from other parts of Chennai. We factor in travel time when suggesting who can reach you on time." },
...
const AREA_HIGHLIGHTS = [
  { name: "East Coast Road", type: "Scenic route", note: "Beautiful coastal road with beaches and resorts" },
  { name: "Beaches", type: "Tourist destination", note: "Multiple beaches along ECR, popular tourist area" },
  { name: "Resort Hotels", type: "Accommodation", note: "Many beachside resorts and hotels for bookings" },
  { name: "Mahabalipuram", type: "Historic site", note: "Close proximity to UNESCO World Heritage site" },
  { name: "Covelong Beach", type: "Beach destination", note: "Popular beach destination along ECR" },
  { name: "VGP Golden Beach", type: "Entertainment", note: "Theme park and beach resort area" },
];

const AREA_COMPARISON = [
  { area: "ECR", advantage: "Beachside & resort area", note: "Unique beachside location with resort hotels, scenic coastal route, perfect for tourists" },
  { area: "T Nagar", advantage: "Shopping district", note: "Popular for hotel bookings, but no beachside resort advantage" },
  { area: "OMR", advantage: "IT corridor", note: "Good for IT professionals, but further from city center" },
  { area: "Adyar", advantage: "Residential & upscale", note: "Quieter area, good hotels but fewer than ECR" },
  { area: "Guindy", advantage: "Business district", note: "Corporate hub, but no beachside location like ECR" },
  { area: "Velachery", advantage: "South Chennai hub", note: "Growing area with good connectivity, but further from central Chennai" },
  { area: "Egmore", advantage: "Transport hub", note: "Near railway station, convenient but less hotel density than ECR" },
];
...
const GROUP_BOOKING_INFO = [
  { title: "Multiple Escorts", desc: "Need multiple escorts for a corporate event, party, or group gathering in ECR? We can arrange 2-4 escorts depending on availability. Advance notice required-at least 2-3 days." },
...
const FAQ_ITEMS = [
  { q: "Do you cover ECR?", a: "Yes. ECR is one of our main areas in Chennai. We do outcall to hotels and residences in ECR. Tell us your location (hotel name or area) and when you need someone; we'll suggest who can reach you on time." },
  { q: "Do I need to pay advance in ECR?", a: "For regular, housewife and college-girl profiles -no advance. We need hotel proof and room details if you're at a hotel, and you give her name at reception. For models, artists, celebrity and actress we take a small advance; the rest when she arrives." },
  { q: "What's the best way to book an escort in ECR?", a: "Message us on Telegram. Tell us you're in ECR, when you need someone, and what you're looking for (regular, housewife, model, Tamil, Mallu, etc.). We'll suggest who's free. Same-day and advance bookings both work." },
  { q: "Outcall or incall in ECR?", a: "We do outcall only - she comes to your hotel or your place in ECR. Have the address and any gate or lobby instructions ready." },
  { q: "Why is ECR popular for escort bookings?", a: "ECR is Chennai's beachside resort area with many resort hotels and tourists. It's easy for us to send someone there, and clients often stay at beachside resorts. Same process as the rest of Chennai: discreet, pay when you meet." },
];

// Build JSON-LD after all constants are defined
function buildECRJsonLd() {
  ...
  return [
    {
      ...
      itemListElement: [
        ...
        { "@type": "ListItem", position: 3, name: "ECR Escorts", item: url },
      ],
    },
    {
      "@context": "https://schema.org",
    ...
    },
    {
      ...
      "@id": localBusinessId,
      name: "ECR Escorts",
      description: "Premium escort service on East Coast Road, Chennai. Outcall to resorts and hotels. Discreet, verified companions. Tamil, Mallu, Telugu & Kannada escorts available.",
      url,
      image: [
        `${base}/images/2.avif`,
      ],
            ...
            itemListElement: [
              {
                ...
                itemOffered: {
                  ...
                  description: "Regular escort service on ECR. No advance required.",
                },
              },
            ],
          },
            ...
            itemListElement: [
              {
                ...
                itemOffered: {
                  ...
                  description: "Housewife escort service on ECR. Mature, discreet companions.",
                },
              },
            ],
          },
    ...
    },
    {
      ...
      "@type": "Service",
      "@id": serviceId,
      name: "Escort Service on ECR",
      description: "Premium outcall escort service on East Coast Road, Chennai. Available 24/7. Discreet, verified companions.",
      provider: {
        "@id": organizationId,
      },
      areaServed: {
        "@type": "Place",
        name: "East Coast Road, Chennai",
      },
    ...
    },
    {
      "@context": "https://schema.org",
      "@type": "ItemList",
      name: "Popular Hotels & Resorts on ECR",
      description: "Popular hotels and resorts where we provide escort services on East Coast Road",
    ...
    },
    {
      "@context": "https://schema.org",
      "@type": "ItemList",
      name: "Languages Available on ECR",
      description: "Languages spoken by escorts available on East Coast Road",
...
export default function ECREscortsPage() {
  ...
  return (
    <main id="main-content" className="min-h-screen bg-black" itemScope itemType="https://schema.org/WebPage" lang="en-IN">
          ...
          <div className="mx-auto max-w-7xl">
            ...
            <nav className="mb-6 sm:mb-8" aria-label="Breadcrumb" itemScope itemType="https://schema.org/BreadcrumbList">
              <ol className="flex flex-wrap items-center gap-2 text-xs sm:text-sm text-white/50" role="list">
                ...
                <li aria-hidden="true" className="text-white/30">/</li>
                <li itemProp="itemListElement" itemScope itemType="https://schema.org/ListItem">
                  <span className="text-white/70" itemProp="name">ECR</span>
            ...
            <div>
              ...
              <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl 2xl:text-9xl font-black text-white leading-[0.9] mb-4 sm:mb-6 md:mb-8 tracking-tight">
                <span className="block">EAST COAST ROAD</span>
              ...
              <p className="text-base sm:text-lg md:text-xl lg:text-2xl text-white/95 leading-relaxed mb-6 sm:mb-8 md:mb-10 max-w-2xl lg:max-w-3xl font-light" itemProp="description">
                Premium escort service on East Coast Road. Outcall to your resort or hotel-discreet, verified, pay when you meet.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="grid lg:grid-cols-12 gap-8 sm:gap-10 lg:gap-12 items-start">
            ...
            <div className="lg:col-span-9">
              <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-white mb-6 sm:mb-8 leading-tight" itemProp="name">
                East Coast Road&apos;s Premier Escort Service
              </h2>
              <div className="prose prose-invert max-w-none space-y-4 sm:space-y-6 text-base sm:text-lg text-white/80 leading-relaxed" itemProp="description">
                <p>
                  <strong className="text-white">ECR</strong> is one of Chennai&apos;s most popular areas for resort and hotel bookings. If you&apos;re staying at a beachside resort or hotel here, or you live in the area and want company for a dinner or an evening, we&apos;ve got you.
                </p>
                <p>
                ...
                <p>
                  Outcall only - she comes to you. We don&apos;t share your number; discretion is default. Tell us your location in ECR, when you need someone, and what type you want (Tamil, Mallu, regular, model, etc.). We&apos;ll suggest who&apos;s free and can reach you on time.
                </p>
              </div>
            </div>
          </div>
      ...
      {/* Why ECR Specifically - Diagonal Split Design */}
      <section className="relative py-10 sm:py-12 md:py-16 px-4 sm:px-6 lg:px-8" aria-labelledby="why-ecr-heading" itemScope itemType="https://schema.org/ItemList">
        <div className="mx-auto max-w-7xl">
          <div className="mb-10 sm:mb-12">
            <div className="flex items-center gap-4 mb-4" aria-hidden="true">
              <div className="h-1 w-16 bg-[var(--accent-gold)]" />
              <span className="text-xs font-mono tracking-widest text-[var(--accent-gold)] uppercase">Why ECR</span>
            </div>
            <h2 id="why-ecr-heading" className="text-4xl sm:text-5xl md:text-6xl font-black text-white mb-4 leading-tight" itemProp="name">
              Why Choose<br />ECR?
            </h2>
          </div>

          <div className="grid lg:grid-cols-2 gap-6 sm:gap-8" itemProp="itemListElement" role="list">
            {WHY_ECR.map((item, idx) => (
              <article
                key={item.title}
          ...
          <div className="grid lg:grid-cols-12 gap-6 sm:gap-8 mb-6 sm:mb-8">
            <div className="lg:col-span-4">
              ...
              <p className="text-base sm:text-lg text-white/70" itemProp="description">
                Regular, housewife, college girls, models and more. All available for outcall in ECR.
              </p>
            </div>
                ...
                {CATEGORIES.map((cat, idx) => (
                  ...
                  >
                    <Link
                      ...
                      rel="follow"
                      aria-label={`Browse ${cat.label} in ECR`}
                      itemProp="item"
                    >
        ...
        <div className="mx-auto max-w-7xl">
          <div className="text-center mb-8 sm:mb-10">
            ...
            <h2 id="languages-heading" className="text-3xl sm:text-4xl md:text-5xl font-bold text-white mb-3 sm:mb-4" itemProp="name">
              Languages Available in ECR
            </h2>
            <p className="text-base sm:text-lg md:text-xl text-white/70 max-w-2xl mx-auto" itemProp="description">
              Tamil, Mallu, Telugu, and Kannada escorts available for outcall in ECR.
            </p>
          </div>
        ...
        <div className="mx-auto max-w-7xl">
          <div className="text-center mb-8 sm:mb-10">
            ...
            <h2 id="hotels-heading" className="text-3xl sm:text-4xl md:text-5xl font-bold text-white mb-3 sm:mb-4" itemProp="name">
              Popular Hotels & Locations in ECR
            </h2>
            <p className="text-base sm:text-lg md:text-xl text-white/70 max-w-2xl mx-auto" itemProp="description">
              We cover major resorts and hotels along ECR. Beachside location makes it ideal for resort bookings.
            </p>
          </div>
          ...
          <div className="mt-8 p-6 bg-black/40 border border-white/10 rounded-xl">
            <p className="text-white/80 text-center">
              <strong className="text-white">East Coast Road</strong>, <strong className="text-white">beachside resorts</strong>, and surrounding areas are all covered. Tell us your resort or hotel name when you book.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="relative py-10 sm:py-12 md:py-16 px-4 sm:px-6 lg:px-8 bg-white/[0.02] overflow-hidden" aria-labelledby="highlights-heading" itemScope itemType="https://schema.org/ItemList">
        ...
        <div className="mx-auto max-w-7xl relative z-10">
          <div className="text-center mb-10 sm:mb-12">
            ...
            <p className="text-base sm:text-lg text-white/60 max-w-xl mx-auto" itemProp="description">
              Key locations and landmarks in and around ECR.
            </p>
          </div>
        ...
        <div className="mx-auto max-w-7xl">
          <div className="text-center mb-8 sm:mb-10">
            ...
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-white mb-3 sm:mb-4">
              Duration Options in ECR
            </h2>
            <p className="text-base sm:text-lg md:text-xl text-white/70 max-w-2xl mx-auto">
              Flexible durations. All outcall to your hotel or your place in ECR.
            </p>
          </div>
          ...
          <div className="space-y-6">
            <div className="p-6 sm:p-8 bg-white/5 border border-white/10 rounded-xl">
              ...
              <p className="text-white/75 mb-4">
                We accept cash or UPI payments. Payment is made when the escort arrives at your location in ECR.
              </p>
            ...
            <div className="p-6 sm:p-8 bg-white/5 border border-white/10 rounded-xl">
              ...
              <p className="text-white/75 mb-4">
                For regular, housewife and college-girl profiles -no advance required. Payment when she arrives at your hotel or your place in ECR. Have payment ready-cash or UPI-to make the transaction smooth.
              </p>
            ...
            <div className="p-6 sm:p-8 bg-white/5 border border-white/10 rounded-xl">
              ...
              <p className="text-white/75">
                If you&apos;re at a hotel in ECR, we need proof you&apos;re staying there (room key photo or bill) and your room number. You give her name at reception when she arrives so she can come up. Payment is made when she arrives.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="mx-auto max-w-5xl">
          ...
          <div className="space-y-6">
            ...
            <div className="p-6 sm:p-8 bg-black/40 border border-white/10 rounded-xl">
              ...
              <p className="text-white/75">
                Evenings and weekends can be busier in ECR. We&apos;ll still respond; advance notice helps secure your preferred time. Business travelers often book weekday evenings.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="relative py-10 sm:py-12 md:py-16 px-4 sm:px-6 lg:px-8 bg-white/[0.02]">
        <div className="mx-auto max-w-5xl">
          ...
          <div className="grid sm:grid-cols-2 gap-4 sm:gap-6">
            {[
              { title: "Complete Discretion", desc: "We don't share your number with escorts. Your booking stays between you and us. ECR is central-we're used to discreet hotel and residential outcall." },
              { title: "Verified Profiles", desc: "All escorts are verified before listing. Real photos, real people. No fake profiles or bait-and-switch in ECR bookings." },
              { title: "Outcall Only", desc: "She comes to you-your hotel or your place in ECR. You control the environment. No incall locations." },
      ...
      <section className="relative py-10 sm:py-12 md:py-16 px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-5xl">
          <div className="text-center mb-8 sm:mb-10">
            ...
            <p className="text-base sm:text-lg md:text-xl text-white/70 max-w-2xl mx-auto">
              Have these ready so your booking in ECR goes smoothly.
            </p>
          </div>

          <div className="space-y-4">
            {[
              { label: "Your Location", detail: "Exact location in ECR-hotel name and area, or residential area and address. If it's your place, any gate or lobby instructions." },
      ...
      <section className="relative py-10 sm:py-12 md:py-16 px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-5xl">
          <div className="text-center mb-8 sm:mb-10">
            ...
            <p className="text-base sm:text-lg md:text-xl text-white/70 max-w-2xl mx-auto">
              Beachside location makes ECR a popular destination for resort bookings and tourists.
            </p>
          </div>

          <div className="p-6 sm:p-8 bg-black/40 border border-white/10 rounded-xl">
            <p className="text-white/80 leading-relaxed mb-4">
              <strong className="text-white">ECR</strong> is Chennai&apos;s scenic beachside route, connecting beaches and resorts along the coast. Whether you&apos;re staying at a beachside resort, hotel, or in a residential area along East Coast Road, we factor in travel time when suggesting who can reach you.
            </p>
            <p className="text-white/80 leading-relaxed mb-4">
              The area is well-connected by road and offers easy access to beaches, resorts, and tourist destinations. Tell us your location when you book-we don&apos;t need the exact address until we confirm, but clear gate or lobby instructions help avoid delays.
            </p>
            <p className="text-white/80 leading-relaxed">
              <strong className="text-white">Nearby areas:</strong> Adyar (20 min), Guindy (25 min), OMR (30 min). ECR&apos;s beachside location makes it unique for resort bookings and tourist clients.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="relative py-10 sm:py-12 md:py-16 px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-5xl">
          ...
          <div className="mt-10 p-8 bg-gradient-to-r from-[var(--accent-gold)]/10 via-[var(--accent-gold)]/5 to-[var(--accent-gold)]/10 border-l-4 border-[var(--accent-gold)] rounded-xl">
            <p className="text-white/90 text-center leading-relaxed">
              <strong className="text-white">You don&apos;t need to arrange transportation.</strong> We handle all coordination. The escort will come directly to your location in ECR.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="relative py-10 sm:py-12 md:py-16 px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-5xl">
          <div className="text-center mb-8 sm:mb-10">
            ...
            <p className="text-base sm:text-lg md:text-xl text-white/70 max-w-2xl mx-auto">
              Make your booking in ECR smooth and hassle-free.
            </p>
          </div>
      ...
      <section className="relative py-10 sm:py-12 md:py-16 px-4 sm:px-6 lg:px-8 overflow-hidden">
        ...
        <div className="mx-auto max-w-7xl relative z-10">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5 sm:gap-6">
            {AREA_COMPARISON.map((item, idx) => (
              <div
                key={item.area}
                className={`relative group ${
                  item.area === "ECR" ? 'lg:col-span-3 sm:col-span-2' : ''
                }`}
              >
                {item.area === "ECR" && (
          ...
          <div className="mt-10 p-8 bg-gradient-to-r from-black/80 via-[var(--accent-gold)]/10 to-black/80 border-2 border-[var(--accent-gold)]/30 rounded-2xl">
            <p className="text-white/90 text-center leading-relaxed text-base sm:text-lg">
              <strong className="text-white">ECR&apos;s beachside location</strong> makes it unique for escort bookings in Chennai. Resort hotels along the coast, scenic route, perfect for tourists, and we&apos;re experienced with resort bookings.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="relative py-10 sm:py-12 md:py-16 px-4 sm:px-6 lg:px-8 bg-black" aria-labelledby="cta-heading" itemScope itemType="https://schema.org/ContactPage">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="text-lg sm:text-xl text-white/80 mb-8 sm:mb-10 max-w-2xl mx-auto" itemProp="description">
            Message us with your location in ECR, when you need someone, and what you have in mind.
          </p>
          <div className="flex flex-wrap justify-center gap-3 sm:gap-4" role="group" aria-label="Contact options">
            <a
              ...
              aria-label="Contact us on Telegram for ECR escort bookings"
            ...
            <Link
              ...
              rel="follow"
              aria-label="Contact page for ECR escort service"
            >
              Contact
            </Link>
          </div>
