...
const url = `${base}/indiranagar-escorts`;

const metaTitle = "Indiranagar Escorts | Bangalore Escorts in Indiranagar – Outcall to Hotels & Your Place";
const metaDescription =
  "Indiranagar escorts and escort service in Bangalore. Outcall to your hotel or place in Indiranagar. Discreet, verified. Tamil, Mallu, Telugu & Kannada. Pay when you meet. No advance for regular & housewife.";
...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "Indiranagar escort service",
    "Bangalore escorts Indiranagar",
    "outcall Indiranagar",
    "hotel escort Indiranagar",
    "Tamil escorts Indiranagar",
    "escort service Bangalore Indiranagar",
    "Indiranagar Main Road escorts",
    "100 Feet Road escorts",
    "escorts near Loyola College",
    "Indiranagar hotel escorts",
    "discreet escorts Indiranagar",
    "verified escorts Indiranagar",
    "Mallu escorts Indiranagar",
    "Telugu escorts Indiranagar",
    "Kannada escorts Indiranagar",
    "housewife escorts Indiranagar",
    "college girls escorts Indiranagar",
    "model escorts Indiranagar",
    "regular escorts Indiranagar",
    "escort booking Indiranagar",
    "escort service Indiranagar Bangalore",
    "outcall escort service Indiranagar",
    "24/7 escorts Indiranagar",
    "same day escorts Indiranagar",
    "business traveler escorts Indiranagar",
    "corporate escort Indiranagar",
    "dinner escort Indiranagar",
    "event escort Indiranagar",
  ],
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Indiranagar escorts – premium outcall escort service in Bangalore",
        type: "image/avif",
      },
    ],
  },
  ...
  other: {
    "geo.region": "IN-KA",
    "geo.placename": "Indiranagar, Bangalore",
    "geo.position": "12.9780;77.6400",
    "ICBM": "12.9780, 77.6400",
  },
};

const OTHER_AREAS = [
  { name: "Koramangala", slug: "koramangala-escorts", desc: "Most hotel bookings" },
  { name: "MG Road", slug: "mg-road-escorts", desc: "IT & corporate" },
  { name: "Whitefield", slug: "whitefield-escorts", desc: "Business district" },
  { name: "HSR Layout", slug: "hsr-layout-escorts", desc: "Residential & hotels" },
  { name: "Electronic City", slug: "electronic-city-escorts", desc: "IT hub" },
  { name: "JP Nagar", slug: "jp-nagar-escorts", desc: "Central" },
];

const HOW_IT_WORKS = [
  { step: 1, title: "Contact Us", body: "Message with your location in Indiranagar (hotel or area), when you need someone, and what you have in mind. We'll ask the basics—hotel proof if you're at a hotel, type (regular, housewife, model, etc.)." },
  { step: 2, title: "We Suggest Who's Free", body: "We'll tell you who can reach you on time in Indiranagar. If you're at a hotel we need proof and room details; you give her name at reception when she arrives." },
  { step: 3, title: "She Comes to You", body: "Outcall only. She'll come to your hotel or your place in Indiranagar. Payment when she's there—cash or UPI. No advance for regular, housewife and college-girl profiles." },
];
...
const WHY_CHOOSE = [
  ...
  { title: "Complete Discretion", body: "We don't share your number. Your booking stays between you and us. Indiranagar is central—we're used to discreet hotel and residential outcall." },
  { title: "Central & Easy", body: "Indiranagar is one of Bangalore's busiest areas for hotel bookings. We send someone who can reach you on time. No fuss." },
...
const LANGUAGES = [
  { name: "Tamil", desc: "Most bookings in Indiranagar are Tamil. Perfect for locals and Tamil-speaking clients." },
  { name: "Malayalam", desc: "Mallu escorts available in Indiranagar. Great for Kerala clients and Malayalam speakers." },
  { name: "Telugu", desc: "Telugu-speaking companions in Indiranagar. Popular for business travelers from Andhra/Telangana." },
  { name: "Kannada", desc: "Kannada escorts in Indiranagar. Same booking process and discretion." },
];

const POPULAR_HOTELS = [
  { name: "ITC Gardenia", area: "Residency Road", note: "Luxury hotel, popular for business travelers" },
  { name: "The Leela Palace", area: "Old Airport Road", note: "High-end, discreet outcall" },
  { name: "Taj West End", area: "Race Course Road", note: "Central location, easy access" },
  { name: "Radisson Blu", area: "Indiranagar", note: "Business district, many bookings" },
  { name: "The Park", area: "Indiranagar", note: "Central, convenient for outcall" },
  { name: "Vivanta by Taj", area: "MG Road", note: "Popular with business travelers" },
];

const DURATION_OPTIONS = [
  { title: "Short Time (2-3 hours)", desc: "Most popular in Indiranagar. Perfect for business travelers staying at hotels. She comes to you for a few hours—dinner, conversation, or relaxed evening. Pay when she arrives; no advance for regular and housewife profiles.", popular: true },
  { title: "Dinner or Evening", desc: "Fixed slot for a dinner, event, or party in Indiranagar. Tell us the start time and when it ends. Same payment rules. We match someone who fits the occasion.", popular: false },
  { title: "Full Night", desc: "Dinner plus the night—typically 8—œ10 hours. Advance notice helps so we can confirm who's free in Indiranagar. Payment when she's there; for models and above we take a small advance.", popular: false },
  { title: "Outstation Travel", desc: "Trips from Indiranagar to Mysore, Coorg, or elsewhere. We need a few days' notice. Not every companion does outstation. Same discretion and payment.", popular: false },
];

const WHO_BOOKS_INDIRANAGAR = [
  { title: "Business Travelers", body: "Staying at hotels in Indiranagar for work. Don't want to eat alone or sit in a room. Need discreet company that's hassle-free. Most bookings are from business travelers." },
  { title: "Locals", body: "Living in or near Indiranagar and want company for an evening—dinner, event, or just a few hours. Same process: tell us your area, when, and type; we fix someone who shows up." },
  { title: "Events & Corporate", body: "Need a plus-one for a client dinner or corporate event in Indiranagar. We send someone presentable who knows how to keep the evening smooth. Popular for business gatherings." },
];

const TIPS_FOR_EXPERIENCE = [
  { tip: "Be Clear About Location", detail: "Tell us your exact location in Indiranagar—hotel name and area, or your residential area. Clear gate or lobby instructions help avoid delays." },
...
const SERVICES_OCCASIONS = [
  { title: "Dinner Dates", desc: "Company for dinner at restaurants in Indiranagar. Presentable, conversation-ready. Perfect for business dinners or casual evenings.", popular: true },
  ...
  { title: "Parties & Social Events", desc: "Companion for parties, celebrations, or social gatherings in Indiranagar. Fun, engaging, fits the occasion.", popular: false },
  { title: "Travel Companion", desc: "Company for outstation trips from Indiranagar—Mysore, Coorg, or elsewhere. Advance notice required.", popular: false },
...
const WHY_INDIRANAGAR = [
  { title: "Most Hotel Bookings", desc: "Indiranagar has the highest concentration of hotel bookings in Bangalore. Most business travelers stay here, making it our busiest area for outcall bookings." },
  { title: "Popular Area", desc: "Indiranagar is one of Bangalore's most popular areas for hotel stays. We're experienced with this area and know how to coordinate discreet outcall efficiently." },
  { title: "Central Location", desc: "Centrally located in Bangalore, making it easy for escorts to reach you from anywhere in the city. Quick access from MG Road, Koramangala, and other key areas." },
  { title: "Hotel Advantage", desc: "High density of hotels means we're most experienced with hotel bookings here. We know the area, the hotels, and how to coordinate discreet outcall seamlessly." },
];

const TRANSPORTATION_INFO = [
  { title: "Travel Time", desc: "Escorts typically reach Indiranagar within 30-60 minutes from other parts of Bangalore. We factor in travel time when suggesting who can reach you on time." },
...
const AREA_HIGHLIGHTS = [
  { name: "Indiranagar Main Road", type: "Main thoroughfare", note: "Many hotels and restaurants along this road" },
  { name: "100 Feet Road", type: "Commercial area", note: "Business district, easy access" },
  { name: "Residential Areas", type: "Residential", note: "Central location reference point" },
  { name: "Bangalore Landmarks", type: "Landmarks", note: "Nearby entertainment and restaurants" },
  { name: "Popular Hotel District", type: "Hotels", note: "Most hotel bookings area, popular destination" },
  { name: "Central Bangalore", type: "Location", note: "Well-connected, convenient access" },
];

const AREA_COMPARISON = [
  { area: "Indiranagar", advantage: "Most hotel bookings", note: "Highest hotel density, most popular area for hotel bookings, central location" },
  { area: "Koramangala", advantage: "Popular area", note: "Good for hotel bookings, but less central than Indiranagar" },
  { area: "MG Road", advantage: "IT & corporate", note: "Good for business travelers, but fewer hotels than Indiranagar" },
  { area: "Whitefield", advantage: "IT hub", note: "Growing area with hotels, but further from city center" },
  { area: "HSR Layout", advantage: "Residential & hotels", note: "Quieter area, good hotels but fewer than Indiranagar" },
  { area: "Electronic City", advantage: "IT corridor", note: "Good for IT professionals, but further from central Bangalore" },
  { area: "JP Nagar", advantage: "Residential hub", note: "Convenient area, but less hotel density than Indiranagar" },
];
...
const GROUP_BOOKING_INFO = [
  { title: "Multiple Escorts", desc: "Need multiple escorts for a corporate event, party, or group gathering in Indiranagar? We can arrange 2-4 escorts depending on availability. Advance notice required—at least 2-3 days." },
...
const FAQ_ITEMS = [
  { q: "Do you cover Indiranagar?", a: "Yes. Indiranagar is one of our main areas in Bangalore. We do outcall to hotels and residences in Indiranagar. Tell us your location (hotel name or area) and when you need someone; we'll suggest who can reach you on time." },
  { q: "Do I need to pay advance in Indiranagar?", a: "For regular, housewife and college-girl profiles—no advance. We need hotel proof and room details if you're at a hotel, and you give her name at reception. For models, artists, celebrity and actress we take a small advance; the rest when she arrives." },
  { q: "What's the best way to book an escort in Indiranagar?", a: "Message us on Telegram. Tell us you're in Indiranagar, when you need someone, and what you're looking for (regular, housewife, model, Tamil, Mallu, etc.). We'll suggest who's free. Same-day and advance bookings both work." },
  { q: "Outcall or incall in Indiranagar?", a: "We do outcall only—she comes to your hotel or your place in Indiranagar. Have the address and any gate or lobby instructions ready." },
  { q: "Why is Indiranagar popular for escort bookings?", a: "Indiranagar is central Bangalore with many hotels and business travelers. It's easy for us to send someone there, and clients often stay in the area. Same process as the rest of Bangalore: discreet, pay when you meet." },
];

// Build JSON-LD after all constants are defined
function buildIndiranagarJsonLd() {
  ...
  return [
    {
      ...
      itemListElement: [
        ...
        { "@type": "ListItem", position: 3, name: "Indiranagar Escorts", item: url },
      ],
    },
    {
      "@context": "https://schema.org",
    ...
    },
    {
      ...
      "@type": "LocalBusiness",
      "@id": localBusinessId,
      name: "Indiranagar Escorts",
      description: "Premium escort service in Indiranagar, Bangalore. Outcall to hotels and residences. Discreet, verified companions. Tamil, Mallu, Telugu & Kannada escorts available.",
      url,
      image: [
        `${base}/images/2.avif`,
      ],
            ...
            itemListElement: [
              {
                ...
                itemOffered: {
                  ...
                  description: "Regular escort service in Indiranagar. No advance required.",
                },
              },
            ],
          },
            ...
            itemListElement: [
              {
                ...
                itemOffered: {
                  ...
                  description: "Housewife escort service in Indiranagar. Mature, discreet companions.",
                },
              },
            ],
          },
    ...
    },
    {
      ...
      "@type": "Service",
      "@id": serviceId,
      name: "Escort Service in Indiranagar",
      description: "Premium outcall escort service in Indiranagar, Bangalore. Available 24/7. Discreet, verified companions.",
      provider: {
        "@id": organizationId,
      },
      areaServed: {
    ...
    },
    {
      "@context": "https://schema.org",
      "@type": "ItemList",
      name: "Popular Hotels in Indiranagar",
      description: "Popular hotels and locations where we provide escort services in Indiranagar",
    ...
    },
    {
      "@context": "https://schema.org",
      "@type": "ItemList",
      name: "Languages Available in Indiranagar",
      description: "Languages spoken by escorts available in Indiranagar",
...
export default function IndiranagarEscortsPage() {
  const jsonLd = buildIndiranagarJsonLd();
  return (
    <main id="main-content" className="min-h-screen bg-black" itemScope itemType="https://schema.org/WebPage" lang="en-IN">
      ...
      <header className="relative w-full min-h-screen flex flex-col justify-end overflow-hidden" role="banner" itemScope itemType="https://schema.org/WPHeader">
        ...
        <div className="absolute inset-0" aria-hidden="true">
          <Image
            src="/images/2.avif"
            alt="Indiranagar escorts —œ premium outcall escort service in Bangalore. Discreet, verified companions available for hotel and residential bookings in central Bangalore."
            fill
          ...
          <div className="mx-auto max-w-7xl">
            ...
            <nav className="mb-6 sm:mb-8" aria-label="Breadcrumb" itemScope itemType="https://schema.org/BreadcrumbList">
              <ol className="flex flex-wrap items-center gap-2 text-xs sm:text-sm text-white/50" role="list">
                ...
                <li aria-hidden="true" className="text-white/30">/</li>
                <li itemProp="itemListElement" itemScope itemType="https://schema.org/ListItem">
                  <span className="text-white/70" itemProp="name">Indiranagar</span>
            ...
            <div>
              ...
              <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl 2xl:text-9xl font-black text-white leading-[0.9] mb-4 sm:mb-6 md:mb-8 tracking-tight">
                <span className="block">Indiranagar</span>
              ...
              <p className="text-base sm:text-lg md:text-xl lg:text-2xl text-white/95 leading-relaxed mb-6 sm:mb-8 md:mb-10 max-w-2xl lg:max-w-3xl font-light" itemProp="description">
                Premium escort service in central Bangalore. Outcall to your hotel or your place—discreet, verified, pay when you meet.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="grid lg:grid-cols-12 gap-8 sm:gap-10 lg:gap-12 items-start">
            ...
            <div className="lg:col-span-9">
              <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-white mb-6 sm:mb-8 leading-tight" itemProp="name">
                Central Bangalore&apos;s Premier Escort Service
              </h2>
              <div className="prose prose-invert max-w-none space-y-4 sm:space-y-6 text-base sm:text-lg text-white/80 leading-relaxed" itemProp="description">
                <p>
                  <strong className="text-white">Indiranagar</strong> is Bangalore&apos;s most popular area for hotel bookings. Most hotel bookings happen here, making it our busiest area for outcall bookings. If you&apos;re staying at a hotel here or you live in the area and want company for a dinner or an evening, we&apos;ve got you.
                </p>
                <p>
                ...
                <p>
                  Outcall only—she comes to you. We don&apos;t share your number; discretion is default. Tell us your location in Indiranagar, when you need someone, and what type you want (Tamil, Mallu, regular, model, etc.). We&apos;ll suggest who&apos;s free and can reach you on time.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="mx-auto max-w-7xl">
          <div className="text-center mb-8 sm:mb-10">
            ...
            <h2 id="why-choose-heading" className="text-3xl sm:text-4xl md:text-5xl font-bold text-white mb-3 sm:mb-4">
              Trusted Service in Indiranagar
            </h2>
          </div>
      ...
      {/* Why Indiranagar Specifically - Diagonal Split Design */}
      <section className="relative py-10 sm:py-12 md:py-16 px-4 sm:px-6 lg:px-8" aria-labelledby="why-Indiranagar-heading" itemScope itemType="https://schema.org/ItemList">
        <div className="mx-auto max-w-7xl">
          <div className="mb-10 sm:mb-12">
            <div className="flex items-center gap-4 mb-4" aria-hidden="true">
              <div className="h-1 w-16 bg-[var(--accent-gold)]" />
              <span className="text-xs font-mono tracking-widest text-[var(--accent-gold)] uppercase">Why Indiranagar</span>
            </div>
            <h2 id="why-Indiranagar-heading" className="text-4xl sm:text-5xl md:text-6xl font-black text-white mb-4 leading-tight" itemProp="name">
              Why Choose<br />Indiranagar?
            </h2>
          </div>

          <div className="grid lg:grid-cols-2 gap-6 sm:gap-8" itemProp="itemListElement" role="list">
            {WHY_INDIRANAGAR.map((item, idx) => (
              <article
                key={item.title}
          ...
          <div className="grid lg:grid-cols-12 gap-6 sm:gap-8 mb-6 sm:mb-8">
            <div className="lg:col-span-4">
              ...
              <p className="text-base sm:text-lg text-white/70" itemProp="description">
                Regular, housewife, college girls, models and more. All available for outcall in Indiranagar.
              </p>
            </div>
                ...
                {CATEGORIES.map((cat, idx) => (
                  ...
                  >
                    <Link
                      ...
                      rel="follow"
                      aria-label={`Browse ${cat.label} in Indiranagar`}
                      itemProp="item"
                    >
        ...
        <div className="mx-auto max-w-7xl">
          <div className="text-center mb-8 sm:mb-10">
            ...
            <h2 id="languages-heading" className="text-3xl sm:text-4xl md:text-5xl font-bold text-white mb-3 sm:mb-4" itemProp="name">
              Languages Available in Indiranagar
            </h2>
            <p className="text-base sm:text-lg md:text-xl text-white/70 max-w-2xl mx-auto" itemProp="description">
              Tamil, Mallu, Telugu, and Kannada escorts available for outcall in Indiranagar.
            </p>
          </div>
        ...
        <div className="mx-auto max-w-7xl">
          <div className="text-center mb-8 sm:mb-10">
            ...
            <h2 id="hotels-heading" className="text-3xl sm:text-4xl md:text-5xl font-bold text-white mb-3 sm:mb-4" itemProp="name">
              Popular Hotels & Locations in Indiranagar
            </h2>
            <p className="text-base sm:text-lg md:text-xl text-white/70 max-w-2xl mx-auto" itemProp="description">
              We cover major hotels and residential areas in Indiranagar. Most hotel bookings area, popular hotel district, central location makes it easy for outcall.
            </p>
          </div>
          ...
          <div className="mt-8 p-6 bg-black/40 border border-white/10 rounded-xl">
            <p className="text-white/80 text-center">
              <strong className="text-white">Indiranagar Main Road</strong>, <strong className="text-white">100 Feet Road</strong>, and surrounding areas are all covered. Tell us your hotel name or residential area when you book.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-7xl relative z-10">
          <div className="text-center mb-10 sm:mb-12">
            <div className="inline-block mb-4" aria-hidden="true">
              <span className="text-xs font-mono tracking-widest text-[var(--accent-gold)] uppercase">Ã°Å¸â€œÂ Landmarks</span>
            </div>
            ...
            <p className="text-base sm:text-lg text-white/60 max-w-xl mx-auto" itemProp="description">
              Key locations and landmarks in and around Indiranagar.
            </p>
          </div>
        ...
        <div className="mx-auto max-w-7xl">
          <div className="text-center mb-8 sm:mb-10">
            ...
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-white mb-3 sm:mb-4">
              Duration Options in Indiranagar
            </h2>
            <p className="text-base sm:text-lg md:text-xl text-white/70 max-w-2xl mx-auto">
              Flexible durations. All outcall to your hotel or your place in Indiranagar.
            </p>
          </div>
                ...
                <div className={`relative p-6 sm:p-8 bg-black/60 backdrop-blur-md border-2 ${
                  ...
                  {service.popular && (
                    <div className="absolute -top-2 -right-2 w-6 h-6 bg-[var(--accent-gold)] rounded-full flex items-center justify-center">
                      <span className="text-xs font-bold text-black">Ã¢Ëœâ€¦</span>
                    </div>
                  )}
                  <div className="mb-3">
          ...
          <div className="space-y-6">
            <div className="p-6 sm:p-8 bg-white/5 border border-white/10 rounded-xl">
              ...
              <p className="text-white/75 mb-4">
                We accept cash or UPI payments. Payment is made when the escort arrives at your location in Indiranagar.
              </p>
            ...
            <div className="p-6 sm:p-8 bg-white/5 border border-white/10 rounded-xl">
              ...
              <p className="text-white/75 mb-4">
                For regular, housewife and college-girl profiles—no advance required. Payment when she arrives at your hotel or your place in Indiranagar. Have payment ready—cash or UPI—to make the transaction smooth.
              </p>
            ...
            <div className="p-6 sm:p-8 bg-white/5 border border-white/10 rounded-xl">
              ...
              <p className="text-white/75">
                If you&apos;re at a hotel in Indiranagar, we need proof you&apos;re staying there (room key photo or bill) and your room number. You give her name at reception when she arrives so she can come up. Payment is made when she arrives.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="relative py-10 sm:py-12 md:py-16 px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-6xl">
          <div className="text-center mb-10 sm:mb-12">
            ...
            <p className="text-base sm:text-lg text-white/60 max-w-xl mx-auto">
              What affects the rates in Indiranagar.
            </p>
          </div>
        ...
        <div className="mx-auto max-w-5xl">
          ...
          <div className="space-y-6">
            <div className="p-6 sm:p-8 bg-black/40 border border-white/10 rounded-xl">
              ...
              <p className="text-white/75">
                Message as early as you can. We usually reply within 1—œ2 hours; we&apos;ll tell you who&apos;s free and can reach you in Indiranagar. Popular for business travelers who decide last minute.
              </p>
            </div>
            <div className="p-6 sm:p-8 bg-black/40 border border-white/10 rounded-xl">
            ...
            <div className="p-6 sm:p-8 bg-black/40 border border-white/10 rounded-xl">
              ...
              <p className="text-white/75">
                Evenings and weekends can be busier in Indiranagar. We&apos;ll still respond; advance notice helps secure your preferred time. Business travelers often book weekday evenings.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="relative py-10 sm:py-12 md:py-16 px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-7xl">
          <div className="text-center mb-8 sm:mb-10">
            ...
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-white mb-3 sm:mb-4">
              Who Books Escorts in Indiranagar?
            </h2>
            <p className="text-base sm:text-lg md:text-xl text-white/70 max-w-2xl mx-auto">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
            {WHO_BOOKS_INDIRANAGAR.map((item) => (
              <div
                key={item.title}
      ...
      <section className="relative py-10 sm:py-12 md:py-16 px-4 sm:px-6 lg:px-8 bg-white/[0.02]">
        <div className="mx-auto max-w-5xl">
          <div className="text-center mb-8 sm:mb-10">
            ...
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-white mb-3 sm:mb-4">
              Safety & Discretion in Indiranagar
            </h2>
            <p className="text-base sm:text-lg md:text-xl text-white/70 max-w-2xl mx-auto">
          ...
          <div className="grid sm:grid-cols-2 gap-4 sm:gap-6">
            {[
              { title: "Complete Discretion", desc: "We don't share your number with escorts. Your booking stays between you and us. Indiranagar is central—we're used to discreet hotel and residential outcall." },
              { title: "Verified Profiles", desc: "All escorts are verified before listing. Real photos, real people. No fake profiles or bait-and-switch in Indiranagar bookings." },
              { title: "Outcall Only", desc: "She comes to you—your hotel or your place in Indiranagar. You control the environment. No incall locations." },
      ...
      <section className="relative py-10 sm:py-12 md:py-16 px-4 sm:px-6 lg:px-8 bg-white/[0.02]">
        <div className="mx-auto max-w-5xl">
          <div className="text-center mb-10 sm:mb-12">
            <div className="inline-flex items-center gap-3 mb-4">
              <span className="text-2xl">Ã¢Å“â€œ</span>
          ...
          <div className="space-y-6">
            {[
              ...
              },
              {
                ...
                icon: "Ã°Å¸â€œÅ ",
                content: "We monitor feedback and maintain quality standards. If an escort doesn't meet expectations, we address it immediately. Your feedback helps us maintain service quality in Indiranagar.",
                items: null,
                note: null
              }
            ].map((item, idx) => (
                    ...
                    <div className="ml-16 space-y-2">
                      {item.items.map((li, i) => (
                        <div key={i} className="flex items-start gap-2">
                          <span className="text-[var(--accent-gold)] mt-1">Ã¢Å“â€œ</span>
      ...
      <section className="relative py-10 sm:py-12 md:py-16 px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-5xl">
          <div className="text-center mb-8 sm:mb-10">
            ...
            <p className="text-base sm:text-lg md:text-xl text-white/70 max-w-2xl mx-auto">
              Have these ready so your booking in Indiranagar goes smoothly.
            </p>
          </div>

          <div className="space-y-4">
            {[
              { label: "Your Location", detail: "Exact location in Indiranagar—hotel name and area, or residential area and address. If it's your place, any gate or lobby instructions." },
          ...
          <div className="space-y-5">
            {[
              ...
              },
              {
                ...
                icon: "Ã°Å¸ÂÂ¨",
                desc: "If you're staying at a hotel in Indiranagar, we need:",
                items: [
              ...
              },
              {
                ...
                icon: "Ã°Å¸ÂÂ ",
                desc: "For residential bookings in Indiranagar, we need your area and address. Clear gate or lobby instructions help avoid delays.",
                items: null
              },
              {
                title: "Communication",
                    ...
                    <div className="flex-1">
                      ...
                      {item.items && (
                        <div className="space-y-2 ml-4">
                          {item.items.map((li, i) => (
                            <div key={i} className="flex items-start gap-2">
                              <span className="text-[var(--accent-gold)] mt-1">Ã¢-Â¸</span>
                              <span className="text-sm text-white/70">{li}</span>
                            </div>
                          ))}
                        </div>
      ...
      <section className="relative py-10 sm:py-12 md:py-16 px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-5xl">
          <div className="text-center mb-8 sm:mb-10">
            ...
            <p className="text-base sm:text-lg md:text-xl text-white/70 max-w-2xl mx-auto">
              Central location makes Indiranagar easy to reach from anywhere in Bangalore.
            </p>
          </div>

          <div className="p-6 sm:p-8 bg-black/40 border border-white/10 rounded-xl">
            <p className="text-white/80 leading-relaxed mb-4">
              <strong className="text-white">Indiranagar</strong> is centrally located in Bangalore, making it easy for escorts to reach you from other parts of the city. Whether you&apos;re staying at a hotel on Indiranagar Main Road, 100 Feet Road, or in a residential area, we factor in travel time when suggesting who can reach you.
            </p>
            <p className="text-white/80 leading-relaxed mb-4">
              The area is well-connected by road and has good access to major Bangalore landmarks. Tell us your location when you book—we don&apos;t need the exact address until we confirm, but clear gate or lobby instructions help avoid delays.
            </p>
            <p className="text-white/80 leading-relaxed">
              <strong className="text-white">Nearby areas:</strong> Koramangala (10 min), MG Road (15 min), Whitefield (25 min), HSR Layout (20 min). Easy access makes Indiranagar one of Bangalore&apos;s most convenient areas for outcall bookings, especially with the most hotel bookings advantage.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="relative py-10 sm:py-12 md:py-16 px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-5xl">
          <div className="text-center mb-10 sm:mb-12">
            <div className="inline-flex items-center gap-3 mb-4">
              <span className="text-2xl">Ã°Å¸Å¡-</span>
          ...
          <div className="mt-10 p-8 bg-gradient-to-r from-[var(--accent-gold)]/10 via-[var(--accent-gold)]/5 to-[var(--accent-gold)]/10 border-l-4 border-[var(--accent-gold)] rounded-xl">
            <p className="text-white/90 text-center leading-relaxed">
              <strong className="text-white">You don&apos;t need to arrange transportation.</strong> We handle all coordination. The escort will come directly to your location in Indiranagar.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="relative py-10 sm:py-12 md:py-16 px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-5xl">
          <div className="text-center mb-8 sm:mb-10">
            ...
            <p className="text-base sm:text-lg md:text-xl text-white/70 max-w-2xl mx-auto">
              Make your booking in Indiranagar smooth and hassle-free.
            </p>
          </div>
                ...
                <div className="relative p-6 sm:p-8 bg-black/60 backdrop-blur-md border-l-4 border-[var(--accent-gold)]/40 hover:border-[var(--accent-gold)] rounded-xl transition-all hover:bg-black/70">
                  <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 sm:gap-6">
                    <div className="flex-shrink-0 w-16 h-16 rounded-xl bg-gradient-to-br from-[var(--accent-gold)]/20 to-[var(--accent-gold)]/10 flex items-center justify-center text-3xl border border-[var(--accent-gold)]/30 group-hover:scale-110 transition-transform">
                      {idx === 0 ? "Ã°Å¸â€™Â¬" : idx === 1 ? "Ã°Å¸â€œÅ¾" : "Ã°Å¸â€œÂ§"}
                    </div>
      ...
      <section className="relative py-10 sm:py-12 md:py-16 px-4 sm:px-6 lg:px-8 bg-white/[0.02] overflow-hidden">
        ...
        <div className="mx-auto max-w-5xl relative z-10">
          ...
          <div className="relative">
            ...
            <div className="space-y-8">
              {[
                { time: "9 AM - 6 PM", label: "Daytime", desc: "Fastest response, usually within 1-2 hours", icon: "Ã¢Ëœâ‚¬Ã¯Â¸Â" },
                { time: "6 PM - 11 PM", label: "Evenings", desc: "Busy period, may take 2-3 hours to respond", icon: "Ã°Å¸Å’â€ " },
                { time: "11 PM - 2 AM", label: "Late Night", desc: "Limited availability, response may be slower", icon: "Ã°Å¸Å’â„¢" },
                { time: "2 AM - 9 AM", label: "Early Morning", desc: "Minimal availability, responses next day", icon: "Ã°Å¸Å’â€¦" }
              ].map((item, idx) => (
                ...
                <div className={`relative p-6 sm:p-8 bg-black/60 backdrop-blur-md border-2 ${
                  ...
                  <div className="flex items-start justify-between mb-3">
                    ...
                    <div className="text-3xl opacity-50">
                      {idx === 0 ? "Ã°Å¸Å’Å¾" : idx === 1 ? "Ã°Å¸Å½â€°" : idx === 2 ? "Ã°Å¸Å’Â§Ã¯Â¸Â" : "Ã¢Ëœâ‚¬Ã¯Â¸Â"}
                    </div>
                  </div>
      ...
      <section className="relative py-10 sm:py-12 md:py-16 px-4 sm:px-6 lg:px-8 overflow-hidden">
        ...
        <div className="mx-auto max-w-7xl relative z-10">
          <div className="text-center mb-10 sm:mb-12">
            <div className="inline-flex items-center gap-3 mb-4">
              <span className="text-2xl">Ã¢Å¡-Ã¯Â¸Â</span>
              <span className="text-xs font-mono tracking-widest text-[var(--accent-gold)] uppercase">Comparison</span>
              <span className="text-2xl">Ã¢Å¡-Ã¯Â¸Â</span>
            </div>
            <h2 className="text-4xl sm:text-5xl md:text-6xl font-black text-white mb-4 leading-tight">
              Indiranagar vs<br />Other Areas
            </h2>
            <p className="text-base sm:text-lg text-white/60 max-w-xl mx-auto">
              What makes Indiranagar unique.
            </p>
          </div>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5 sm:gap-6">
            {AREA_COMPARISON.map((item, idx) => (
              <div
                key={item.area}
                className={`relative group ${
                  item.area === "Indiranagar" ? 'lg:col-span-3 sm:col-span-2' : ''
                }`}
              >
                {item.area === "Indiranagar" && (
                ...
                <div className={`relative p-6 sm:p-8 bg-black/60 backdrop-blur-md border-2 ${
                  ...
                  <div className={`text-center ${item.area === "Indiranagar" ? 'mt-4' : ''}`}>
          ...
          <div className="mt-10 p-8 bg-gradient-to-r from-black/80 via-[var(--accent-gold)]/10 to-black/80 border-2 border-[var(--accent-gold)]/30 rounded-2xl">
            <p className="text-white/90 text-center leading-relaxed text-base sm:text-lg">
              <strong className="text-white">Indiranagar has the most hotel bookings</strong> in Bangalore, making it the most popular area for escort bookings. Highest hotel density, most hotel bookings advantage, easy access from all parts of the city, and we&apos;re most experienced with this area.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="relative py-10 sm:py-12 md:py-16 px-4 sm:px-6 lg:px-8 overflow-hidden" aria-labelledby="concerns-heading" itemScope itemType="https://schema.org/FAQPage">
        ...
        <div className="mx-auto max-w-5xl relative z-10">
          <div className="text-center mb-10 sm:mb-12">
            <div className="inline-flex items-center gap-3 mb-4" aria-hidden="true">
              <span className="text-2xl">Ã¢Ââ€œ</span>
      ...
      <section className="relative py-10 sm:py-12 md:py-16 px-4 sm:px-6 lg:px-8 bg-black" aria-labelledby="cta-heading" itemScope itemType="https://schema.org/ContactPage">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="text-lg sm:text-xl text-white/80 mb-8 sm:mb-10 max-w-2xl mx-auto" itemProp="description">
            Message us with your location in Indiranagar, when you need someone, and what you have in mind.
          </p>
          <div className="flex flex-wrap justify-center gap-3 sm:gap-4" role="group" aria-label="Contact options">
            <a
              ...
              aria-label="Contact us on Telegram for Indiranagar escort bookings"
            ...
            <Link
              ...
              rel="follow"
              aria-label="Contact page for Indiranagar escort service"
            >
              Contact
            </Link>
          </div>
