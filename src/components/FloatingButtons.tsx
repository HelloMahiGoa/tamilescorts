  ...
  return (
    <>
      ...
      {showScrollTop && (
        <button
          onClick={scrollToTop}
          className="fixed bottom-24 right-6 z-50 flex h-12 w-12 items-center justify-center rounded-full bg-[var(--accent-orange)] shadow-2xl transition-all hover:scale-110 hover:shadow-[0_0_20px_rgba(255,107,53,0.6)]"
