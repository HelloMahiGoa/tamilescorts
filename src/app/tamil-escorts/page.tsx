...
const url = `${base}/tamil-escorts`;

const metaTitle = "Tamil Escorts | Premium Tamil Escorts in Chennai, Bangalore, Hyderabad & More";
const metaDescription =
  "Tamil escorts and escort service across South India. Outcall to your hotel or place in Chennai, Bangalore, Hyderabad, Coimbatore, Madurai. Discreet, verified. Regular, housewife, models, artists, celebrity, actress. Pay when you meet.";

function buildTamilJsonLd() {
  ...
  return [
    {
      ...
      itemListElement: [
        ...
        { "@type": "ListItem", position: 2, name: "Tamil Escorts", item: url },
      ],
    },
    {
      "@context": "https://schema.org",
    ...
    },
    {
      ...
      "@id": localBusinessId,
      name: "Tamil Escorts",
      description: "Premium Tamil escort service across South India. Outcall to Chennai, Bangalore, Hyderabad, Coimbatore, Madurai. Discreet, verified companions.",
      url,
...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "Tamil companions",
    "Tamil speaking escorts",
    "housewife escorts Tamil",
    "model escorts Tamil",
    "regular escorts Tamil",
    "outcall Tamil escorts",
  ],
  openGraph: {
    type: "website",
    locale: "en_IN",
    ...
    title: metaTitle,
    description: metaDescription,
    images: [{ url: `${base}/images/2.avif`, width: 1200, height: 630, alt: "Tamil escorts – premium escort service across South India" }],
  },
  twitter: {
...
const WHY_CHOOSE = [
  ...
  { title: "Direct Contact", body: "No bots, no long forms. You talk to someone who handles Tamil escort bookings every day. Quick response." },
...
const WHO_BOOKS = [
  ...
  { title: "Locals", body: "Living in Chennai, Bangalore, Hyderabad or elsewhere and want company for an evening—dinner, event, or just a few hours. Same process: you tell us area, when, and category; we fix someone who shows up." },
...
const FAQ_ITEMS = [
  ...
  { q: "Are Tamil escorts verified?", a: "Yes. We verify profiles before listing. You get real photos and real people. No fake profiles or bait-and-switch. If something isn't right on the day, you can tell us—we take feedback seriously." },
  { q: "Can I book a Tamil escort for an event?", a: "Yes. We get requests for client dinners, corporate events, and social gatherings. Tell us the occasion, timing, and how formal it is; we'll suggest who fits. Same payment rules apply." },
  { q: "Do Tamil escorts speak Tamil?", a: "Yes. All our Tamil escorts speak Tamil and English. Many are multilingual. If you want someone who can hold a conversation in Tamil—for a family function, a dinner, or just because you're more comfortable—tell us when you book." },
];

const TAMIL_CATEGORIES: { slug: CategorySlug; label: string; line: string }[] = [
    ...
    <main id="main-content" className="min-h-screen bg-black">
      ...
      <header className="relative w-full min-h-[100vh] flex flex-col justify-end overflow-hidden">
        <div className="absolute inset-0 hidden md:block">
          <Image
            src="/images/2.avif"
            alt="Tamil escorts – premium escort service across South India"
            fill
        ...
        <div className="absolute inset-0 md:hidden">
          <Image
            ...
            alt="Premium Tamil escorts – discreet outcall booking to your hotel or place"
            fill
            className="object-cover object-center"
            priority
            sizes="100vw"
          ...
          <div className="mx-auto w-full max-w-7xl">
            ...
            <div className="max-w-2xl md:max-w-xl lg:max-w-2xl">
              ...
              <p className="mt-6 text-lg sm:text-xl text-white/85 leading-relaxed max-w-xl">
                Premium Tamil escort service across South India. Outcall to your hotel or your place—Chennai, Bangalore, Hyderabad, Coimbatore, Madurai and more.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="border-b border-white/10 py-6 px-4 sm:px-6 lg:px-8" aria-label="About Tamil escorts">
        <div className="mx-auto max-w-4xl text-center">
          <p className="text-base sm:text-lg text-white/80 leading-relaxed">
            <strong className="text-white">Tamil escorts</strong> and escort service in{" "}
            <strong className="text-white">Chennai</strong>, <strong className="text-white">Bangalore</strong>,{" "}
            <strong className="text-white">Hyderabad</strong>, Coimbatore, Madurai and across South India. Tamil-speaking companions. Outcall to your hotel or place. Discreet, verified, pay when you meet.
          </p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 min-h-0">
          <div className="relative aspect-[4/3] lg:aspect-auto lg:min-h-[480px] overflow-hidden bg-black">
            <Image
              ...
              alt="Premium Tamil escorts – Tamil-speaking companions for outcall across South India"
              fill
              className="object-cover object-center"
          ...
          <div className="flex flex-col justify-center px-4 py-12 sm:px-8 lg:px-12 xl:px-16 lg:py-16">
            <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-white mb-6 leading-tight">
              Looking for Tamil escorts? You&apos;ve found South India&apos;s trusted Tamil escort service.
            </h2>
            <p className="text-base sm:text-lg leading-relaxed text-white/85 mb-4">
              Most of our bookings are from people in town for work—staying at a hotel in <strong className="text-white">Chennai</strong>, <strong className="text-white">Bangalore</strong>, or <strong className="text-white">Hyderabad</strong>—or locals who want company for a dinner or an event. We don&apos;t do the &quot;pay first and hope someone shows up&quot; thing. You tell us your city/area, what kind of evening you have in mind, and when. We suggest someone who can reach you without a fuss.
            </p>
            <p className="text-base sm:text-lg leading-relaxed text-white/85 mb-4">
        ...
        <div className="mx-auto max-w-4xl">
          <div className="relative rounded-2xl border border-[var(--accent-gold)]/25 bg-black/50 px-6 sm:px-10 py-10 sm:py-12 text-center overflow-hidden">
            ...
            <h2 className="text-2xl sm:text-3xl font-bold text-white mb-5">
              What If Booking Tamil Escorts Just Worked?
            </h2>
            ...
            <p className="text-white/70 text-sm sm:text-base">
              This is South India&apos;s trusted Tamil escort service that turns a simple booking into a smooth evening.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-6xl">
          <div className="text-center mb-10">
            ...
            <h2 className="text-2xl sm:text-3xl font-bold text-white mb-3">
              Popular Cities for Tamil Escorts
            </h2>
            <p className="text-white/70 max-w-2xl mx-auto">
              We cover Chennai, Bangalore, Hyderabad, Coimbatore, Madurai, and more across South India. Tell us your city and area when you book and we&apos;ll fix someone who can reach you on time.
            </p>
          </div>
        ...
        <div className="mx-auto max-w-5xl">
          <div className="text-center mb-10">
            ...
            <p className="text-white/70">
              Book your Tamil escort in three simple steps.
            </p>
          </div>
        ...
        <div className="mx-auto max-w-6xl">
          <div className="text-center mb-10">
            ...
            <p className="text-white/70 max-w-xl mx-auto">
              Trusted Tamil escort service. No advance for regular profiles. Discreet and direct.
            </p>
          </div>
      ...
      <section className="py-14 px-4 sm:px-6 lg:px-8 border-t border-white/10" aria-label="Tamil escort categories">
        <div className="mx-auto max-w-6xl">
          <div className="text-center mb-10">
            <span className="inline-block text-xs font-semibold tracking-[0.2em] text-[var(--accent-gold)] uppercase mb-2">
              Categories
            ...
            <h2 className="text-2xl sm:text-3xl font-bold text-white mb-3">
              Browse Tamil Escorts by Category
            </h2>
            <p className="text-white/70 max-w-xl mx-auto">
          ...
          <div className="relative rounded-2xl border border-white/10 bg-gradient-to-br from-white/[0.04] to-transparent overflow-hidden">
            ...
            <div className="pl-8 pr-6 sm:pr-8 py-8 sm:py-10">
              ...
              <p className="text-white/85 leading-relaxed">
                All our Tamil escorts speak Tamil and English. Many are multilingual. If you want someone who can hold a conversation in Tamil—for a family function, a dinner where everyone&apos;s speaking Tamil, or just because you&apos;re more comfortable—tell us when you book. We&apos;ll suggest who fits. It&apos;s one of the things we get asked most.
              </p>
            </div>
          </div>
        </div>
      ...
      {/* Who Books Tamil Escorts – label + cards */}
      <section className="py-14 px-4 sm:px-6 lg:px-8 border-t border-white/10 bg-white/[0.02]">
        <div className="mx-auto max-w-5xl">
          <div className="text-center mb-10">
            <span className="inline-block text-xs font-semibold tracking-[0.2em] text-[var(--accent-gold)] uppercase mb-2">
        ...
        <div className="mx-auto max-w-4xl">
          <div className="relative rounded-2xl border border-white/10 bg-gradient-to-br from-white/[0.04] to-transparent overflow-hidden">
            ...
            <div className="pl-8 pr-6 sm:pr-8 py-8 sm:py-10">
              ...
              <h2 className="text-2xl sm:text-3xl font-bold text-white mb-5">
                First Time Booking a Tamil Escort?
              </h2>
      ...
      {/* When to Book */}
      <section className="py-14 px-4 sm:px-6 lg:px-8 border-t border-white/10" aria-label="When to book Tamil escorts">
        <div className="mx-auto max-w-4xl">
          ...
          <div className="rounded-2xl border border-white/10 bg-black/40 p-6 sm:p-8 space-y-4">
            <p className="text-white/75">
              <strong className="text-white">Same-day:</strong> Message as early as you can. We usually reply within 1–2 hours; we&apos;ll tell you who&apos;s free and can reach you. Popular in Chennai, Bangalore, Hyderabad.
            </p>
            <p className="text-white/75">
              <strong className="text-white">Advance:</strong> For full-night, events, or outstation trips, book a day or two ahead so we can confirm the right Tamil escort and timing.
            </p>
            <p className="text-white/75">
      ...
      <section className="border-y border-white/10 py-14 px-4 sm:px-6 lg:px-8 bg-white/[0.02]" aria-label="Other escort types">
        <div className="mx-auto max-w-4xl">
          <div className="text-center mb-8">
            ...
            <p className="text-white/70 max-w-lg mx-auto">
              We offer Mallu, Telugu, and Kannada escorts across the same cities. Same process—discreet, outcall, pay when you meet.
            </p>
          </div>
      ...
      {/* FAQ – label + cards */}
      <section className="border-y border-white/10 py-14 px-4 sm:px-6 lg:px-8 bg-white/[0.02]" aria-label="Frequently asked questions about Tamil escorts">
        <div className="mx-auto max-w-3xl">
          <div className="text-center mb-10">
            <span className="inline-block text-xs font-semibold tracking-[0.2em] text-[var(--accent-gold)] uppercase mb-2">
              FAQ
            ...
            <h2 className="text-2xl sm:text-3xl font-bold text-white mb-3">
              Top Questions about Tamil Escorts
            </h2>
        ...
        <div className="mx-auto max-w-2xl">
          <div className="rounded-2xl border border-[var(--accent-gold)]/30 bg-black/50 px-6 sm:px-10 py-10 sm:py-12 text-center">
            ...
            <h2 className="text-2xl font-bold text-white mb-4">
              Ready to Book a Tamil Escort?
            </h2>
            <p className="text-white/70 mb-6">
              Message us with your city/area, when you need someone, and what you have in mind. We&apos;re on Telegram. No bots—you&apos;ll talk to someone who handles Tamil escort bookings every day. Questions about cities, payment, or what to expect? Ask when you message.
            </p>
            <div className="flex flex-wrap justify-center gap-4">
              <a
                ...
                title="Contact Tamil escorts on Telegram"
              ...
              <Link
                href="/contact"
                title="Contact us to book Tamil escorts"
