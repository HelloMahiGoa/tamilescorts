  ...
  return [
    {
      ...
      itemListElement: [
        ...
        { "@type": "ListItem", position: 2, name: "Kannada Escorts", item: url },
      ],
    },
    {
      "@context": "https://schema.org",
...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "Kannada companions",
    "Kannada speaking escorts",
    "housewife escorts Kannada",
    "model escorts Kannada",
    "regular escorts Kannada",
    "outcall Kannada escorts",
  ],
  openGraph: {
    type: "website",
    locale: "en_IN",
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Kannada escorts – premium escort service across South India",
      },
    ],
  },
  twitter: {
...
const HOW_IT_WORKS = [
  {
    step: 1,
    title: "Contact Us",
    body: "Message or call with your city/area, when you need someone, and what you have in mind. We'll ask the basics—hotel or your place, category (regular, housewife, model, etc.).",
  },
  {
    step: 2,
    title: "We Suggest Who's Free",
    body: "We'll tell you who can reach you on time. If you're at a hotel we need proof and room details; you give her name at reception before she leaves.",
  },
  {
    step: 3,
    title: "She Comes to You",
    body: "Outcall only. She'll turn up at the agreed time. Have address and gate/lobby details ready. Payment when she's there—cash or UPI. No advance for regular, housewife, college-girl profiles.",
  },
];

const WHY_CHOOSE = [
  {
    title: "No Advance for Regular",
    body: "For regular, housewife and college-girl profiles we don't ask for advance. Hotel proof + room details + name at reception. Pay when she reaches you.",
  },
  {
    title: "Complete Discretion",
    body: "We don't share your number. Girls don't post or talk about clients. Your booking stays between you and us.",
  },
  {
    title: "Direct Contact",
    body: "No bots, no long forms. You talk to someone who handles Kannada escort bookings every day. Quick response.",
  },
  {
    title: "Pay When You Meet",
    body: "Cash or UPI when she's in your room. For models and above we take a small advance; rest on arrival.",
  },
];
...
const SERVICE_TYPES = [
  {
    title: "Short time",
    desc: "A few hours at your hotel or place. Most popular for business travelers. Pay when she arrives; no advance for regular and housewife profiles.",
  },
  {
    title: "Dinner or event",
    desc: "Plus-one for a client dinner or company for an evening out. We'll match someone who's presentable and easy to be around.",
  },
  {
    title: "Full night",
    desc: "Longer stay—dinner plus the night. Advance notice helps so we can confirm who's free. Same payment rules: cash or UPI when she's there.",
  },
  {
    title: "Travel companion",
    desc: "Outstation trips need advance booking. Not every girl does it; we'll check when you ask.",
  },
];
...
const WHO_BOOKS = [
  {
    ...
    body: "In town for a few days, staying at a hotel. Don't want to eat alone or sit in a room. Need company that's discreet and hassle-free.",
  },
  {
    title: "Locals",
  ...
  },
  {
    ...
    body: "Need a plus-one for a corporate dinner or a client meet. We send someone presentable who knows how to keep the evening smooth.",
  },
];
...
const WHAT_TO_EXPECT = [
  {
    step: "You message",
    text: "City/area, when, and what you have in mind (regular, housewife, model, dinner, short time, etc.).",
  },
  {
    step: "We confirm",
    text: "We tell you who's free and can reach you. If it's a hotel, we need proof and room details; you give her name at reception.",
  },
  {
    step: "She arrives",
    text: "Outcall only. She comes to you. Payment when she's there—cash or UPI. No advance for regular, housewife, college-girl.",
  },
  {
    step: "After",
    text: "Your booking stays between you and us. We don't share your number or store your details. Discretion is default.",
  },
];
...
const FAQ_ITEMS = [
  ...
  },
  {
    ...
    a: "For regular, housewife and college-girl profiles—no advance. We need hotel proof and room details if you're at a hotel, and you give her name at reception before she starts. For models, artists, celebrity and actress we take a small advance (10% or 20%); the rest when she arrives.",
  },
  {
    q: "How do I book a Kannada escort?",
    a: "Message us on Telegram. Tell us your city/area, when you need someone, and what you're looking for (regular, housewife, model, etc.). We'll suggest who's free. Same-day and advance bookings both work.",
  },
  {
    q: "Is my information kept private?",
    a: "Yes. We don't share your number with the girls. We don't store or share your details. All coordination goes through us. Discretion is non-negotiable.",
  },
  {
    q: "Outcall or incall?",
    a: "We do outcall only—she comes to your hotel or your place. Have the address and any gate or lobby instructions ready so there's no back-and-forth.",
  },
  {
    q: "Are Kannada escorts verified?",
    a: "Yes. We verify profiles before listing. You get real photos and real people. No fake profiles or bait-and-switch. If something isn't right on the day, you can tell us—we take feedback seriously.",
  },
  {
    q: "Can I book a Kannada escort for an event?",
    a: "Yes. We get requests for client dinners, corporate events, and social gatherings. Tell us the occasion, timing, and how formal it is; we'll suggest who fits. Same payment rules apply.",
  },
  {
    q: "Do Kannada escorts speak Kannada?",
    a: "Yes. All our Kannada escorts speak Kannada and English. Many are multilingual. If you want someone who can hold a conversation in Kannada—for a family function, a dinner, or just because you're more comfortable—tell us when you book.",
  },
];

const KANNADA_CATEGORIES: { slug: CategorySlug; label: string; line: string }[] = [
  {
    slug: "regular",
    label: "Regular Escorts",
    line: "Most popular. No advance; hotel proof and room details for hotel bookings.",
  },
  {
    slug: "housewife",
    label: "Housewife Escorts",
    line: "Discreet, easy to talk to. Same payment rules—pay when she arrives.",
  },
  {
    slug: "college-girls",
    label: "College Girls",
    line: "Casual vibe for dinners and evenings. Outcall to your hotel or place.",
  },
  {
    slug: "models",
    label: "Models",
    line: "Presentable for client dinners and events. Small advance; rest on arrival.",
  },
  {
    slug: "artists",
    label: "Artists & Performers",
    line: "Creative souls from the arts. Perfect for cultural events and conversations.",
  },
  {
    slug: "celebrity",
    label: "Celebrity Escorts",
    line: "High-profile companions. Maximum discretion. Small advance required.",
  },
  {
    slug: "actress",
    label: "Actress Escorts",
    line: "Screen and stage talent. Expressive and confident. Premium category.",
  },
];

export default function KannadaEscortsPage() {
  const jsonLd = buildKannadaJsonLd();
  return (
    <main id="main-content" className="min-h-screen bg-black">
      ...
      <header className="relative w-full min-h-[100vh] flex flex-col justify-end overflow-hidden">
        ...
        <div className="absolute inset-0 md:hidden">
          <Image
            ...
            alt="Premium Kannada escorts – discreet outcall booking to your hotel or place"
            fill
            className="object-cover object-center"
            priority
            sizes="100vw"
      ...
      <section
        className="border-b border-white/10 py-6 px-4 sm:px-6 lg:px-8"
        aria-label="About Kannada escorts"
      >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 min-h-0">
          <div className="relative aspect-[4/3] lg:aspect-auto lg:min-h-[480px] overflow-hidden bg-black">
            <Image
              ...
              alt="Premium Kannada escorts – Kannada-speaking companions for outcall across South India"
              fill
              className="object-cover object-center"
          ...
          <div className="flex flex-col justify-center px-4 py-12 sm:px-8 lg:px-12 xl:px-16 lg:py-16">
            <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-white mb-6 leading-tight">
              Looking for Kannada escorts? You&apos;ve found South India&apos;s trusted Kannada escort
              service.
            </h2>
            ...
            <p className="text-base sm:text-lg leading-relaxed text-white/85 mb-4">
              Outcall to your hotel or your place is the norm. Discretion is non-negotiable. We don't
              share your number; the girls don't post or talk about clients. Payment when she arrives—cash
              or UPI. For regular, housewife and college-girl profiles we don't ask for advance; we just
              need hotel proof and your room details if you're at a hotel. You give her name at reception
              before she starts. For models, artists, celebrity and actress we take a small advance; the
              rest when she's there.
            </p>
            <p className="text-base sm:text-lg leading-relaxed text-white/85">
              A lot of our clients are here for a few days on work. They don't want to eat alone in a
              hotel or sit in a room by themselves. Some need a plus-one for a client dinner. Some just
              want company for an evening with no strings. Same drill for everyone: you book, we fix
              someone who shows up, you pay when she's there.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="border-y border-white/10 py-14 px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-4xl">
          <div className="relative rounded-2xl border border-[var(--accent-gold)]/25 bg-black/50 px-6 sm:px-10 py-10 sm:py-12 text-center overflow-hidden">
            <div
              className="absolute top-0 left-0 right-0 h-1 bg-gradient-to-r from-transparent via-[var(--accent-gold)]/60 to-transparent"
              aria-hidden
            />
            ...
            <h2 className="text-2xl sm:text-3xl font-bold text-white mb-5">
              What If Booking Kannada Escorts Just Worked?
            </h2>
            <p className="text-lg text-white/85 leading-relaxed max-w-2xl mx-auto mb-4">
              No fakes. No &quot;pay first and pray.&quot; You tell us what you want—city/area, when,
              category (regular, housewife, model). We handle the rest. Direct contact with our team. Pay
              when you meet. Complete privacy guaranteed.
            </p>
            <p className="text-white/70 text-sm sm:text-base">
              This is South India&apos;s trusted Kannada escort service that turns a simple booking into a
              smooth evening.
            </p>
          </div>
        </div>
      ...
      <section className="border-y border-white/10 py-14 px-4 sm:px-6 lg:px-8 bg-white/[0.02]">
        <div className="mx-auto max-w-5xl">
          <div className="text-center mb-10">
            ...
            <p className="text-white/70">Book your Kannada escort in three simple steps.</p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {HOW_IT_WORKS.map((item) => (
              <div
                key={item.step}
                className="relative rounded-2xl border border-white/10 bg-black/40 p-6 sm:p-8 text-center hover:border-[var(--accent-gold)]/40 transition-colors"
              >
        ...
        <div className="mx-auto max-w-6xl">
          <div className="text-center mb-10">
            ...
            <p className="text-white/70 max-w-xl mx-auto">
              Trusted Kannada escort service. No advance for regular profiles. Discreet and direct.
            </p>
          </div>
      ...
      <section
        className="py-14 px-4 sm:px-6 lg:px-8 border-t border-white/10"
        aria-label="Kannada escort categories"
      >
        <div className="mx-auto max-w-6xl">
          <div className="text-center mb-10">
            <span className="inline-block text-xs font-semibold tracking-[0.2em] text-[var(--accent-gold)] uppercase mb-2">
            ...
            <h2 className="text-2xl sm:text-3xl font-bold text-white mb-3">
              Browse Kannada Escorts by Category
            </h2>
            <p className="text-white/70 max-w-xl mx-auto">
              Regular, housewife, college girls, models, artists, celebrity, actress and more. All
              available with outcall to your location.
            </p>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {KANNADA_CATEGORIES.map((cat) => (
              <Link
                key={cat.slug}
                href={`/profiles/kannada/${cat.slug}`}
          ...
          <div className="relative rounded-2xl border border-white/10 bg-gradient-to-br from-white/[0.04] to-transparent overflow-hidden">
            ...
            <div className="pl-8 pr-6 sm:pr-8 py-8 sm:py-10">
              ...
              <p className="text-white/85 leading-relaxed">
                All our Kannada escorts speak Kannada and English. Many are multilingual. If you want
      ...
      <section className="border-y border-white/10 py-14 px-4 sm:px-6 lg:px-8 bg-white/[0.02]">
        <div className="mx-auto max-w-6xl">
          <div className="text-center mb-10">
            ...
            <h2 className="text-2xl sm:text-3xl font-bold text-white mb-3">What We Offer</h2>
            <p className="text-white/70 max-w-2xl mx-auto">
              From a few hours to a full night, dinner dates to travel. Outcall to your hotel or your
              place. Tell us what you need and we&apos;ll match you.
            </p>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
      ...
      <section className="py-14 px-4 sm:px-6 lg:px-8 border-t border-white/10 bg-white/[0.02]">
        <div className="mx-auto max-w-6xl">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            {[
              {
                title: "Short time (a few hours)",
                desc: "Most popular for business travelers. She comes to you for 2–3 hours (or as agreed). Enough for dinner, conversation, or a relaxed evening. Pay when she arrives; no advance for regular, housewife and college-girl profiles.",
                num: "1",
              },
              {
                title: "Dinner or evening",
                desc: "A fixed slot for a dinner, event, or party. We need the start time and roughly when it ends. Same payment rules. Tell us the occasion so we match someone who fits the vibe.",
                num: "2",
              },
              {
                title: "Full night",
                desc: "Dinner plus the night—typically 8–10 hours or as agreed. Advance notice helps so we can confirm who's free. Payment when she's there; for models and above we take a small advance.",
                num: "3",
              },
              {
                title: "Outstation (travel)",
                desc: "Trips to other cities or destinations. We need a few days' notice. Not every companion does outstation. Same discretion and payment when she's with you.",
                num: "4",
              },
            ].map((item) => (
              <div
                key={item.num}
                className="group rounded-2xl border border-white/10 bg-black/40 p-6 sm:p-8 hover:border-[var(--accent-gold)]/40 transition-colors"
              >
        ...
        <div className="mx-auto max-w-5xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {WHO_BOOKS.map((item) => (
              <div
                key={item.title}
                className="rounded-2xl border border-white/10 bg-black/30 p-6 hover:border-[var(--accent-gold)]/40 transition-colors"
              >
                <div className="w-10 h-px bg-[var(--accent-gold)]/50 mb-3" aria-hidden />
        ...
        <div className="mx-auto max-w-4xl">
          <div className="relative rounded-2xl border border-white/10 bg-gradient-to-br from-white/[0.04] to-transparent overflow-hidden">
            ...
            <div className="pl-8 pr-6 sm:pr-8 py-8 sm:py-10">
              ...
              <h2 className="text-2xl sm:text-3xl font-bold text-white mb-5">
                First Time Booking a Kannada Escort?
              </h2>
              <p className="text-white/85 leading-relaxed mb-4">
                A lot of our clients are first-timers. You message us with your city/area, when you need
                someone, and what you have in mind (dinner, a few hours, event, or just company). We
                suggest who&apos;s free and can reach you. If you&apos;re at a hotel we need proof and room
                details; you give her name at reception when she arrives. Payment when she&apos;s there—no
                advance for regular and housewife profiles.
              </p>
              <p className="text-white/85 leading-relaxed">
                If something isn&apos;t right on the day, tell us afterwards. We take feedback seriously.
                The women we work with are used to first-time clients; they&apos;re not there to make you
                feel awkward.
              </p>
            </div>
          </div>
        ...
        <div className="mx-auto max-w-4xl">
          <div className="rounded-2xl border border-[var(--accent-gold)]/30 bg-black/60 p-8 sm:p-10 text-center shadow-[0_0_0_1px_var(--accent-gold)]/10">
            ...
            <p className="text-white/85 leading-relaxed max-w-2xl mx-auto mb-6">
              No hidden charges. We quote based on duration, category (regular, housewife, model, etc.)
              and location. You pay when you meet—cash or UPI. For regular, housewife and college-girl
              profiles we don&apos;t ask for advance. For models, artists, celebrity and actress we take a
              small advance; the rest when she arrives.
            </p>
      ...
      {/* When to Book */}
      <section className="py-14 px-4 sm:px-6 lg:px-8 border-t border-white/10" aria-label="When to book Kannada escorts">
        <div className="mx-auto max-w-4xl">
      ...
      <section className="border-y border-white/10 py-14 px-4 sm:px-6 lg:px-8 bg-white/[0.02]" aria-label="Other escort types">
        <div className="mx-auto max-w-4xl">
          <div className="text-center mb-8">
            ...
            <p className="text-white/70 max-w-lg mx-auto">
              We offer Tamil, Mallu, and Telugu escorts across the same cities. Same process—discreet, outcall, pay when you meet.
            </p>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            ...
            <Link href="/mallu-escorts" className="rounded-xl border border-white/10 bg-black/30 p-5 hover:border-[var(--accent-gold)]/40 transition-colors text-center">
              <span className="text-lg font-bold text-[var(--accent-gold)]">Mallu Escorts</span>
              <p className="text-sm text-white/75 mt-2">Malayalam-speaking companions across South India</p>
            </Link>
      ...
      <section
        className="border-y border-white/10 py-14 px-4 sm:px-6 lg:px-8 bg-white/[0.02]"
        aria-label="Frequently asked questions about Kannada escorts"
      >
        <div className="mx-auto max-w-3xl">
          <div className="text-center mb-10">
            <span className="inline-block text-xs font-semibold tracking-[0.2em] text-[var(--accent-gold)] uppercase mb-2">
            ...
            <h2 className="text-2xl sm:text-3xl font-bold text-white mb-3">
              Top Questions about Kannada Escorts
            </h2>
            <p className="text-white/60 text-sm">Answered honestly. No fluff.</p>
          </div>
        ...
        <div className="mx-auto max-w-2xl">
          <div className="rounded-2xl border border-[var(--accent-gold)]/30 bg-black/50 px-6 sm:px-10 py-10 sm:py-12 text-center">
            ...
            <h2 className="text-2xl font-bold text-white mb-4">
              Ready to Book a Kannada Escort?
            </h2>
            <p className="text-white/70 mb-6">
              Message us with your city/area, when you need someone, and what you have in mind. We&apos;re
              on Telegram. No bots—you&apos;ll talk to someone who handles Kannada escort
              bookings every day. Questions about cities, payment, or what to expect? Ask when you
              message.
            </p>
            <div className="flex flex-wrap justify-center gap-4">
              ...
              <Link
                href="/contact"
                title="Contact us to book Kannada escorts"
