  ...
  return [
    {
      ...
      itemListElement: [
        ...
        { "@type": "ListItem", position: 2, name: "Telugu Escorts", item: url },
      ],
    },
    {
      "@context": "https://schema.org",
...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "Telugu companions",
    "Telugu speaking escorts",
    "housewife escorts Telugu",
    "model escorts Telugu",
    "regular escorts Telugu",
    "outcall Telugu escorts",
  ],
  openGraph: {
    type: "website",
    locale: "en_IN",
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Telugu escorts – premium escort service across South India",
      },
    ],
  },
  twitter: {
...
const POPULAR_CITIES = [
  ...
  { name: "Madurai", slug: "madurai-escorts", desc: "Cultural heritage" },
];
...
const WHY_CHOOSE = [
  ...
  },
  {
    ...
    body: "No bots, no long forms. You talk to someone who handles Telugu escort bookings every day. Quick response.",
  },
  {
...
const FAQ_ITEMS = [
  ...
  {
    q: "How do I book a Telugu escort?",
  ...
  {
    q: "Can I book a Telugu escort for an event?",
  ...
  {
    q: "Do Telugu escorts speak Telugu?",
    a: "Yes. All our Telugu escorts speak Telugu and English. Many are multilingual. If you want someone who can hold a conversation in Telugu—for a family function, a dinner, or just because you're more comfortable—tell us when you book.",
  },
];

const TELUGU_CATEGORIES: { slug: CategorySlug; label: string; line: string }[] = [
  {
    slug: "regular",
...
export default function TeluguEscortsPage() {
  const jsonLd = buildTeluguJsonLd();
  return (
    <main id="main-content" className="min-h-screen bg-black">
      ...
      <header className="relative w-full min-h-[100vh] flex flex-col justify-end overflow-hidden">
        ...
        <div className="absolute inset-0 md:hidden">
          <Image
            ...
            alt="Premium Telugu escorts – discreet outcall booking to your hotel or place"
            fill
            className="object-cover object-center"
            priority
            sizes="100vw"
      ...
      <section
        ...
        aria-label="About Telugu escorts"
      >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 min-h-0">
          <div className="relative aspect-[4/3] lg:aspect-auto lg:min-h-[480px] overflow-hidden bg-black">
            <Image
              ...
              alt="Premium Telugu escorts – Telugu-speaking companions for outcall across South India"
              fill
              className="object-cover object-center"
          ...
          <div className="flex flex-col justify-center px-4 py-12 sm:px-8 lg:px-12 xl:px-16 lg:py-16">
            <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-white mb-6 leading-tight">
              Looking for Telugu escorts? You&apos;ve found South India&apos;s trusted Telugu escort
              service.
            </h2>
            ...
            <p className="text-base sm:text-lg leading-relaxed text-white/85">
              A lot of our clients are in the city for a few days on work. They don't want to eat alone in
              a hotel or sit in a room by themselves. Some need a plus-one for a client dinner. Some just
        ...
        <div className="mx-auto max-w-4xl">
          <div className="relative rounded-2xl border border-[var(--accent-gold)]/25 bg-black/50 px-6 sm:px-10 py-10 sm:py-12 text-center overflow-hidden">
            ...
            <h2 className="text-2xl sm:text-3xl font-bold text-white mb-5">
              What If Booking Telugu Escorts Just Worked?
            </h2>
            ...
            <p className="text-white/70 text-sm sm:text-base">
              This is South India&apos;s trusted Telugu escort service that turns a simple booking into a
              smooth evening.
            </p>
          </div>
        </div>
      ...
      <section className="border-y border-white/10 py-14 px-4 sm:px-6 lg:px-8 bg-white/[0.02]">
        <div className="mx-auto max-w-5xl">
          <div className="text-center mb-10">
            ...
            <p className="text-white/70">Book your Telugu escort in three simple steps.</p>
          </div>
        ...
        <div className="mx-auto max-w-6xl">
          <div className="text-center mb-10">
            ...
            <p className="text-white/70 max-w-xl mx-auto">
              Trusted Telugu escort service. No advance for regular profiles. Discreet and direct.
            </p>
          </div>
      ...
      <section
        ...
        aria-label="Telugu escort categories"
      >
        <div className="mx-auto max-w-6xl">
          <div className="text-center mb-10">
            <span className="inline-block text-xs font-semibold tracking-[0.2em] text-[var(--accent-gold)] uppercase mb-2">
            ...
            <h2 className="text-2xl sm:text-3xl font-bold text-white mb-3">
              Browse Telugu Escorts by Category
            </h2>
            <p className="text-white/70 max-w-xl mx-auto">
        ...
        <div className="mx-auto max-w-4xl">
          <div className="relative rounded-2xl border border-white/10 bg-gradient-to-br from-white/[0.04] to-transparent overflow-hidden">
            ...
            <div className="pl-8 pr-6 sm:pr-8 py-8 sm:py-10">
              ...
              <h2 className="text-2xl sm:text-3xl font-bold text-white mb-5">
                First Time Booking a Telugu Escort?
              </h2>
      ...
      {/* When to Book */}
      <section className="py-14 px-4 sm:px-6 lg:px-8 border-t border-white/10" aria-label="When to book Telugu escorts">
        <div className="mx-auto max-w-4xl">
      ...
      <section className="border-y border-white/10 py-14 px-4 sm:px-6 lg:px-8 bg-white/[0.02]" aria-label="Other escort types">
        <div className="mx-auto max-w-4xl">
          <div className="text-center mb-8">
            ...
            <p className="text-white/70 max-w-lg mx-auto">
              We offer Tamil, Mallu, and Kannada escorts across the same cities. Same process—discreet, outcall, pay when you meet.
            </p>
          </div>
      ...
      <section
        ...
        aria-label="Frequently asked questions about Telugu escorts"
      >
        <div className="mx-auto max-w-3xl">
          <div className="text-center mb-10">
            <span className="inline-block text-xs font-semibold tracking-[0.2em] text-[var(--accent-gold)] uppercase mb-2">
            ...
            <h2 className="text-2xl sm:text-3xl font-bold text-white mb-3">
              Top Questions about Telugu Escorts
            </h2>
        ...
        <div className="mx-auto max-w-2xl">
          <div className="rounded-2xl border border-[var(--accent-gold)]/30 bg-black/50 px-6 sm:px-10 py-10 sm:py-12 text-center">
            ...
            <h2 className="text-2xl font-bold text-white mb-4">
              Ready to Book a Telugu Escort?
            </h2>
            <p className="text-white/70 mb-6">
              Message us with your city/area, when you need someone, and what you have in mind. We&apos;re
              on Telegram. No bots—you&apos;ll talk to someone who handles Telugu escort
            ...
            <div className="flex flex-wrap justify-center gap-4">
              <a
                ...
                title="Contact Telugu escorts on Telegram"
              ...
              <Link
                href="/contact"
                title="Contact us to book Telugu escorts"
