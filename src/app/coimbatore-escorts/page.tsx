...
const url = `${base}/coimbatore-escorts`;

const metaTitle = "Coimbatore Escorts | Premium Escorts in Coimbatore – RS Puram, Gandhipuram, Peelamedu";
const metaDescription =
  "Coimbatore escorts and escort service in Coimbatore. Outcall to your hotel or place in RS Puram, Gandhipuram, Peelamedu, Saibaba Colony. Discreet, verified. Tamil, Mallu companions. Pay when you meet.";

function buildCoimbatoreJsonLd() {
  ...
  return [
    {
      ...
      itemListElement: [
        ...
        { "@type": "ListItem", position: 2, name: "Coimbatore Escorts", item: url },
      ],
    },
    {
      "@context": "https://schema.org",
    ...
    },
    {
      ...
      "@type": "LocalBusiness",
      "@id": localBusinessId,
      name: "Coimbatore Escorts",
      description: "Premium escort service in Coimbatore. Outcall to RS Puram, Gandhipuram, Peelamedu, Saibaba Colony. Discreet, verified. Tamil, Mallu companions.",
      url,
...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "Race Course escorts",
    "outcall Coimbatore",
    "Tamil escorts Coimbatore",
    "Mallu escorts Coimbatore",
    "housewife escorts Coimbatore",
    "model escorts Coimbatore",
    "escort service RS Puram",
    "hotel escort Coimbatore",
  ],
  openGraph: {
    type: "website",
    locale: "en_IN",
    ...
    title: metaTitle,
    description: metaDescription,
    images: [{ url: `${base}/images/2.avif`, width: 1200, height: 630, alt: "Coimbatore escorts – premium outcall escort service" }],
  },
  twitter: {
...
const POPULAR_AREAS = [
  { name: "RS Puram", slug: "rs-puram", desc: "Central & hotels" },
  { name: "Gandhipuram", slug: "gandhipuram", desc: "Commercial hub" },
  { name: "Peelamedu", slug: "peelamedu", desc: "IT & airport" },
  { name: "Saibaba Colony", slug: "saibaba-colony", desc: "Residential & stays" },
  { name: "Race Course", slug: "race-course", desc: "Upscale area" },
  { name: "Ukkadam", slug: "ukkadam", desc: "Central Coimbatore" },
];

const MORE_AREAS = [
  { name: "Sungam", slug: "sungam" },
  { name: "Ramnagar", slug: "ramnagar" },
  { name: "Tatabad", slug: "tatabad" },
  { name: "Kovaipudur", slug: "kovaipudur" },
  { name: "Saravanampatti", slug: "saravanampatti" },
  { name: "Brookefields", slug: "brookefields" },
];
...
const WHY_CHOOSE = [
  ...
  { title: "Direct Contact", body: "No bots, no long forms. You talk to someone who handles Coimbatore bookings every day. Quick response." },
...
const SERVICE_TYPES = [
  ...
  { title: "Dinner or event", desc: "Plus-one for a client dinner in RS Puram or Gandhipuram, or company for an evening out. We'll match someone who's presentable and easy to be around." },
  ...
  { title: "Travel companion", desc: "Outstation trips (Ooty, Coonoor, Munnar, Kodaikanal) need advance booking. Not every girl does it; we'll check when you ask." },
];

const WHO_BOOKS = [
  { title: "Business travelers", body: "In town for a few days, staying at a hotel in RS Puram or Peelamedu. Don't want to eat alone or sit in a room. Need company that's discreet and hassle-free." },
  { title: "Locals", body: "Living in Coimbatore and want company for an evening—dinner, event, or just a few hours. Same process: you tell us area, when, and type; we fix someone who shows up." },
  { title: "Events & client dinners", body: "Need a plus-one for a corporate dinner or a client meet in Gandhipuram or RS Puram. We send someone presentable who knows how to keep the evening smooth." },
];
...
const FAQ_ITEMS = [
  { q: "What areas in Coimbatore do you cover?", a: "We cover RS Puram, Gandhipuram, Peelamedu, Saibaba Colony, Race Course, Ukkadam, Sungam, Ramnagar, Tatabad, Kovaipudur, Saravanampatti, Brookefields and the rest of the city. Tell us your location when you book and we'll fix someone who can reach you on time." },
  ...
  { q: "How do I book a Coimbatore escort?", a: "Message us on Telegram. Tell us your area, when you need someone, and what you're looking for (Tamil, Mallu, regular, model, etc.). We'll suggest who's free. Same-day and advance bookings both work." },
  ...
  { q: "Outcall or incall in Coimbatore?", a: "We do outcall only in Coimbatore—she comes to your hotel or your place. Have the address and any gate or lobby instructions ready so there's no back-and-forth." },
  { q: "Are Coimbatore escorts verified?", a: "Yes. We verify profiles before listing. You get real photos and real people. No fake profiles or bait-and-switch. If something isn't right on the day, you can tell us—we take feedback seriously." },
  { q: "What is the best area for hotel bookings in Coimbatore?", a: "RS Puram and Gandhipuram get the most hotel bookings—central, plenty of hotels, easy for us to send someone. Peelamedu and Saibaba Colony are popular with business travelers. Race Course and Ukkadam work well too. Tell us your hotel area and we'll match someone who can reach you on time." },
  { q: "Can I book a Tamil or Mallu escort in Coimbatore?", a: "Yes. We have Tamil and Mallu escorts in Coimbatore. When you message, tell us your preference—language or type (regular, housewife, model, etc.)—and we'll suggest who's free and fits." },
];

const COIMBATORE_CATEGORIES: { slug: CategorySlug; label: string; line: string }[] = [
  { slug: "regular", label: "Regular Escorts", line: "Most popular in Coimbatore. No advance; hotel proof and room details for hotel bookings." },
...
export default function CoimbatoreEscortsPage() {
  const jsonLd = buildCoimbatoreJsonLd();
  return (
    <main id="main-content" className="min-h-screen bg-black">
      ...
      <header className="relative w-full min-h-[100vh] flex flex-col justify-end overflow-hidden">
        <div className="absolute inset-0 hidden md:block">
          <Image
            src="/images/2.avif"
            alt="Coimbatore escorts – premium outcall escort service in RS Puram, Gandhipuram, Peelamedu and across Coimbatore"
            fill
        ...
        <div className="absolute inset-0 md:hidden">
          <Image
            ...
            alt="Premium Coimbatore escorts – discreet outcall booking to your hotel or place"
            fill
            className="object-cover object-center"
            priority
            sizes="100vw"
          ...
          <div className="mx-auto w-full max-w-7xl">
            ...
            <div className="max-w-2xl md:max-w-xl lg:max-w-2xl">
              ...
              <p className="mt-6 text-lg sm:text-xl text-white/85 leading-relaxed max-w-xl">
                Premium escort service in Coimbatore. Outcall to your hotel or your place—RS Puram, Gandhipuram, Peelamedu, Saibaba Colony and across the city.
              </p>
              <a
      ...
      <section className="border-b border-white/10 py-6 px-4 sm:px-6 lg:px-8" aria-label="About Coimbatore escorts">
        <div className="mx-auto max-w-4xl text-center">
          <p className="text-base sm:text-lg text-white/80 leading-relaxed">
            <strong className="text-white">Coimbatore escorts</strong> and escort service in{" "}
            <strong className="text-white">RS Puram</strong>, <strong className="text-white">Gandhipuram</strong>,{" "}
            <strong className="text-white">Peelamedu</strong>, Saibaba Colony, Race Course and across Coimbatore. Tamil & Mallu companions. Outcall to your hotel or place. Discreet, verified, pay when you meet.
          </p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 min-h-0">
          <div className="relative aspect-[4/3] lg:aspect-auto lg:min-h-[480px] overflow-hidden bg-black">
            <Image
              ...
              alt="Premium Coimbatore escorts – Tamil and Mallu companions for outcall in Coimbatore"
              fill
              className="object-cover object-center"
          ...
          <div className="flex flex-col justify-center px-4 py-12 sm:px-8 lg:px-12 xl:px-16 lg:py-16">
            <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-white mb-6 leading-tight">
              Looking for premium Coimbatore escorts? You&apos;ve found the city&apos;s trusted escort service.
            </h2>
            <p className="text-base sm:text-lg leading-relaxed text-white/85 mb-4">
              Most of our bookings in <strong className="text-white">Coimbatore</strong> are from people in town for work—staying at a hotel in <strong className="text-white">RS Puram</strong> or <strong className="text-white">Peelamedu</strong>—or locals who want company for a dinner or an event. We don&apos;t do the &quot;pay first and hope someone shows up&quot; thing. You tell us your area, what kind of evening you have in mind, and when. We suggest someone who can reach you without a fuss.
            </p>
            <p className="text-base sm:text-lg leading-relaxed text-white/85 mb-4">
            ...
            <p className="text-base sm:text-lg leading-relaxed text-white/85">
              A lot of our clients are here for a few days on work. They don't want to eat alone in a hotel or sit in a room by themselves. Some need a plus-one for a client dinner in Gandhipuram or Peelamedu. Some just want company for an evening with no strings. Same drill for everyone: you book, we fix someone who shows up, you pay when she's there.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-4xl">
          <div className="relative rounded-2xl border border-[var(--accent-gold)]/25 bg-black/50 px-6 sm:px-10 py-10 sm:py-12 text-center overflow-hidden">
            ...
            <h2 className="text-2xl sm:text-3xl font-bold text-white mb-5">
              What If Booking Escorts in Coimbatore Just Worked?
            </h2>
            ...
            <p className="text-white/70 text-sm sm:text-base">
              This is Coimbatore&apos;s trusted escort service that turns a simple booking into a smooth evening.
            </p>
          </div>
        </div>
      </section>
      ...
      <Suspense fallback={null}>
        <DailyProfilesSection citySlug="coimbatore-escorts" basePath="/coimbatore-escorts" />
      </Suspense>
        ...
        <div className="mx-auto max-w-6xl">
          <div className="text-center mb-10">
            ...
            <p className="text-white/70 max-w-2xl mx-auto">
              We cover RS Puram, Gandhipuram, Peelamedu, and the suburbs. Tell us your location when you book and we&apos;ll fix someone who can reach you on time.
            </p>
          </div>
          ...
          <div className="rounded-xl border border-white/10 bg-black/30 px-6 py-5 text-center">
            ...
            <p className="text-white/60 text-sm text-center mt-4 max-w-xl mx-auto">
              RS Puram and Gandhipuram get the most hotel bookings. Peelamedu and Saibaba Colony are big for IT and corporate. Race Course, Sungam and Ramnagar are a mix of hotels and residential. Wherever you are, give us the area and we&apos;ll sort it.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-5xl">
          <div className="text-center mb-10">
            ...
            <p className="text-white/70">
              Book your escort in Coimbatore in three simple steps.
            </p>
          </div>
        ...
        <div className="mx-auto max-w-6xl">
          <div className="text-center mb-10">
            ...
            <p className="text-white/70 max-w-xl mx-auto">
              Trusted Coimbatore escort service. No advance for regular profiles. Discreet and direct.
            </p>
          </div>
        ...
        <div className="mx-auto max-w-4xl">
          <div className="text-center mb-8">
            ...
            <p className="text-white/70 max-w-xl mx-auto mb-8">
              100% verified profiles. Tamil and Mallu escorts in Coimbatore. Choose a type to browse by category (regular, housewife, college girls, models, artists, celebrity, actress).
            </p>
      ...
      {/* Tamil & Mallu Escorts in Coimbatore – label + cards */}
      <section className="border-y border-white/10 py-14 px-4 sm:px-6 lg:px-8 bg-white/[0.02]" aria-label="Tamil Mallu escorts Coimbatore">
        <div className="mx-auto max-w-6xl">
          <div className="text-center mb-10">
            <span className="inline-block text-xs font-semibold tracking-[0.2em] text-[var(--accent-gold)] uppercase mb-2">
              By language
            ...
            <h2 className="text-2xl sm:text-3xl font-bold text-white mb-3">
              Tamil & Mallu Escorts in Coimbatore
            </h2>
            <p className="text-white/70 max-w-2xl mx-auto">
              We have companions who speak Tamil and Malayalam. Many clients in Coimbatore want someone who gets the culture and can hold a conversation in their language—for a dinner, an event, or a relaxed evening at your hotel or place.
            </p>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            {[
              { href: "/tamil-escorts", label: "Tamil Escorts", desc: "Tamil companions in Coimbatore. RS Puram, Gandhipuram, Peelamedu—outcall to your hotel or place. Same discretion and pay-when-you-meet policy." },
              { href: "/mallu-escorts", label: "Mallu Escorts", desc: "Mallu companions in Coimbatore for dinner, events or travel. Most requested in Kerala. Presentable, easy to talk to. Outcall; pay when she arrives." },
            ].map((item) => (
      ...
      {/* Languages in Coimbatore – card with pills */}
      <section className="py-14 px-4 sm:px-6 lg:px-8 border-t border-white/10">
        <div className="mx-auto max-w-4xl">
          <div className="relative rounded-2xl border border-white/10 bg-gradient-to-br from-white/[0.04] to-transparent overflow-hidden">
            ...
            <div className="pl-8 pr-6 sm:pr-8 py-8 sm:py-10">
              ...
              <p className="text-white/85 leading-relaxed">
                Our companions in Coimbatore speak Tamil and Malayalam, plus English. Many are multilingual. If you want someone who can hold a conversation in a specific language—for a family function, a dinner where everyone&apos;s speaking Malayalam or Tamil, or just because you&apos;re more comfortable—tell us when you book. We&apos;ll suggest who fits. It&apos;s one of the things we get asked most in Coimbatore.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-14 px-4 sm:px-6 lg:px-8 border-t border-white/10" aria-label="Escort categories Coimbatore">
        <div className="mx-auto max-w-6xl">
          <div className="text-center mb-10">
            <span className="inline-block text-xs font-semibold tracking-[0.2em] text-[var(--accent-gold)] uppercase mb-2">
              Categories
            ...
            <p className="text-white/70 max-w-xl mx-auto">
              Regular, housewife, college girls, models and more. All available in Coimbatore with outcall to your location.
            </p>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {COIMBATORE_CATEGORIES.map((cat) => (
              <Link
                key={cat.slug}
      ...
      <section className="border-y border-white/10 py-14 px-4 sm:px-6 lg:px-8 bg-white/[0.02]">
        <div className="mx-auto max-w-6xl">
          <div className="text-center mb-10">
            ...
            <h2 className="text-2xl sm:text-3xl font-bold text-white mb-3">
              What We Offer in Coimbatore
            </h2>
            <p className="text-white/70 max-w-2xl mx-auto">
              From a few hours to a full night, dinner dates to travel. Outcall to your hotel or your place in Coimbatore. Tell us what you need and we&apos;ll match you.
            </p>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
      ...
      <section className="py-14 px-4 sm:px-6 lg:px-8 border-t border-white/10 bg-white/[0.02]">
        <div className="mx-auto max-w-6xl">
          <div className="text-center mb-10">
            ...
            <p className="text-white/70 max-w-xl mx-auto">
              We offer flexible durations. All outcall to your hotel or your place in Coimbatore.
            </p>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            {[
              ...
              { title: "Outstation (travel)", desc: "Trips to Ooty, Coonoor, Munnar, Kodaikanal or elsewhere. We need a few days' notice. Not every companion does outstation. Same discretion and payment when she's with you.", num: "4" },
            ].map((item) => (
      ...
      {/* Outstation from Coimbatore – card */}
          ...
          <div className="relative rounded-2xl border border-white/10 bg-white/[0.03] overflow-hidden">
            ...
            <div className="pl-8 pr-6 sm:pr-8 py-6 sm:py-8">
              ...
              <h2 className="text-xl sm:text-2xl font-bold text-white mb-3">
                Outstation from Coimbatore
              </h2>
              <p className="text-white/85 leading-relaxed">
                We get requests for trips to Ooty, Coonoor, Munnar, Kodaikanal, and elsewhere. Not every companion does outstation, and we need advance notice—often a few days—to check who&apos;s free and willing to travel. Same rules: discretion, pay when she&apos;s with you (cash or UPI), and for regular and housewife profiles no advance. Tell us where you&apos;re going, how many nights, and when; we&apos;ll see what we can arrange.
              </p>
            </div>
          </div>
        </div>
      ...
      {/* Who Books Coimbatore Escorts – label + cards */}
      <section className="py-14 px-4 sm:px-6 lg:px-8 border-t border-white/10 bg-white/[0.02]">
        <div className="mx-auto max-w-5xl">
          <div className="text-center mb-10">
            <span className="inline-block text-xs font-semibold tracking-[0.2em] text-[var(--accent-gold)] uppercase mb-2">
      ...
      {/* First time booking in Coimbatore – card */}
      <section className="py-14 px-4 sm:px-6 lg:px-8 border-t border-white/10" aria-label="First time booking Coimbatore">
        <div className="mx-auto max-w-4xl">
          <div className="relative rounded-2xl border border-white/10 bg-gradient-to-br from-white/[0.04] to-transparent overflow-hidden">
            <div className="absolute left-0 top-0 bottom-0 w-1.5 bg-[var(--accent-gold)]/60" aria-hidden />
            <div className="pl-8 pr-6 sm:pr-8 py-8 sm:py-10">
              ...
              <h2 className="text-2xl sm:text-3xl font-bold text-white mb-5">
                First Time Booking in Coimbatore?
              </h2>
        ...
        <div className="mx-auto max-w-4xl">
          <div className="relative rounded-2xl border border-white/10 overflow-hidden">
            ...
            <div className="p-6 sm:p-8">
              ...
              <p className="text-white/85 leading-relaxed mb-4">
                Same-day bookings work—we often confirm within a few hours. For peak times (weekends, evenings in RS Puram or Gandhipuram) a few hours&apos; notice helps. For full-night or outstation (Ooty, Coonoor, Munnar, Kodaikanal) we need advance notice; not every girl does it, and we need to line it up.
              </p>
              <p className="text-white/85 leading-relaxed">
      ...
      {/* Why outcall only in Coimbatore – card */}
      <section className="py-14 px-4 sm:px-6 lg:px-8 border-t border-white/10 bg-white/[0.02]">
        <div className="mx-auto max-w-4xl">
          <div className="rounded-2xl border border-white/10 overflow-hidden">
            <div className="bg-black/50 px-6 sm:px-8 py-6 border-b border-white/10">
              ...
              <h2 className="text-2xl sm:text-3xl font-bold text-white">
                Why Outcall Only in Coimbatore for Celebrity, Models, Artists and Actress?
              </h2>
            </div>
            <div className="p-6 sm:p-8 space-y-6">
              <div className="rounded-xl bg-white/[0.03] border border-white/5 p-5 sm:p-6">
                ...
                <p className="text-white/85 leading-relaxed text-sm sm:text-base">
                  In Coimbatore we offer <strong className="text-white">outcall only</strong>—she comes to your hotel or your place. We don&apos;t arrange incall. That applies to all profiles: regular, housewife, college girls, and also celebrity, models, artists and actress. You stay in a space you control; she travels to you.
                </p>
              </div>
              <div className="rounded-xl bg-white/[0.03] border border-white/5 p-5 sm:p-6">
      ...
      {/* Area keyword blocks – RS Puram/Gandhipuram & Peelamedu/Saibaba Colony */}
      <section className="py-14 px-4 sm:px-6 lg:px-8 border-t border-white/10" aria-label="Escort service by area Coimbatore">
        <div className="mx-auto max-w-5xl">
          <div className="text-center mb-10">
            <span className="inline-block text-xs font-semibold tracking-[0.2em] text-[var(--accent-gold)] uppercase mb-2">
              By area
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="group rounded-2xl border border-white/10 bg-white/[0.03] p-6 sm:p-8 hover:border-[var(--accent-gold)]/40 transition-colors">
              <div className="flex flex-wrap gap-2 mb-4">
                <Link href="/rs-puram-escorts" className="inline-flex items-center px-3 py-1.5 rounded-full text-xs font-semibold bg-[var(--accent-gold)]/15 text-[var(--accent-gold)] border border-[var(--accent-gold)]/30 hover:bg-[var(--accent-gold)]/25 transition-colors">
                  RS Puram
                </Link>
                <Link href="/gandhipuram-escorts" className="inline-flex items-center px-3 py-1.5 rounded-full text-xs font-semibold bg-[var(--accent-gold)]/15 text-[var(--accent-gold)] border border-[var(--accent-gold)]/30 hover:bg-[var(--accent-gold)]/25 transition-colors">
                  Gandhipuram
                </Link>
              </div>
              <h3 className="text-lg sm:text-xl font-bold text-white mb-3">
                Escort Service in RS Puram and Gandhipuram
              </h3>
              <p className="text-white/80 text-sm sm:text-base leading-relaxed">
                Most of our Coimbatore hotel bookings are in RS Puram and Gandhipuram—central, plenty of hotels, easy for us to send someone. Outcall to your room; we need proof and room details, and you give her name at reception. Pay when she arrives.
              </p>
            </div>
            <div className="group rounded-2xl border border-white/10 bg-white/[0.03] p-6 sm:p-8 hover:border-[var(--accent-gold)]/40 transition-colors">
              <div className="flex flex-wrap gap-2 mb-4">
                <Link href="/peelamedu-escorts" className="inline-flex items-center px-3 py-1.5 rounded-full text-xs font-semibold bg-[var(--accent-gold)]/15 text-[var(--accent-gold)] border border-[var(--accent-gold)]/30 hover:bg-[var(--accent-gold)]/25 transition-colors">
                  Peelamedu
                </Link>
                <Link href="/saibaba-colony-escorts" className="inline-flex items-center px-3 py-1.5 rounded-full text-xs font-semibold bg-[var(--accent-gold)]/15 text-[var(--accent-gold)] border border-[var(--accent-gold)]/30 hover:bg-[var(--accent-gold)]/25 transition-colors">
                  Saibaba Colony
                </Link>
              </div>
              <h3 className="text-lg sm:text-xl font-bold text-white mb-3">
                Outcall Escorts in Peelamedu and Saibaba Colony
              </h3>
              <p className="text-white/80 text-sm sm:text-base leading-relaxed">
                Peelamedu and Saibaba Colony are big for IT and corporate clients. We get a lot of bookings from business travelers staying there. Outcall only—she comes to your hotel or your place. Tell us your area and when you need someone; we&apos;ll suggest who&apos;s free and can reach you on time.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="relative rounded-2xl border border-white/10 bg-gradient-to-br from-white/[0.04] to-transparent overflow-hidden">
            ...
            <div className="p-6 sm:p-8">
              ...
              <p className="text-white/85 leading-relaxed mb-6">
                We cover all of Coimbatore. When you book we factor in where you are and where she&apos;s coming from so we suggest someone who can reach you on time. Tell us your area (or hotel name and area) when you message; we don&apos;t need the exact address until we confirm. Clear gate or lobby instructions help so there&apos;s no back-and-forth on the day.
              </p>
              <div className="flex flex-wrap gap-2">
                {[
                  { name: "RS Puram", slug: "rs-puram-escorts" },
                  { name: "Gandhipuram", slug: "gandhipuram-escorts" },
                  { name: "Peelamedu", slug: "peelamedu-escorts" },
                  { name: "Saibaba Colony", slug: "saibaba-colony-escorts" },
                  { name: "Race Course", slug: "race-course-escorts" },
                  { name: "Ukkadam", slug: "ukkadam-escorts" },
                  { name: "Sungam", slug: "sungam-escorts" },
                  { name: "Ramnagar", slug: "ramnagar-escorts" },
                  { name: "Tatabad", slug: "tatabad-escorts" },
                  { name: "Kovaipudur", slug: "kovaipudur-escorts" },
                  { name: "Saravanampatti", slug: "saravanampatti-escorts" },
                  { name: "Brookefields", slug: "brookefields-escorts" },
                ].map((area) => (
                  <Link
                    key={area.slug}
                    href={`/${area.slug}`}
      ...
      <section className="py-14 px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-6xl grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-14 items-center">
          ...
          <div className="relative aspect-[4/3] lg:aspect-[3/4] rounded-xl overflow-hidden bg-white/5 shrink-0">
            <Image
              src="/images/3.avif"
              alt="Trusted Coimbatore escort service – discreet outcall to your hotel or place"
              fill
              className="object-cover object-center"
              sizes="(max-width: 1023px) 100vw, 50vw"
            />
        ...
        <div className="mx-auto max-w-4xl">
          <div className="rounded-2xl border border-white/10 bg-black/20 px-6 sm:px-10 py-10 text-center">
            ...
            <p className="text-white/70 mb-8 max-w-2xl mx-auto">
              Coimbatore is a major hub; we also arrange outcall in Chennai, Bangalore, Hyderabad, Kochi, Madurai and more. Ask when you message—availability depends on who&apos;s free and where. Same rules: discretion, pay when you meet, no advance for regular and housewife profiles.
            </p>
      ...
      <section className="border-y border-white/10 py-14 px-4 sm:px-6 lg:px-8 bg-white/[0.02]" aria-label="Blog and guides">
        <div className="mx-auto max-w-4xl">
          <div className="text-center mb-8">
            ...
            <p className="text-white/70 max-w-xl mx-auto">
              Straightforward guides on booking, discretion, and what to expect in Coimbatore and South India.
            </p>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            <Link
      ...
      {/* FAQ – label + cards */}
      <section className="border-y border-white/10 py-14 px-4 sm:px-6 lg:px-8 bg-white/[0.02]" aria-label="Frequently asked questions about Coimbatore escorts">
        <div className="mx-auto max-w-3xl">
          <div className="text-center mb-10">
            <span className="inline-block text-xs font-semibold tracking-[0.2em] text-[var(--accent-gold)] uppercase mb-2">
              FAQ
            ...
            <h2 className="text-2xl sm:text-3xl font-bold text-white mb-3">
              Top Questions about Escorts in Coimbatore
            </h2>
        ...
        <div className="mx-auto max-w-2xl">
          <div className="rounded-2xl border border-[var(--accent-gold)]/30 bg-black/50 px-6 sm:px-10 py-10 sm:py-12 text-center">
            ...
            <h2 className="text-2xl font-bold text-white mb-4">
              Ready to Book a Coimbatore Escort?
            </h2>
            <p className="text-white/70 mb-6">
              Message us with your area, when you need someone, and what you have in mind. We&apos;re on Telegram. No bots—you&apos;ll talk to someone who handles Coimbatore bookings every day. Questions about areas, payment, or what to expect? Ask when you message.
            </p>
            <div className="flex flex-wrap justify-center gap-4">
              <a
                ...
                title="Contact Coimbatore escorts on Telegram"
              ...
              <Link
                href="/contact"
                title="Contact us to book Coimbatore escorts"
